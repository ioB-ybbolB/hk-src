function unityFramework(Module) {
    var Module = void 0 !== Module ? Module : {}
      ...
      , stackTraceReferenceMatch = jsStackTrace().match(new RegExp(stackTraceReference));
    stackTraceReferenceMatch && (Module.stackTraceRegExp = new RegExp(stackTraceReference.replace("([^\\n]+)", stackTraceReferenceMatch[4].replace(/[\\^${}[\]().*+?|]/g, "\\$&")).replace("jsStackTrace", "[^\\n]+")));
    var abort = function(e) {
        if (!ABORT) {
            ...
            var i = "abort(" + e + ") at " + stackTrace();
            if (!Module.abortHandler || !Module.abortHandler(i))
                throw i
        }
    };
    ...
    Module.SetFullscreen = function(e) {
        if (void 0 !== runtimeInitialized && runtimeInitialized)
            if (void 0 === JSEvents)
    ...
    function SendMessage(e, i, n) {
        if (void 0 === n)
            ...
            Module.ccall("SendMessageString", null, ["string", "string", "string"], [e, i, n]);
        else {
            if ("number" != typeof n)
        ...
        !function() {
            if (navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia) {
                if (!navigator.mediaDevices || !navigator.mediaDevices.enumerateDevices) {
                    if ("undefined" == typeof MediaStreamTrack || void 0 === MediaStreamTrack.getSources)
                        return void console.log("Media Devices cannot be enumerated on this browser.");
            ...
            function e(e) {
                var i = {
                    deviceName: e = e || "device #" + MediaDevices.length,
                    refCount: 0,
                    video: null
                };
                MediaDevices.push(i)
    ...
    ENVIRONMENT_IS_NODE ? (scriptDirectory = __dirname + "/",
    Module.read = function(e, i) {
        var n;
    ...
    ,
    process.argv.length > 1 && (Module.thisProgram = process.argv[1].replace(/\\/g, "/")),
    ...
    ) : ENVIRONMENT_IS_SHELL ? ("undefined" != typeof read && (Module.read = function(e) {
        return read(e)
    }
    ),
    Module.readBinary = function(e) {
        var i;
        return "function" == typeof readbuffer ? new Uint8Array(readbuffer(e)) : (assert("object" == typeof (i = read(e, "binary"))),
        i)
    }
    ,
    "undefined" != typeof scriptArgs ? Module.arguments = scriptArgs : "undefined" != typeof arguments && (Module.arguments = arguments),
    "function" == typeof quit && (Module.quit = function(e) {
        quit(e)
    }
    )) : (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) && (ENVIRONMENT_IS_WEB ? document.currentScript && (scriptDirectory = document.currentScript.src) : scriptDirectory = self.location.href,
    scriptDirectory = 0 !== scriptDirectory.indexOf("blob:") ? scriptDirectory.split("/").slice(0, -1).join("/") + "/" : "",
    ...
    Module.readAsync = function(e, i, n) {
        var t = new XMLHttpRequest;
        t.open("GET", e, !0),
        t.responseType = "arraybuffer",
        t.onload = function() {
            200 == t.status || 0 == t.status && t.response ? i(t.response) : n()
        }
        ,
        t.onerror = n,
        t.send(null)
    ...
    function staticAlloc(e) {
        var i = STATICTOP;
        return STATICTOP = STATICTOP + e + 15 & -16,
        i
    }
    function dynamicAlloc(e) {
        var i = HEAP32[DYNAMICTOP_PTR >> 2]
          , n = i + e + 15 & -16;
        if ((HEAP32[DYNAMICTOP_PTR >> 2] = n,
        n >= TOTAL_MEMORY) && !enlargeMemory())
            return HEAP32[DYNAMICTOP_PTR >> 2] = i,
            0;
        return i
    }
    function alignMemory(e, i) {
        return i || (i = STACK_ALIGN),
        e = Math.ceil(e / i) * i
    }
    ...
    function addFunction(e, i) {
        for (var n = 0; n < 0; n++)
            if (!functionPointers[n])
                return functionPointers[n] = e,
                jsCallStartIndex + n;
    ...
    function getFuncWrapper(e, i) {
        if (e) {
            assert(i),
            funcWrappers[i] || (funcWrappers[i] = {});
            var n = funcWrappers[i];
            return n[e] || (1 === i.length ? n[e] = function() {
                return dynCall(i, e)
            }
            : 2 === i.length ? n[e] = function(n) {
    ...
    function getCFunc(e) {
        var i = Module["_" + e];
        return assert(i, "Cannot call unknown function " + e + ", make sure it is exported"),
        i
    }
    var JSfuncs = {
        stackSave: function() {
        ...
        stringToC: function(e) {
            ...
            if (null != e && 0 !== e) {
                var n = 1 + (e.length << 2);
                stringToUTF8(e, i = stackAlloc(n), n)
            }
            return i
        }
    }
    ...
    function cwrap(e, i, n, t) {
        ...
        return "string" !== i && r && !t ? getCFunc(e) : function() {
    ...
    function allocate(e, i, n, t) {
        ...
        o = e) : (r = !1,
        o = e.length);
        var _, a = "string" == typeof i ? i : null;
        if (_ = n == ALLOC_NONE ? t : ["function" == typeof _malloc ? _malloc : staticAlloc, stackAlloc, staticAlloc, dynamicAlloc][void 0 === n ? ALLOC_STATIC : n](Math.max(o, a ? 1 : i.length)),
        r) {
            var l;
            for (t = _,
            assert(0 == (3 & _)),
        ...
        if ("i8" === a)
            return e.subarray || e.slice ? HEAPU8.set(e, _) : HEAPU8.set(new Uint8Array(e), _),
            _;
        for (var u, s, c, f = 0; f < o; ) {
            var d = e[f];
            0 !== (u = a || i[f]) ? ("i64" == u && (u = "i32"),
            setValue(_ + f, d, u),
            c !== u && (s = getNativeTypeSize(u),
            c = u),
            f += s) : f++
        }
        return _
    ...
    function Pointer_stringify(e, i) {
        if (0 === i || !e)
            return "";
        for (var n, t = 0, r = 0; t |= n = HEAPU8[e + r >> 0],
        (0 != n || i) && (r++,
        !i || r != i); )
            ;
        i || (i = r);
        var o = "";
        if (t < 128) {
            for (var _, a = 1024; i > 0; )
                _ = String.fromCharCode.apply(String, HEAPU8.subarray(e, e + Math.min(i, a))),
                o = o ? o + _ : _,
                e += a,
                i -= a;
            return o
    ...
    function UTF8ArrayToString(e, i) {
        for (var n = i; e[n]; )
            ++n;
        if (n - i > 16 && e.subarray && UTF8Decoder)
            return UTF8Decoder.decode(e.subarray(i, n));
        for (var t, r, o, _, a, l = ""; ; ) {
            if (!(t = e[i++]))
                return l;
            if (128 & t)
                ...
                192 != (224 & t))
                    if (o = 63 & e[i++],
                    224 == (240 & t) ? t = (15 & t) << 12 | r << 6 | o : (_ = 63 & e[i++],
                    240 == (248 & t) ? t = (7 & t) << 18 | r << 12 | o << 6 | _ : (a = 63 & e[i++],
                    t = 248 == (252 & t) ? (3 & t) << 24 | r << 18 | o << 12 | _ << 6 | a : (1 & t) << 30 | r << 24 | o << 18 | _ << 12 | a << 6 | 63 & e[i++])),
                    t < 65536)
                    ...
                    l += String.fromCharCode((31 & t) << 6 | r);
            else
                l += String.fromCharCode(t)
        }
    }
    ...
    function stringToUTF8Array(e, i, n, t) {
        if (!(t > 0))
            return 0;
        for (var r = n, o = n + t - 1, _ = 0; _ < e.length; ++_) {
    ...
    function allocateUTF8(e) {
        var i = lengthBytesUTF8(e) + 1
          , n = _malloc(i);
        return n && stringToUTF8Array(e, HEAP8, n, i),
        n
    }
    function allocateUTF8OnStack(e) {
        var i = lengthBytesUTF8(e) + 1
          , n = stackAlloc(i);
        return stringToUTF8Array(e, HEAP8, n, i),
        n
    }
    function demangle(e) {
        return e
    ...
    var buffer, HEAP8, HEAPU8, HEAP16, HEAPU16, HEAP32, HEAPU32, HEAPF32, HEAPF64, STATIC_BASE, STATICTOP, staticSealed, STACK_BASE, STACKTOP, STACK_MAX, DYNAMIC_BASE, DYNAMICTOP_PTR, byteLength, PAGE_SIZE = 16384, WASM_PAGE_SIZE = 65536, ASMJS_PAGE_SIZE = 16777216, MIN_TOTAL_MEMORY = 16777216;
    function alignUp(e, i) {
        return e % i > 0 && (e += i - e % i),
        e
    }
    ...
    function enlargeMemory() {
        ...
        return t && t.byteLength == TOTAL_MEMORY ? (updateGlobalBuffer(t),
    ...
    staticSealed = !1,
    Module.reallocBuffer || (Module.reallocBuffer = function(e) {
        var i;
        try {
    ...
    function callRuntimeCallbacks(e) {
        for (; e.length > 0; ) {
            ...
            if ("function" != typeof i) {
                var n = i.func;
                "number" == typeof n ? void 0 === i.arg ? Module.dynCall_v(n) : Module.dynCall_vi(n, i.arg) : n(void 0 === i.arg ? null : i.arg)
            } else
                i()
        }
    }
    TOTAL_MEMORY < TOTAL_STACK && err("TOTAL_MEMORY should be larger than TOTAL_STACK, was " + TOTAL_MEMORY + "! (TOTAL_STACK=" + TOTAL_STACK + ")"),
    ...
    function reSign(e, i, n) {
        if (e <= 0)
            return e;
        var t = i <= 32 ? Math.abs(1 << i - 1) : Math.pow(2, i - 1);
        return e >= t && (i <= 32 || e > t) && (e = -2 * t + e),
        e
    }
    ...
    function integrateWasmJS() {
        var e = "build.wast"
          , i = "build.wasm"
          , n = "build.temp.asm.js";
        isDataURI(e) || (e = locateFile(e)),
        isDataURI(i) || (i = locateFile(i)),
        isDataURI(n) || (n = locateFile(n));
        var t = {
            global: null,
            env: null,
        ...
        function _(e, n, _) {
            if ("object" != typeof WebAssembly)
                return err("no native wasm support detected"),
                !1;
            if (!(Module.wasmMemory instanceof WebAssembly.Memory))
                return err("no native wasm Memory in use"),
                !1;
            function a(e, i) {
                (r = e.exports).memory && function(e) {
                    var i = Module.buffer;
                    e.byteLength < i.byteLength && err("the new buffer in mergeMemory is smaller than the previous one. in native wasm, we should grow memory here");
                    var n = new Int8Array(i);
                    new Int8Array(e).set(n),
            ...
            Module.instantiateWasm)
                try {
                    return Module.instantiateWasm(t, a)
                } catch (e) {
            ...
            function u(e) {
                (Module.wasmBinary || !ENVIRONMENT_IS_WEB && !ENVIRONMENT_IS_WORKER || "function" != typeof fetch ? new Promise((function(e, i) {
                    e(o())
                }
                )) : fetch(i, {
            ...
            return Module.wasmBinary || "function" != typeof WebAssembly.instantiateStreaming || isDataURI(i) || "function" != typeof fetch ? u(l) : WebAssembly.instantiateStreaming(fetch(i, {
                credentials: "same-origin"
            }), t).then(l).catch((function(e) {
        ...
        Module.reallocBuffer = function(e) {
            return "asmjs" === l ? a(e) : function(e) {
                e = alignUp(e, Module.usingWasm ? WASM_PAGE_SIZE : ASMJS_PAGE_SIZE);
                var i = Module.buffer.byteLength;
                if (Module.usingWasm)
                    try {
                        return -1 !== Module.wasmMemory.grow((e - i) / 65536) ? Module.buffer = Module.wasmMemory.buffer : null
                    } catch (e) {
                        return null
                    }
            }(e)
        ...
        Module.asm = function(e, i, n) {
            if (!i.table) {
                var t = Module.wasmTableSize;
                void 0 === t && (t = 1024);
                var r = Module.wasmMaxTableSize;
                "object" == typeof WebAssembly && "function" == typeof WebAssembly.Table ? i.table = void 0 !== r ? new WebAssembly.Table({
                    initial: t,
                    maximum: r,
                    element: "anyfunc"
            ...
            var o;
            return i.memoryBase || (i.memoryBase = Module.STATIC_BASE),
            i.tableBase || (i.tableBase = 0),
            assert(o = _(0, i), "no binaryen method succeeded."),
            o
        }
    }
    integrateWasmJS();
    ...
    , function() {
        return void 0 !== Module.shouldQuit
    }
    , function() {
        for (var e in Module.intervals)
            window.clearInterval(e);
        Module.intervals = {};
        for (var i = 0; i < Module.deinitializers.length; i++)
            Module.deinitializers[i]();
        Module.deinitializers = [],
        "function" == typeof Module.onQuit && Module.onQuit()
    }
    ];
    ...
    STATICTOP = (STATIC_BASE = GLOBAL_BASE) + 4108480,
    __ATINIT__.push({
        func: function() {
    ...
    var STATIC_BUMP = 4108480;
    Module.STATIC_BASE = STATIC_BASE,
    Module.STATIC_BUMP = STATIC_BUMP;
    var tempDoublePtr = STATICTOP;
    function _JS_Cursor_SetImage(e, i) {
        for (var n = "", t = 0; t < i; t++)
            n += String.fromCharCode(HEAPU8[e + t]);
        Module.canvas.style.cursor = "url(data:image/cur;base64," + btoa(n) + "),default"
    }
    function _JS_Cursor_SetShow(e) {
        Module.canvas.style.cursor = e ? "default" : "none"
    }
    function _JS_Eval_ClearInterval(e) {
        window.clearInterval(e)
    }
    ...
    function _JS_Eval_SetInterval(e, i, n) {
    ...
    var fs = {
        ...
        sync: function(e) {
            if (e) {
                if (0 == fs.numPendingSync)
                    return
            } else if (fs.syncInProgress)
                return void fs.numPendingSync++;
            fs.syncInProgress = !0,
        ...
        if (0 != WEBAudio.audioWebEnabled) {
            var n = {
                ...
                setupPanning: function() {
                    this.threeD ? (this.source.disconnect(),
                    this.source.connect(this.panner),
                    this.panner.connect(this.gain)) : (this.panner.disconnect(),
    ...
    function _JS_Sound_Init() {
        try {
            ...
            var e = Module.setInterval((function() {
                "suspended" === WEBAudio.audioContext.state ? WEBAudio.audioContext.resume() : Module.clearInterval(e)
            }
            ), 400);
    ...
    function _JS_Sound_Load(e, i) {
        ...
        var n = {
          ...
          , r = HEAPU8.buffer.slice(e, e + i);
        return WEBAudio.audioContext.decodeAudioData(r, (function(e) {
            n.buffer = e
        }
        ), (function() {
            n.error = !0,
    ...
    function _JS_Sound_Load_PCM(e, i, n, t) {
        ...
        for (var r = {
            ...
            var _ = (t >> 2) + i * o
              , a = r.buffer;
            (a.copyToChannel || function(e, i, n) {
                var t = e.subarray(0, Math.min(e.length, this.length - (0 | n)));
                this.getChannelData(0 | i).set(t, 0 | n)
            }
            ).apply(a, [HEAPF32.subarray(_, _ + i), o, 0])
        }
        return WEBAudio.audioInstances.push(r) - 1
    }
    function _JS_Sound_Play(e, i, n, t) {
        if (_JS_Sound_Stop(i, 0),
        0 != WEBAudio.audioWebEnabled) {
            var r = WEBAudio.audioInstances[e]
              , o = WEBAudio.audioInstances[i];
            if (r.buffer)
                try {
                    o.playBuffer(WEBAudio.audioContext.currentTime + t, r.buffer, n)
                } catch (e) {
    ...
    function _JS_Sound_Set3D(e, i) {
        ...
        n.threeD != i && (n.threeD = i,
        n.setupPanning())
    }
    function _JS_Sound_SetListenerOrientation(e, i, n, t, r, o) {
        0 != WEBAudio.audioWebEnabled && (WEBAudio.audioContext.listener.forwardX ? (WEBAudio.audioContext.listener.forwardX.setValueAtTime(-e, WEBAudio.audioContext.currentTime),
        WEBAudio.audioContext.listener.forwardY.setValueAtTime(-i, WEBAudio.audioContext.currentTime),
        WEBAudio.audioContext.listener.forwardZ.setValueAtTime(-n, WEBAudio.audioContext.currentTime),
        WEBAudio.audioContext.listener.upX.setValueAtTime(t, WEBAudio.audioContext.currentTime),
        WEBAudio.audioContext.listener.upY.setValueAtTime(r, WEBAudio.audioContext.currentTime),
        WEBAudio.audioContext.listener.upZ.setValueAtTime(o, WEBAudio.audioContext.currentTime)) : WEBAudio.audioContext.listener.setOrientation(-e, -i, -n, t, r, o))
    }
    function _JS_Sound_SetListenerPosition(e, i, n) {
        0 != WEBAudio.audioWebEnabled && (WEBAudio.audioContext.listener.positionX ? (WEBAudio.audioContext.listener.positionX.setValueAtTime(e, WEBAudio.audioContext.currentTime),
        WEBAudio.audioContext.listener.positionY.setValueAtTime(i, WEBAudio.audioContext.currentTime),
        WEBAudio.audioContext.listener.positionZ.setValueAtTime(n, WEBAudio.audioContext.currentTime)) : WEBAudio.audioContext.listener.setPosition(e, i, n))
    }
    ...
    function _JS_Sound_SetPitch(e, i) {
        if (0 != WEBAudio.audioWebEnabled)
            try {
                WEBAudio.audioInstances[e].source.playbackRate.setValueAtTime(i, WEBAudio.audioContext.currentTime)
            } catch (e) {
                console.error("Invalid audio pitch " + i + " specified to WebAudio backend!")
            }
    }
    ...
    function _JS_Sound_SetVolume(e, i) {
        if (0 != WEBAudio.audioWebEnabled)
            try {
                WEBAudio.audioInstances[e].gain.gain.setValueAtTime(i, WEBAudio.audioContext.currentTime)
            } catch (e) {
                console.error("Invalid audio volume " + i + " specified to WebAudio backend!")
            }
    }
    ...
    function _JS_SystemInfo_GetBrowserName(e, i) {
        var n = Module.SystemInfo.browser;
        return e && stringToUTF8(n, e, i),
        lengthBytesUTF8(n)
    }
    function _JS_SystemInfo_GetBrowserVersionString(e, i) {
        var n = Module.SystemInfo.browserVersion;
        return e && stringToUTF8(n, e, i),
        lengthBytesUTF8(n)
    }
    function _JS_SystemInfo_GetCanvasClientSize(e, i, n) {
        var t = UTF8ToString(e)
          , r = "#canvas" == t ? Module.canvas : document.querySelector(t);
        HEAPF64[i >> 3] = r ? r.clientWidth : 0,
        HEAPF64[n >> 3] = r ? r.clientHeight : 0
    }
    function _JS_SystemInfo_GetDocumentURL(e, i) {
        return e && stringToUTF8(document.URL, e, i),
        lengthBytesUTF8(document.URL)
    }
    function _JS_SystemInfo_GetGPUInfo(e, i) {
        var n = Module.SystemInfo.gpu;
        return e && stringToUTF8(n, e, i),
        lengthBytesUTF8(n)
    }
    function _JS_SystemInfo_GetLanguage(e, i) {
        var n = Module.SystemInfo.language;
        return e && stringToUTF8(n, e, i),
        lengthBytesUTF8(n)
    }
    ...
    function _JS_SystemInfo_GetOS(e, i) {
        var n = Module.SystemInfo.os + " " + Module.SystemInfo.osVersion;
        return e && stringToUTF8(n, e, i),
        lengthBytesUTF8(n)
    }
    ...
    function _JS_SystemInfo_GetScreenSize(e, i) {
        HEAPF64[e >> 3] = Module.SystemInfo.width,
        HEAPF64[i >> 3] = Module.SystemInfo.height
    }
    function _JS_SystemInfo_GetStreamingAssetsURL(e, i) {
        return e && stringToUTF8(Module.streamingAssetsUrl, e, i),
        lengthBytesUTF8(Module.streamingAssetsUrl)
    }
    ...
    var videoInstances = [];
    function _JS_Video_CanPlayFormat(e) {
        var i = Pointer_stringify(e);
        return "" != document.createElement("video").canPlayType(i)
    }
    function _JS_Video_Create(e) {
        var i = Pointer_stringify(e)
        ...
        n.addEventListener("ended", (function(e) {
            n.looping && !n.detached && n.play()
        }
        )),
        videoInstances.push(n) - 1
    }
    function _JS_Video_Destroy(e) {
        videoInstances[e].detached = !0,
        videoInstances[e] = null
    }
    function _JS_Video_Duration(e) {
        return videoInstances[e].duration
    }
    function _JS_Video_EnableAudioTrack(e, i, n) {
        var t = videoInstances[e].audioTracks;
        if (t) {
            var r = t[i];
            r && (r.enabled = !!n)
        }
    }
    function _JS_Video_GetAudioLanguageCode(e, i) {
        var n = videoInstances[e].audioTracks;
        if (!n)
            return "";
        var t = n[i];
        return t ? t.language : ""
    }
    function _JS_Video_GetNumAudioTracks(e) {
        var i = videoInstances[e].audioTracks;
        return i ? i.length : 1
    }
    function _JS_Video_Height(e) {
        return videoInstances[e].videoHeight
    }
    function _JS_Video_IsPlaying(e) {
        var i = videoInstances[e];
        return !i.paused && !i.ended
    }
    function _JS_Video_IsReady(e) {
        return !videoInstances[e].isReady && videoInstances[e].readyState >= videoInstances[e].HAVE_ENOUGH_DATA && (videoInstances[e].isReady = !0),
        videoInstances[e].isReady
    }
    function _JS_Video_Pause(e) {
        videoInstances[e].pause()
    }
    function _JS_Video_Play(e) {
        videoInstances[e].play()
    }
    function _JS_Video_Seek(e, i) {
        videoInstances[e].currentTime = i
    }
    function _JS_Video_SetEndedHandler(e, i, n) {
        var t = videoInstances[e];
        t.addEventListener("ended", (function(e) {
            t.detached || dynCall("vi", n, [i])
        }
        ))
    }
    function _JS_Video_SetErrorHandler(e, i, n) {
        var t = videoInstances[e];
        t.onerror = function(e) {
            t.detached || dynCall("vii", n, [i, e.target.error.code])
        }
    }
    function _JS_Video_SetLoop(e, i) {
        videoInstances[e].looping = i
    }
    function _JS_Video_SetMute(e, i) {
        videoInstances[e].muted = i
    }
    function _JS_Video_SetPlaybackRate(e, i) {
        videoInstances[e].playbackRate = i
    }
    function _JS_Video_SetReadyHandler(e, i, n) {
        var t = videoInstances[e];
    ...
    function _JS_Video_SetSeekedOnceHandler(e, i, n) {
        var t = videoInstances[e];
        t.addEventListener("seeked", (function e(r) {
            t.removeEventListener("seeked", e),
            t.detached || dynCall("vi", n, [i])
        }
        ))
    }
    function _JS_Video_SetVolume(e, i) {
        videoInstances[e].volume = i
    }
    function _JS_Video_Time(e) {
        return videoInstances[e].currentTime
    }
    function _JS_Video_UpdateToTexture(e, i) {
        var n = videoInstances[e];
        if (!(n.videoWidth > 0 && n.videoHeight > 0))
            return !1;
        if (n.lastUpdateTextureTime === n.currentTime)
            return !1;
        if (n.lastUpdateTextureTime = n.currentTime,
        GLctx.pixelStorei(GLctx.UNPACK_FLIP_Y_WEBGL, !0),
        n.previousUploadedWidth != n.videoWidth || n.previousUploadedHeight != n.videoHeight) {
            GLctx.deleteTexture(GL.textures[i]);
            ...
            GLctx.texImage2D(GLctx.TEXTURE_2D, 0, GLctx.RGBA, GLctx.RGBA, GLctx.UNSIGNED_BYTE, n),
            n.previousUploadedWidth = n.videoWidth,
            n.previousUploadedHeight = n.videoHeight
        } else
            GLctx.bindTexture(GLctx.TEXTURE_2D, GL.textures[i]),
            GLctx.texImage2D(GLctx.TEXTURE_2D, 0, GLctx.RGBA, GLctx.RGBA, GLctx.UNSIGNED_BYTE, n);
        return GLctx.pixelStorei(GLctx.UNPACK_FLIP_Y_WEBGL, !1),
        !0
    }
    function _JS_Video_Width(e) {
        return videoInstances[e].videoWidth
    }
    var webcam = {
        canvas: null
    };
    function _JS_WebCamVideo_CanPlay(e) {
        return MediaDevices[e].video && MediaDevices[e].video.videoWidth > 0 && MediaDevices[e].video.videoHeight > 0
    }
    function _JS_WebCamVideo_GetDeviceName(e, i, n) {
        return i && stringToUTF8(MediaDevices[e].deviceName, i, n),
        lengthBytesUTF8(MediaDevices[e].deviceName)
    }
    function _JS_WebCamVideo_GetNativeHeight(e) {
        return MediaDevices[e].video ? MediaDevices[e].video.videoHeight : 0
    }
    function _JS_WebCamVideo_GetNativeWidth(e) {
        return MediaDevices[e].video ? MediaDevices[e].video.videoWidth : 0
    }
    function _JS_WebCamVideo_GetNumDevices() {
        return MediaDevices.length
    }
    function _JS_WebCamVideo_GrabFrame(e, i, n, t) {
        if (MediaDevices[e].video) {
            var r = webcam.canvas.getContext("2d");
            if (r)
                canvas.width = n,
                canvas.height = t,
                r.drawImage(MediaDevices[e].video, 0, 0, MediaDevices[e].video.videoWidth, MediaDevices[e].video.videoHeight, 0, 0, n, t),
                writeArrayToMemory(r.getImageData(0, 0, n, t).data, i);
            else
                console.log("2d Context is null")
        } else
            console.error("WebCam not initialized.")
    }
    function _JS_WebCamVideo_Start(e) {
        if (MediaDevices[e].video)
            MediaDevices[e].refCount++;
        else if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia ? navigator.getMedia = function(e, i, n) {
            navigator.mediaDevices.getUserMedia(e).then(i).catch(n)
        }
        ...
        navigator.getMedia) {
            if (!webcam.canvas) {
                ...
                !canvas.getContext("2d"))
                    return void console.log("context2d is null");
            ...
            navigator.getMedia({
                ...
                i.srcObject = n,
                webcam.canvas.appendChild(i),
                i.play(),
                MediaDevices[e].video = i,
                MediaDevices[e].stream = n,
                MediaDevices[e].refCount++
            }
            ), (function(e) {
    ...
    function _JS_WebCamVideo_Stop(e) {
        MediaDevices[e].video ? 0 == --MediaDevices[e].refCount && (webcam.canvas.removeChild(MediaDevices[e].video),
        MediaDevices[e].video = null,
        MediaDevices[e].stream.getVideoTracks().forEach((function(e) {
            e.stop && e.stop()
        }
        ))) : console.error("WebCam not initialized.")
    }
    function _JS_WebCam_IsSupported() {
        return null != (navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia)
    }
    var wr = {
        requestInstances: {},
        nextRequestId: 1
    ...
    function _JS_WebRequest_Create(e, i) {
        var n = Pointer_stringify(e)
          , t = Pointer_stringify(i)
          , r = Module.companyName && Module.productName && Module.XMLHttpRequest ? new Module.XMLHttpRequest({
            companyName: Module.companyName,
            productName: Module.productName,
            cacheControl: Module.cacheControl(n)
        }) : new XMLHttpRequest;
        return r.open(t, n, !0),
        r.responseType = "arraybuffer",
        wr.requestInstances[wr.nextRequestId] = r,
        wr.nextRequestId++
    }
    function _JS_WebRequest_GetResponseHeaders(e, i, n) {
        var t = wr.requestInstances[e].getAllResponseHeaders();
        return i && stringToUTF8(t, i, n),
        lengthBytesUTF8(t)
    }
    ...
    function _JS_WebRequest_SetProgressHandler(e, i, n) {
        wr.requestInstances[e].onprogress = function(e) {
    ...
    function _JS_WebRequest_SetResponseHandler(e, i, n) {
        ...
        function r(e, r) {
            if (n) {
                var o = lengthBytesUTF8(e) + 1
                  , _ = _malloc(o);
                stringToUTF8(e, _, o),
                dynCall("viiiiii", n, [i, t.status, 0, 0, _, r]),
                _free(_)
            }
        }
        t.onload = function(e) {
            if (n) {
                ...
                if (0 != r.length) {
                    var o = _malloc(r.length);
                    HEAPU8.set(r, o),
                    dynCall("viiiiii", n, [i, t.status, o, r.length, 0, 0])
                } else
                    dynCall("viiiiii", n, [i, t.status, 0, 0, 0, 0])
            }
        }
        ,
        t.onerror = function(e) {
    ...
    function ___atomic_compare_exchange_8(e, i, n, t, r, o, _) {
        var a = HEAP32[e >> 2]
          , l = HEAP32[e + 4 >> 2]
          , u = HEAP32[i >> 2]
          , s = HEAP32[i + 4 >> 2];
        return a === u && l === s ? (HEAP32[e >> 2] = n,
        HEAP32[e + 4 >> 2] = t,
        1) : (HEAP32[i >> 2] = a,
        HEAP32[i + 4 >> 2] = l,
        0)
    ...
    function ___atomic_fetch_add_8(e, i, n, t) {
        var r = HEAP32[e >> 2]
          , o = HEAP32[e + 4 >> 2];
        return HEAP32[e >> 2] = _i64Add(r, o, i, n),
    ...
    function ___buildEnvironment(e) {
        var i, n;
        ___buildEnvironment.called ? (n = HEAP32[e >> 2],
        i = HEAP32[n >> 2]) : (___buildEnvironment.called = !0,
        ...
        for (var a = 0; a < t.length; a++) {
            writeAsciiToMemory(_ = t[a], i),
            HEAP32[n + 4 * a >> 2] = i,
            i += _.length + 1
        }
        HEAP32[n + 4 * t.length >> 2] = 0
    }
    ...
    var EXCEPTIONS = {
        ...
        deAdjust: function(e) {
            if (!e || EXCEPTIONS.infos[e])
                return e;
            for (var i in EXCEPTIONS.infos) {
                var n = +i;
                if (EXCEPTIONS.infos[n].adjusted === e)
                    return n
            }
            return e
        },
        ...
        decRef: function(e) {
            if (e) {
                ...
                assert(i.refcount > 0),
                i.refcount--,
                0 !== i.refcount || i.rethrown || (i.destructor && Module.dynCall_vi(i.destructor, e),
    ...
    function ___cxa_end_catch() {
        ...
        e && (EXCEPTIONS.decRef(EXCEPTIONS.deAdjust(e)),
        EXCEPTIONS.last = 0)
    }
    ...
    function ___cxa_rethrow() {
        var e = EXCEPTIONS.caught.pop();
        throw e = EXCEPTIONS.deAdjust(e),
        EXCEPTIONS.infos[e].rethrown || (EXCEPTIONS.caught.push(e),
        EXCEPTIONS.infos[e].rethrown = !0),
        EXCEPTIONS.last = e,
        e
    }
    ...
    function ___cxa_find_matching_catch() {
        ...
        for (var r = 0; r < t.length; r++)
            if (t[r] && Module.___cxa_can_catch(t[r], n, e))
                return e = HEAP32[e >> 2],
                i.adjusted = e,
                0 | (setTempRet0(t[r]),
                e);
    ...
    function ___map_file(e, i) {
        return ___setErrNo(ERRNO_CODES.EPERM),
        -1
    }
    var ERRNO_MESSAGES = {
        0: "Success",
      ...
      , PATH = {
        ...
        resolve: function() {
            ...
            return (i ? "/" : "") + (e = PATH.normalizeArray(e.split("/").filter((function(e) {
                return !!e
            }
            )), !i).join("/")) || "."
        },
        relative: function(e, i) {
            ...
            for (var t = n(e.split("/")), r = n(i.split("/")), o = Math.min(t.length, r.length), _ = o, a = 0; a < o; a++)
                if (t[a] !== r[a]) {
                    _ = a;
                    break
                }
            var l = [];
            for (a = _; a < t.length; a++)
                l.push("..");
            return (l = l.concat(r.slice(_))).join("/")
        }
    }
      , TTY = {
        ttys: [],
        ...
        stream_ops: {
            ...
            write: function(e, i, n, t, r) {
                ...
                for (var o = 0; o < t; o++)
                    try {
                        e.tty.ops.put_char(e.tty, i[n + o])
                    } catch (e) {
                        throw new FS.ErrnoError(ERRNO_CODES.EIO)
                    }
        ...
        default_tty_ops: {
            get_char: function(e) {
                if (!e.input.length) {
                    ...
                    if (ENVIRONMENT_IS_NODE) {
                        ...
                        _ && fs.closeSync(o),
                        i = t > 0 ? n.slice(0, t).toString("utf-8") : null
                    } else
            ...
            put_char: function(e, i) {
                null === i || 10 === i ? (out(UTF8ArrayToString(e.output, 0)),
        ...
        default_tty1_ops: {
            put_char: function(e, i) {
                null === i || 10 === i ? (err(UTF8ArrayToString(e.output, 0)),
                e.output = []) : 0 != i && e.output.push(i)
            },
            flush: function(e) {
      ...
      , MEMFS = {
        ...
        createNode: function(e, i, n, t) {
            ...
            return FS.isDir(r.mode) ? (r.node_ops = MEMFS.ops_table.dir.node,
            r.stream_ops = MEMFS.ops_table.dir.stream,
            r.contents = {}) : FS.isFile(r.mode) ? (r.node_ops = MEMFS.ops_table.file.node,
            r.stream_ops = MEMFS.ops_table.file.stream,
            r.usedBytes = 0,
            r.contents = null) : FS.isLink(r.mode) ? (r.node_ops = MEMFS.ops_table.link.node,
            r.stream_ops = MEMFS.ops_table.link.stream) : FS.isChrdev(r.mode) && (r.node_ops = MEMFS.ops_table.chrdev.node,
        ...
        expandFileStorage: function(e, i) {
            if (e.contents && e.contents.subarray && i > e.contents.length && (e.contents = MEMFS.getFileDataAsRegularArray(e),
            ...
            !e.contents || e.contents.subarray) {
                ...
                var t = e.contents;
                return e.contents = new Uint8Array(i),
                void (e.usedBytes > 0 && e.contents.set(t.subarray(0, e.usedBytes), 0))
            }
            for (!e.contents && i > 0 && (e.contents = []); e.contents.length < i; )
                e.contents.push(0)
        },
        resizeFileStorage: function(e, i) {
            if (e.usedBytes != i) {
                ...
                if (!e.contents || e.contents.subarray) {
                    var n = e.contents;
                    return e.contents = new Uint8Array(new ArrayBuffer(i)),
        ...
        node_ops: {
            getattr: function(e) {
                var i = {};
                return i.dev = FS.isChrdev(e.mode) ? e.id : 1,
                i.ino = e.id,
                i.mode = e.mode,
                i.nlink = 1,
                i.uid = 0,
                i.gid = 0,
                i.rdev = e.rdev,
                FS.isDir(e.mode) ? i.size = 4096 : FS.isFile(e.mode) ? i.size = e.usedBytes : FS.isLink(e.mode) ? i.size = e.link.length : i.size = 0,
            ...
            symlink: function(e, i, n) {
                var t = MEMFS.createNode(e, i, 41471, 0);
                return t.link = n,
                t
            },
            readlink: function(e) {
        ...
        stream_ops: {
            read: function(e, i, n, t, r) {
                ...
                if (r >= e.node.usedBytes)
                    return 0;
                var _ = Math.min(e.node.usedBytes - r, t);
                if (assert(_ >= 0),
                _ > 8 && o.subarray)
                    i.set(o.subarray(r, r + _), n);
                else
                    for (var a = 0; a < _; a++)
                        i[n + a] = o[r + a];
                return _
            },
            write: function(e, i, n, t, r, o) {
                if (!t)
                    return 0;
                var _ = e.node;
                if (_.timestamp = Date.now(),
                i.subarray && (!_.contents || _.contents.subarray)) {
                    if (o)
                        return _.contents = i.subarray(n, n + t),
                        _.usedBytes = t,
                        t;
                    if (0 === _.usedBytes && 0 === r)
                        return _.contents = new Uint8Array(i.subarray(n, n + t)),
                        _.usedBytes = t,
                        t;
                    if (r + t <= _.usedBytes)
                        return _.contents.set(i.subarray(n, n + t), r),
                        t
                }
                if (MEMFS.expandFileStorage(_, r + t),
                _.contents.subarray && i.subarray)
                    _.contents.set(i.subarray(n, n + t), r);
                else
                    for (var a = 0; a < t; a++)
                        _.contents[r + a] = i[n + a];
                return _.usedBytes = Math.max(_.usedBytes, r + t),
                t
            },
            llseek: function(e, i, n) {
                var t = i;
                if (1 === n ? t += e.position : 2 === n && FS.isFile(e.node.mode) && (t += e.node.usedBytes),
                t < 0)
                    throw new FS.ErrnoError(ERRNO_CODES.EINVAL);
                return t
            },
            ...
            mmap: function(e, i, n, t, r, o, _) {
                if (!FS.isFile(e.node.mode))
                    throw new FS.ErrnoError(ERRNO_CODES.ENODEV);
                var a, l, u = e.node.contents;
                if (2 & _ || u.buffer !== i && u.buffer !== i.buffer) {
                    if ((r > 0 || r + t < e.node.usedBytes) && (u = u.subarray ? u.subarray(r, r + t) : Array.prototype.slice.call(u, r, r + t)),
                    l = !0,
                    !(a = _malloc(t)))
            ...
            msync: function(e, i, n, t, r) {
                ...
                if (2 & r)
                    return 0;
                MEMFS.stream_ops.write(e, i, 0, t, n, !1);
                return 0
            }
        }
    }
      , IDBFS = {
        ...
        getDB: function(e, i) {
            ...
            n.onupgradeneeded = function(e) {
                var i, n = e.target.result, t = e.target.transaction;
                (i = n.objectStoreNames.contains(IDBFS.DB_STORE_NAME) ? t.objectStore(IDBFS.DB_STORE_NAME) : n.createObjectStore(IDBFS.DB_STORE_NAME)).indexNames.contains("timestamp") || i.createIndex("timestamp", "timestamp", {
                    unique: !1
                })
            }
            ,
        ...
        getLocalSet: function(e, i) {
            ...
            for (var o = FS.readdir(e.mountpoint).filter(t).map(r(e.mountpoint)); o.length; ) {
                var _, a = o.pop();
                try {
                    _ = FS.stat(a)
                } catch (e) {
                ...
                FS.isDir(_.mode) && o.push.apply(o, FS.readdir(a).filter(t).map(r(a))),
                n[a] = {
                    timestamp: _.mtime
                }
            }
        ...
        loadLocalEntry: function(e, i) {
            ...
            return FS.isDir(n.mode) ? i(null, {
                timestamp: n.mtime,
                mode: n.mode
            }) : FS.isFile(n.mode) ? (t.contents = MEMFS.getFileDataAsTypedArray(t),
            i(null, {
                timestamp: n.mtime,
                mode: n.mode,
                contents: t.contents
        ...
        storeLocalEntry: function(e, i, n) {
            try {
                ...
                FS.chmod(e, i.mode),
                FS.utime(e, i.timestamp, i.timestamp)
            } catch (e) {
                return n(e)
            }
            n(null)
        ...
        reconcile: function(e, i, n) {
            ...
            Object.keys(e.entries).forEach((function(n) {
                var o = e.entries[n]
                  , _ = i.entries[n];
                (!_ || o.timestamp > _.timestamp) && (r.push(n),
                t++)
            }
            ));
            var o = [];
            if (Object.keys(i.entries).forEach((function(n) {
                i.entries[n];
                e.entries[n] || (o.push(n),
                t++)
            }
            )),
            !t)
                return n(null);
            var _ = 0
              , a = ("remote" === e.type ? e.db : i.db).transaction([IDBFS.DB_STORE_NAME], "readwrite")
              , l = a.objectStore(IDBFS.DB_STORE_NAME);
            function u(e) {
                return e ? u.errored ? void 0 : (u.errored = !0,
                n(e)) : ++_ >= t ? n(null) : void 0
            }
            ...
            r.sort().forEach((function(e) {
                "local" === i.type ? IDBFS.loadRemoteEntry(l, e, (function(i, n) {
                    if (i)
                        return u(i);
                    IDBFS.storeLocalEntry(e, n, u)
                }
                )) : IDBFS.loadLocalEntry(e, (function(i, n) {
                    if (i)
                        return u(i);
                    IDBFS.storeRemoteEntry(l, e, n, u)
                }
                ))
            }
            )),
            o.sort().reverse().forEach((function(e) {
                "local" === i.type ? IDBFS.removeLocalEntry(e, u) : IDBFS.removeRemoteEntry(l, e, u)
            }
            ))
        }
    }
      , NODEFS = {
        ...
        createNode: function(e, i, n, t) {
            ...
            return r.node_ops = NODEFS.node_ops,
        ...
        realPath: function(e) {
            for (var i = []; e.parent !== e; )
                i.push(e.name),
                e = e.parent;
            return i.push(e.mount.opts.root),
            i.reverse(),
            PATH.join.apply(null, i)
        },
        flagsForNode: function(e) {
            ...
            e &= -524289;
            var i = 0;
            for (var n in NODEFS.flagsForNodeMap)
                e & n && (i |= NODEFS.flagsForNodeMap[n],
                e ^= n);
            if (e)
                throw new FS.ErrnoError(ERRNO_CODES.EINVAL);
            return i
        ...
        node_ops: {
            getattr: function(e) {
                ...
                return NODEFS.isWindows && !i.blksize && (i.blksize = 4096),
                NODEFS.isWindows && !i.blocks && (i.blocks = (i.size + i.blksize - 1) / i.blksize | 0),
                {
                    dev: i.dev,
                    ino: i.ino,
                    mode: i.mode,
            ...
            setattr: function(e, i) {
                ...
                try {
                    if (void 0 !== i.mode && (fs.chmodSync(n, i.mode),
                    e.mode = i.mode),
                    void 0 !== i.timestamp) {
                        var t = new Date(i.timestamp);
                        fs.utimesSync(n, t, t)
                    }
                    void 0 !== i.size && fs.truncateSync(n, i.size)
                } catch (e) {
                    if (!e.code)
                        throw e;
                    throw new FS.ErrnoError(ERRNO_CODES[e.code])
            ...
            mknod: function(e, i, n, t) {
                var r = NODEFS.createNode(e, i, n, t)
                  , o = NODEFS.realPath(r);
                try {
                    FS.isDir(r.mode) ? fs.mkdirSync(o, r.mode) : fs.writeFileSync(o, "", {
                        mode: r.mode
                    })
                } catch (e) {
                    if (!e.code)
            ...
            readlink: function(e) {
                var i = NODEFS.realPath(e);
                try {
                    return i = fs.readlinkSync(i),
                    i = NODEJS_PATH.relative(NODEJS_PATH.resolve(e.mount.opts.root), i)
                } catch (e) {
                    if (!e.code)
                        throw e;
                    throw new FS.ErrnoError(ERRNO_CODES[e.code])
      ...
      , WORKERFS = {
        ...
        mount: function(e) {
            ...
            var i = WORKERFS.createNode(null, "/", WORKERFS.DIR_MODE, 0)
              , n = {};
            function t(e) {
                for (var t = e.split("/"), r = i, o = 0; o < t.length - 1; o++) {
                    var _ = t.slice(0, o + 1).join("/");
                    n[_] || (n[_] = WORKERFS.createNode(r, t[o], WORKERFS.DIR_MODE, 0)),
                    r = n[_]
                }
                return r
            }
            ...
            return Array.prototype.forEach.call(e.opts.files || [], (function(e) {
                WORKERFS.createNode(t(e.name), r(e.name), WORKERFS.FILE_MODE, 0, e, e.lastModifiedDate)
            }
            )),
            (e.opts.blobs || []).forEach((function(e) {
                WORKERFS.createNode(t(e.name), r(e.name), WORKERFS.FILE_MODE, 0, e.data)
            }
            )),
            (e.opts.packages || []).forEach((function(e) {
                e.metadata.files.forEach((function(i) {
                    var n = i.filename.substr(1);
                    WORKERFS.createNode(t(n), r(n), WORKERFS.FILE_MODE, 0, e.blob.slice(i.start, i.end))
                }
                ))
            }
            )),
        ...
        createNode: function(e, i, n, t, r, o) {
            var _ = FS.createNode(e, i, n);
            return _.mode = n,
            _.node_ops = WORKERFS.node_ops,
            _.stream_ops = WORKERFS.stream_ops,
            _.timestamp = (o || new Date).getTime(),
            assert(WORKERFS.FILE_MODE !== WORKERFS.DIR_MODE),
            n === WORKERFS.FILE_MODE ? (_.size = r.size,
            _.contents = r) : (_.size = 4096,
            _.contents = {}),
            e && (e.contents[i] = _),
            _
        },
        ...
        stream_ops: {
            read: function(e, i, n, t, r) {
                ...
                var o = e.node.contents.slice(r, r + t)
                  , _ = WORKERFS.reader.readAsArrayBuffer(o);
                return i.set(new Uint8Array(_), n),
                o.size
            },
            write: function(e, i, n, t, r) {
                throw new FS.ErrnoError(ERRNO_CODES.EIO)
            ...
            llseek: function(e, i, n) {
                var t = i;
                if (1 === n ? t += e.position : 2 === n && FS.isFile(e.node.mode) && (t += e.node.size),
                t < 0)
                    throw new FS.ErrnoError(ERRNO_CODES.EINVAL);
                return t
            }
    ...
    var FS = {
        ...
        lookupPath: function(e, i) {
            ...
            for (var r = PATH.normalizeArray(e.split("/").filter((function(e) {
                return !!e
            }
            )), !1), o = FS.root, _ = "/", a = 0; a < r.length; a++) {
                var l = a === r.length - 1;
                if (l && i.parent)
                    break;
                if (o = FS.lookupNode(o, r[a]),
                _ = PATH.join2(_, r[a]),
                FS.isMountpoint(o) && (!l || l && i.follow_mount) && (o = o.mounted.root),
                !l || i.follow)
                    for (var u = 0; FS.isLink(o.mode); ) {
                        var s = FS.readlink(_);
                        if (_ = PATH.resolve(PATH.dirname(_), s),
                        o = FS.lookupPath(_, {
        ...
        hashName: function(e, i) {
            for (var n = 0, t = 0; t < i.length; t++)
                n = (n << 5) - n + i.charCodeAt(t) | 0;
        ...
        lookupNode: function(e, i) {
            ...
            for (var t = FS.hashName(e.id, i), r = FS.nameTable[t]; r; r = r.name_next) {
                var o = r.name;
                if (r.parent.id === e.id && o === i)
                    return r
            }
        ...
        createNode: function(e, i, n, t) {
            ...
            var _ = new FS.FSNode(e,i,n,t);
            return FS.hashAddNode(_),
            _
        },
        ...
        nodePermissions: function(e, i) {
            return FS.ignorePermissions || (-1 === i.indexOf("r") || 292 & e.mode) && (-1 === i.indexOf("w") || 146 & e.mode) && (-1 === i.indexOf("x") || 73 & e.mode) ? 0 : ERRNO_CODES.EACCES
        },
        mayLookup: function(e) {
            var i = FS.nodePermissions(e, "x");
            return i || (e.node_ops.lookup ? 0 : ERRNO_CODES.EACCES)
        },
        ...
        mount: function(e, i, n) {
            ...
            return l.mount = a,
            a.root = l,
            r ? FS.root = l : t && (t.mounted = a,
            t.mount && t.mount.mounts.push(a)),
            l
        },
        unmount: function(e) {
            ...
            if (!FS.isMountpoint(i.node))
                throw new FS.ErrnoError(ERRNO_CODES.EINVAL);
            var n = i.node
              , t = n.mounted
              , r = FS.getMounts(t);
            Object.keys(FS.nameTable).forEach((function(e) {
                for (var i = FS.nameTable[e]; i; ) {
                    var n = i.name_next;
                    -1 !== r.indexOf(i.mount) && FS.destroyNode(i),
                    i = n
                }
            }
            )),
        ...
        mknod: function(e, i, n) {
            ...
            if (!r || "." === r || ".." === r)
                throw new FS.ErrnoError(ERRNO_CODES.EINVAL);
            var o = FS.mayCreate(t, r);
            if (o)
                throw new FS.ErrnoError(o);
            if (!t.node_ops.mknod)
                throw new FS.ErrnoError(ERRNO_CODES.EPERM);
            return t.node_ops.mknod(t, r, i, n)
        },
        create: function(e, i) {
            return i = void 0 !== i ? i : 438,
            i &= 4095,
            i |= 32768,
            FS.mknod(e, i, 0)
        },
        mkdir: function(e, i) {
            return i = void 0 !== i ? i : 511,
            i &= 1023,
            i |= 16384,
            FS.mknod(e, i, 0)
        },
        ...
        rename: function(e, i) {
            var n, t, r = PATH.dirname(e), o = PATH.dirname(i), _ = PATH.basename(e), a = PATH.basename(i);
            try {
                n = FS.lookupPath(e, {
                    parent: !0
                }).node,
            ...
            var l, u = FS.lookupNode(n, _), s = PATH.relative(e, o);
            if ("." !== s.charAt(0))
                throw new FS.ErrnoError(ERRNO_CODES.EINVAL);
            if ("." !== (s = PATH.relative(i, r)).charAt(0))
                throw new FS.ErrnoError(ERRNO_CODES.ENOTEMPTY);
            try {
                l = FS.lookupNode(t, a)
            } catch (e) {}
            if (u !== l) {
                var c = FS.isDir(u.mode)
                  , f = FS.mayDelete(n, _, c);
                if (f)
                    throw new FS.ErrnoError(f);
                if (f = l ? FS.mayDelete(t, a, c) : FS.mayCreate(t, a))
                    throw new FS.ErrnoError(f);
                if (!n.node_ops.rename)
                    throw new FS.ErrnoError(ERRNO_CODES.EPERM);
                if (FS.isMountpoint(u) || l && FS.isMountpoint(l))
                    throw new FS.ErrnoError(ERRNO_CODES.EBUSY);
                if (t !== n && (f = FS.nodePermissions(n, "w")))
                    throw new FS.ErrnoError(f);
                try {
                    FS.trackingDelegate.willMovePath && FS.trackingDelegate.willMovePath(e, i)
                } catch (n) {
                    console.log("FS.trackingDelegate['willMovePath']('" + e + "', '" + i + "') threw an exception: " + n.message)
                }
                FS.hashRemoveNode(u);
                try {
                    n.node_ops.rename(u, t, a)
                } catch (e) {
                    throw e
                } finally {
                    FS.hashAddNode(u)
                ...
                try {
                    ...
                    console.log("FS.trackingDelegate['onMovePath']('" + e + "', '" + i + "') threw an exception: " + n.message)
                }
            }
        },
        rmdir: function(e) {
            ...
            try {
                ...
                console.log("FS.trackingDelegate['willDeletePath']('" + e + "') threw an exception: " + i.message)
            }
            ...
            try {
                ...
                console.log("FS.trackingDelegate['onDeletePath']('" + e + "') threw an exception: " + i.message)
            }
        },
        readdir: function(e) {
            var i = FS.lookupPath(e, {
        ...
        readlink: function(e) {
            var i = FS.lookupPath(e).node;
            if (!i)
                throw new FS.ErrnoError(ERRNO_CODES.ENOENT);
            if (!i.node_ops.readlink)
                throw new FS.ErrnoError(ERRNO_CODES.EINVAL);
            return PATH.resolve(FS.getPath(i.parent), i.node_ops.readlink(i))
        },
        stat: function(e, i) {
        ...
        open: function(e, i, n, t, r) {
            ...
            var o;
            if (n = void 0 === n ? 438 : n,
            n = 64 & (i = "string" == typeof i ? FS.modeStringToFlags(i) : i) ? 4095 & n | 32768 : 0,
            "object" == typeof e)
                o = e;
            else {
                e = PATH.normalize(e);
            ...
            if (!o)
                throw new FS.ErrnoError(ERRNO_CODES.ENOENT);
            if (FS.isChrdev(o.mode) && (i &= -513),
            65536 & i && !FS.isDir(o.mode))
                throw new FS.ErrnoError(ERRNO_CODES.ENOTDIR);
            if (!_) {
                var a = FS.mayOpen(o, i);
                if (a)
                    throw new FS.ErrnoError(a)
            }
            512 & i && FS.truncate(o, 0),
            i &= -641;
            ...
            !Module.logReadFiles || 1 & i || (FS.readFiles || (FS.readFiles = {}),
            e in FS.readFiles || (FS.readFiles[e] = 1,
            a("read file: " + e)));
            try {
                if (FS.trackingDelegate.onOpenFile) {
                    var u = 0;
                    1 != (2097155 & i) && (u |= FS.tracking.openFlags.READ),
                    0 != (2097155 & i) && (u |= FS.tracking.openFlags.WRITE),
                    FS.trackingDelegate.onOpenFile(e, u)
                }
            } catch (i) {
                console.log("FS.trackingDelegate['onOpenFile']('" + e + "', flags) threw an exception: " + i.message)
            }
            return l
        },
        close: function(e) {
        ...
        read: function(e, i, n, t, r) {
            ...
            if (o) {
                ...
                r = e.position;
            var _ = e.stream_ops.read(e, i, n, t, r);
            return o || (e.position += _),
            _
        },
        write: function(e, i, n, t, r, o) {
            if (t < 0 || r < 0)
            ...
            if (_) {
                ...
                r = e.position;
            var a = e.stream_ops.write(e, i, n, t, r, o);
            _ || (e.position += a);
            try {
        ...
        mmap: function(e, i, n, t, r, o, _) {
            ...
            if (!e.stream_ops.mmap)
                throw new FS.ErrnoError(ERRNO_CODES.ENODEV);
            return e.stream_ops.mmap(e, i, n, t, r, o, _)
        },
        msync: function(e, i, n, t, r) {
        ...
        readFile: function(e, i) {
            if ((i = i || {}).flags = i.flags || "r",
            i.encoding = i.encoding || "binary",
            "utf8" !== i.encoding && "binary" !== i.encoding)
                throw new Error('Invalid encoding type "' + i.encoding + '"');
            var n, t = FS.open(e, i.flags), r = FS.stat(e).size, o = new Uint8Array(r);
            return FS.read(t, o, 0, r, 0),
            "utf8" === i.encoding ? n = UTF8ArrayToString(o, 0) : "binary" === i.encoding && (n = o),
            FS.close(t),
            n
        },
        writeFile: function(e, i, n) {
            ...
            if ("string" == typeof i) {
                var r = new Uint8Array(lengthBytesUTF8(i) + 1)
                  , o = stringToUTF8Array(i, r, 0, r.length);
                FS.write(t, r, 0, o, void 0, n.canOwn)
            } else {
        ...
        chdir: function(e) {
            ...
            if (null === i.node)
                throw new FS.ErrnoError(ERRNO_CODES.ENOENT);
            if (!FS.isDir(i.node.mode))
                throw new FS.ErrnoError(ERRNO_CODES.ENOTDIR);
            var n = FS.nodePermissions(i.node, "x");
            if (n)
        ...
        createPath: function(e, i, n, t) {
            ...
            for (var r = i.split("/").reverse(); r.length; ) {
                var o = r.pop();
                if (o) {
                    var _ = PATH.join2(e, o);
                    try {
                        FS.mkdir(_)
                    } catch (e) {}
                    e = _
        ...
        createFile: function(e, i, n, t, r) {
            var o = PATH.join2("string" == typeof e ? e : FS.getPath(e), i)
              , _ = FS.getMode(t, r);
            return FS.create(o, _)
        },
        createDataFile: function(e, i, n, t, r, o) {
            var _ = i ? PATH.join2("string" == typeof e ? e : FS.getPath(e), i) : e
              , a = FS.getMode(t, r)
              , l = FS.create(_, a);
            if (n) {
                if ("string" == typeof n) {
                    for (var u = new Array(n.length), s = 0, c = n.length; s < c; ++s)
                        u[s] = n.charCodeAt(s);
                    n = u
                }
                FS.chmod(l, 146 | a);
                var f = FS.open(l, "w");
                FS.write(f, n, 0, n.length, 0, o),
                FS.close(f),
                FS.chmod(l, a)
            }
            return l
        ...
        createDevice: function(e, i, n, t) {
            ...
            return FS.registerDevice(_, {
                ...
                read: function(e, i, t, r, o) {
                    for (var _ = 0, a = 0; a < r; a++) {
                        var l;
                        try {
                            l = n()
                        } catch (e) {
                    ...
                    return _ && (e.node.timestamp = Date.now()),
                    _
                },
                write: function(e, i, n, r, o) {
                    for (var _ = 0; _ < r; _++)
                        try {
                            t(i[n + _])
                        } catch (e) {
        ...
        forceLoadFile: function(e) {
            ...
            return i || ___setErrNo(ERRNO_CODES.EIO),
            i
        },
        createLazyFile: function(e, i, n, t, r) {
            ...
            o.prototype.cacheLength = function() {
                ...
                var i, t = Number(e.getResponseHeader("Content-length")), r = (i = e.getResponseHeader("Accept-Ranges")) && "bytes" === i, o = (i = e.getResponseHeader("Content-Encoding")) && "gzip" === i, _ = 1048576;
                r || (_ = t);
                var a = this;
                a.setDataGetter((function(e) {
                    var i = e * _
                      , r = (e + 1) * _ - 1;
                    if (r = Math.min(r, t - 1),
                    void 0 === a.chunks[e] && (a.chunks[e] = function(e, i) {
                        if (e > i)
                        ...
                        if (r.open("GET", n, !1),
                        t !== _ && r.setRequestHeader("Range", "bytes=" + e + "-" + i),
                        ...
                        !(r.status >= 200 && r.status < 300 || 304 === r.status))
                            throw new Error("Couldn't load " + n + ". Status: " + r.status);
                        return void 0 !== r.response ? new Uint8Array(r.response || []) : intArrayFromString(r.responseText || "", !0)
                    }(i, r)),
                    void 0 === a.chunks[e])
            ...
            var l = FS.createFile(e, i, a, t, r);
            a.contents ? l.contents = a.contents : a.url && (l.contents = null,
            l.url = a.url),
            ...
            return Object.keys(l.stream_ops).forEach((function(e) {
                ...
                u[e] = function() {
                    if (!FS.forceLoadFile(l))
                        throw new FS.ErrnoError(ERRNO_CODES.EIO);
                    return i.apply(null, arguments)
                }
            }
            )),
            u.read = function(e, i, n, t, r) {
                if (!FS.forceLoadFile(l))
                    throw new FS.ErrnoError(ERRNO_CODES.EIO);
                var o = e.node.contents;
                if (r >= o.length)
                    return 0;
                var _ = Math.min(o.length - r, t);
                if (assert(_ >= 0),
                o.slice)
                    for (var a = 0; a < _; a++)
                        i[n + a] = o[r + a];
        ...
        createPreloadedFile: function(e, i, n, t, r, o, _, a, l, u) {
            Browser.init();
            var s = i ? PATH.resolve(PATH.join2(e, i)) : e
              , c = getUniqueRunDependency("cp " + s);
            function f(n) {
                function f(n) {
                    u && u(),
                    a || FS.createDataFile(e, i, n, t, r, l),
                    o && o(),
                    removeRunDependency(c)
                }
                var d = !1;
                Module.preloadPlugins.forEach((function(e) {
                    d || e.canHandle(s) && (e.handle(n, s, f, (function() {
                        _ && _(),
                        removeRunDependency(c)
                    }
                    )),
        ...
        saveFilesToDB: function(e, i, n) {
            ...
            var t = FS.indexedDB();
            try {
                var r = t.open(FS.DB_NAME(), FS.DB_VERSION)
            } catch (e) {
                return n(e)
            }
            r.onupgradeneeded = function() {
                console.log("creating db"),
                r.result.createObjectStore(FS.DB_STORE_NAME)
            }
            ,
            r.onsuccess = function() {
                var t = r.result.transaction([FS.DB_STORE_NAME], "readwrite")
                  , o = t.objectStore(FS.DB_STORE_NAME)
                  , _ = 0
                  , a = 0
                  , l = e.length;
                function u() {
                ...
                e.forEach((function(e) {
                    var i = o.put(FS.analyzePath(e).object.contents, e);
        ...
        loadFilesFromDB: function(e, i, n) {
            ...
            r.onsuccess = function() {
                var t = r.result;
                try {
                    var o = t.transaction([FS.DB_STORE_NAME], "readonly")
                } catch (e) {
                    return void n(e)
                }
                var _ = o.objectStore(FS.DB_STORE_NAME)
                  , a = 0
                  , l = 0
                  , u = e.length;
                function s() {
                ...
                e.forEach((function(e) {
                    ...
                    i.onsuccess = function() {
                        ...
                        FS.createDataFile(PATH.dirname(e), PATH.basename(e), i.result, !0, !0, !0),
                        ++a + l == u && s()
                    }
                    ,
                    i.onerror = function() {
      ...
      , SYSCALLS = {
        ...
        doStat: function(e, i, n) {
            try {
                ...
                if (e && e.node && PATH.normalize(i) !== PATH.normalize(FS.getPath(e.node)))
                    return -ERRNO_CODES.ENOTDIR;
                throw e
            }
            return HEAP32[n >> 2] = t.dev,
            HEAP32[n + 4 >> 2] = 0,
            HEAP32[n + 8 >> 2] = t.ino,
        ...
        doAccess: function(e, i) {
            ...
            2 & i && (t += "w"),
            1 & i && (t += "x"),
            t && FS.nodePermissions(n, t) ? -ERRNO_CODES.EACCES : 0
        },
        doDup: function(e, i, n) {
            var t = FS.getStream(n);
            return t && FS.close(t),
            FS.open(e, i, 0, n, n).fd
        },
        doReadv: function(e, i, n, t) {
            for (var r = 0, o = 0; o < n; o++) {
                var _ = HEAP32[i + 8 * o >> 2]
                  , a = HEAP32[i + (8 * o + 4) >> 2]
                  , l = FS.read(e, HEAP8, _, a, t);
                if (l < 0)
                    return -1;
                if (r += l,
                l < a)
        ...
        getSocketAddress: function(e) {
            ...
            if (e && 0 === i)
                return null;
            var t = __read_sockaddr(i, n);
            if (t.errno)
                throw new FS.ErrnoError(t.errno);
            return t.addr = DNS.lookup_addr(t.addr) || t.addr,
            t
        },
        get64: function() {
            var e = SYSCALLS.get()
              , i = SYSCALLS.get();
            return assert(e >= 0 ? 0 === i : -1 === i),
            e
        },
        getZero: function() {
    ...
    var SOCKFS = {
        mount: function(e) {
            return Module.websocket = Module.websocket && "object" == typeof Module.websocket ? Module.websocket : {},
            Module.websocket._callbacks = {},
            Module.websocket.on = function(e, i) {
        ...
        createSocket: function(e, i, n) {
            ...
            var t = {
              ...
              , r = SOCKFS.nextname()
              , o = FS.createNode(SOCKFS.root, r, 49152, 0);
            o.sock = t;
        ...
        stream_ops: {
            ...
            read: function(e, i, n, t, r) {
                var o = e.node.sock
                  , _ = o.sock_ops.recvmsg(o, t);
                return _ ? (i.set(_.buffer, n),
                _.buffer.length) : 0
            },
            write: function(e, i, n, t, r) {
                var o = e.node.sock;
                return o.sock_ops.sendmsg(o, i, n, t)
            },
            close: function(e) {
                var i = e.node.sock;
                i.sock_ops.close(i)
        ...
        websocket_sock_ops: {
            createPeer: function(e, i, n) {
                var t;
                if ("object" == typeof i && (t = i,
                i = null,
                n = null),
                t)
                    if (t._socket)
                        i = t._socket.remoteAddress,
                        n = t._socket.remotePort;
                    else {
                        var r = /ws[s]?:\/\/([^:]+):(\d+)/.exec(t.url);
                        if (!r)
                    ...
                    try {
                        var o = Module.websocket && "object" == typeof Module.websocket
                          , _ = "ws:#".replace("#", "//");
                        if (o && "string" == typeof Module.websocket.url && (_ = Module.websocket.url),
                        "ws://" === _ || "wss://" === _) {
                            var a = i.split("/");
                            _ = _ + a[0] + ":" + n + "/" + a.slice(1).join("/")
                        }
                        var l = "binary";
                        o && "string" == typeof Module.websocket.subprotocol && (l = Module.websocket.subprotocol),
                        l = l.replace(/^ +| +$/g, "").split(/ *, */);
                        var u = ENVIRONMENT_IS_NODE ? {
                            protocol: l.toString()
                        } : l;
                        o && null === Module.websocket.subprotocol && (l = "null",
                        u = void 0),
                        (t = new (ENVIRONMENT_IS_NODE ? require("ws") : ENVIRONMENT_IS_WEB ? window.WebSocket : WebSocket)(_,u)).binaryType = "arraybuffer"
                    } catch (e) {
            ...
            handlePeerEvents: function(e, i) {
                ...
                function r(t) {
                    if (assert("string" != typeof t && void 0 !== t.byteLength),
                    0 != t.byteLength) {
                        t = new Uint8Array(t);
                        var r = n;
                        if (n = !1,
                        r && 10 === t.length && 255 === t[0] && 255 === t[1] && 255 === t[2] && 255 === t[3] && t[4] === "p".charCodeAt(0) && t[5] === "o".charCodeAt(0) && t[6] === "r".charCodeAt(0) && t[7] === "t".charCodeAt(0)) {
                            var o = t[8] << 8 | t[9];
                            return SOCKFS.websocket_sock_ops.removePeer(e, i),
                            i.port = o,
                            void SOCKFS.websocket_sock_ops.addPeer(e, i)
                        }
                        e.recv_queue.push({
                            addr: i.addr,
                            port: i.port,
                ...
                ENVIRONMENT_IS_NODE ? (i.socket.on("open", t),
                i.socket.on("message", (function(e, i) {
                    i.binary && r(new Uint8Array(e).buffer)
                }
                )),
            ...
            poll: function(e) {
                ...
                var i = 0
                  , n = 1 === e.type ? SOCKFS.websocket_sock_ops.getPeer(e, e.daddr, e.dport) : null;
            ...
            ioctl: function(e, i, n) {
                if (21531 === i) {
                    var t = 0;
                    return e.recv_queue.length && (t = e.recv_queue[0].data.length),
                    HEAP32[n >> 2] = t,
                    0
                }
                return ERRNO_CODES.EINVAL
            ...
            connect: function(e, i, n) {
                ...
                if (void 0 !== e.daddr && void 0 !== e.dport) {
                    ...
                    if (t)
                        throw t.socket.readyState === t.socket.CONNECTING ? new FS.ErrnoError(ERRNO_CODES.EALREADY) : new FS.ErrnoError(ERRNO_CODES.EISCONN)
                }
                var r = SOCKFS.websocket_sock_ops.createPeer(e, i, n);
                throw e.daddr = r.addr,
                e.dport = r.port,
                ...
                e.server.on("connection", (function(i) {
                    if (1 === e.type) {
                        var n = SOCKFS.createSocket(e.family, e.type, e.protocol)
                          , t = SOCKFS.websocket_sock_ops.createPeer(n, i);
                        n.daddr = t.addr,
                        n.dport = t.port,
                        e.pending.push(n),
            ...
            sendmsg: function(e, i, n, t, r, o) {
                if (2 === e.type) {
                    if (void 0 !== r && void 0 !== o || (r = e.daddr,
                    o = e.dport),
                    void 0 === r || void 0 === o)
                    ...
                    r = e.daddr,
                    o = e.dport;
                var _, a = SOCKFS.websocket_sock_ops.getPeer(e, r, o);
                if (1 === e.type) {
                    if (!a || a.socket.readyState === a.socket.CLOSING || a.socket.readyState === a.socket.CLOSED)
                        throw new FS.ErrnoError(ERRNO_CODES.ENOTCONN);
                    if (a.socket.readyState === a.socket.CONNECTING)
                        throw new FS.ErrnoError(ERRNO_CODES.EAGAIN)
                }
                ...
                2 === e.type && (!a || a.socket.readyState !== a.socket.OPEN))
                    return a && a.socket.readyState !== a.socket.CLOSING && a.socket.readyState !== a.socket.CLOSED || (a = SOCKFS.websocket_sock_ops.createPeer(e, r, o)),
                    a.dgram_send_queue.push(_),
                    t;
                try {
                    return a.socket.send(_),
                    t
                } catch (e) {
                    throw new FS.ErrnoError(ERRNO_CODES.EINVAL)
                }
            ...
            recvmsg: function(e, i) {
                ...
                if (!n) {
                    if (1 === e.type) {
                        var t = SOCKFS.websocket_sock_ops.getPeer(e, e.daddr, e.dport);
                        if (t) {
                            if (t.socket.readyState === t.socket.CLOSING || t.socket.readyState === t.socket.CLOSED)
                                return null;
                            throw new FS.ErrnoError(ERRNO_CODES.EAGAIN)
                        }
                        throw new FS.ErrnoError(ERRNO_CODES.ENOTCONN)
                ...
                var r = n.data.byteLength || n.data.length
                  , o = n.data.byteOffset || 0
                  , _ = n.data.buffer || n.data
                  , a = Math.min(i, r)
                  , l = {
                    buffer: new Uint8Array(_,o,a),
                    addr: n.addr,
                    port: n.port
                };
                if (1 === e.type && a < r) {
                    var u = r - a;
                    n.data = new Uint8Array(_,o + a,u),
    ...
    function __inet_pton6_raw(e) {
        ...
        for ((e = 0 === e.indexOf("::") ? e.replace("::", "Z:") : e.replace("::", ":Z:")).indexOf(".") > 0 ? ((i = (e = e.replace(new RegExp("[.]","g"), ":")).split(":"))[i.length - 4] = parseInt(i[i.length - 4]) + 256 * parseInt(i[i.length - 3]),
        i[i.length - 3] = parseInt(i[i.length - 2]) + 256 * parseInt(i[i.length - 1]),
        ...
        n = 0; n < i.length; n++)
            if ("string" == typeof i[n])
                if ("Z" === i[n]) {
                    for (r = 0; r < 8 - i.length + 1; r++)
                        o[n + r] = 0;
                    t = r - 1
                } else
                    o[n + t] = _htons(parseInt(i[n], 16));
            else
                o[n + t] = i[n];
    ...
    function __inet_ntop6_raw(e) {
        ...
        if (u) {
            if (s = __inet_ntop4_raw(l[6] | l[7] << 16),
            -1 === l[5])
                return i = "::ffff:",
                i += s;
            if (0 === l[5])
        ...
        for (n = 0; n < 8; n++)
            ...
            _ > t && (o = n - (t = _) + 1);
        for (n = 0; n < 8; n++)
            t > 1 && 0 === l[n] && n >= o && n < o + t ? n === o && (i += ":",
            0 === o && (i += ":")) : (i += Number(_ntohs(65535 & l[n])).toString(16),
            i += n < 7 ? ":" : "");
        return i
    }
    function __read_sockaddr(e, i) {
        var n, t = HEAP16[e >> 1], r = _ntohs(HEAP16[e + 2 >> 1]);
        switch (t) {
        case 2:
            if (16 !== i)
                return {
            ...
            n = __inet_ntop4_raw(n = HEAP32[e + 4 >> 2]);
            break;
        case 10:
            if (28 !== i)
                return {
            ...
            n = __inet_ntop6_raw(n = [HEAP32[e + 8 >> 2], HEAP32[e + 12 >> 2], HEAP32[e + 16 >> 2], HEAP32[e + 20 >> 2]]);
            break;
        default:
            return {
    ...
    function ___syscall102(e, i) {
        ...
        try {
            var n = SYSCALLS.get()
              , t = SYSCALLS.get();
            switch (SYSCALLS.varargs = t,
            n) {
            case 1:
                var r = SYSCALLS.get()
                  , o = SYSCALLS.get()
                  , _ = SYSCALLS.get();
                return assert((a = SOCKFS.createSocket(r, o, _)).stream.fd < 64),
                a.stream.fd;
            case 2:
                var a = SYSCALLS.getSocketFromFD()
                  , l = SYSCALLS.getSocketAddress();
                return a.sock_ops.bind(a, l.addr, l.port),
                0;
            case 3:
                a = SYSCALLS.getSocketFromFD(),
                l = SYSCALLS.getSocketAddress();
                return a.sock_ops.connect(a, l.addr, l.port),
                0;
            case 4:
                a = SYSCALLS.getSocketFromFD();
                var u = SYSCALLS.get();
                return a.sock_ops.listen(a, u),
                0;
            case 5:
                a = SYSCALLS.getSocketFromFD();
                var s = SYSCALLS.get()
                ...
                a.sock_ops.accept(a));
                if (s)
                    assert(!__write_sockaddr(s, c.family, DNS.lookup_name(c.daddr), c.dport).errno);
                return c.stream.fd;
            case 6:
                a = SYSCALLS.getSocketFromFD(),
                s = SYSCALLS.get(),
                SYSCALLS.get();
                return assert(!__write_sockaddr(s, a.family, DNS.lookup_name(a.saddr || "0.0.0.0"), a.sport).errno),
                0;
            case 7:
                a = SYSCALLS.getSocketFromFD(),
                s = SYSCALLS.get(),
                SYSCALLS.get();
                return a.daddr ? (assert(!__write_sockaddr(s, a.family, DNS.lookup_name(a.daddr), a.dport).errno),
                0) : -ERRNO_CODES.ENOTCONN;
            case 11:
                a = SYSCALLS.getSocketFromFD();
                var f = SYSCALLS.get()
                  , d = SYSCALLS.get()
                  , p = (SYSCALLS.get(),
                SYSCALLS.getSocketAddress(!0));
                return p ? a.sock_ops.sendmsg(a, HEAP8, f, d, p.addr, p.port) : FS.write(a.stream, HEAP8, f, d);
            case 12:
                a = SYSCALLS.getSocketFromFD();
                var v = SYSCALLS.get()
                  , m = SYSCALLS.get();
                ...
                s = SYSCALLS.get(),
                SYSCALLS.get();
                if (!(F = a.sock_ops.recvmsg(a, m)))
                    return 0;
                if (s)
                    assert(!__write_sockaddr(s, a.family, DNS.lookup_name(F.addr), F.port).errno);
                return HEAPU8.set(F.buffer, v),
                F.buffer.byteLength;
            case 14:
            ...
            case 15:
                ...
                var y = SYSCALLS.get()
                  ...
                  , g = SYSCALLS.get()
                  , E = SYSCALLS.get();
                return 1 === y && 4 === S ? (HEAP32[g >> 2] = a.error,
                HEAP32[E >> 2] = 4,
                a.error = null,
                0) : -ERRNO_CODES.ENOPROTOOPT;
            case 16:
                a = SYSCALLS.getSocketFromFD(),
                f = SYSCALLS.get(),
                SYSCALLS.get();
                var M, L = HEAP32[f + 8 >> 2], h = HEAP32[f + 12 >> 2], b = HEAP32[f >> 2], k = HEAP32[f + 4 >> 2];
                if (b) {
                    if ((l = __read_sockaddr(b, k)).errno)
                        return -l.errno;
                    M = l.port,
                    s = DNS.lookup_addr(l.addr) || l.addr
                }
                for (var C = 0, A = 0; A < h; A++)
                    C += HEAP32[L + (8 * A + 4) >> 2];
                var w = new Uint8Array(C)
                  , R = 0;
                for (A = 0; A < h; A++)
                    for (var G = HEAP32[L + (8 * A + 0) >> 2], O = HEAP32[L + (8 * A + 4) >> 2], I = 0; I < O; I++)
                        w[R++] = HEAP8[G + I >> 0];
                return a.sock_ops.sendmsg(a, w, 0, C, s, M);
            case 17:
                for (a = SYSCALLS.getSocketFromFD(),
                f = SYSCALLS.get(),
                SYSCALLS.get(),
                L = HEAP32[f + 8 >> 2],
                h = HEAP32[f + 12 >> 2],
                ...
                A = 0; A < h; A++)
                    C += HEAP32[L + (8 * A + 4) >> 2];
                var F;
                if (!(F = a.sock_ops.recvmsg(a, C)))
                    return 0;
                if (b = HEAP32[f >> 2])
                    assert(!__write_sockaddr(b, a.family, DNS.lookup_name(F.addr), F.port).errno);
                var P = 0
                  , B = F.buffer.byteLength;
                for (A = 0; B > 0 && A < h; A++) {
                    G = HEAP32[L + (8 * A + 0) >> 2];
                    if (O = HEAP32[L + (8 * A + 4) >> 2]) {
                        d = Math.min(O, B),
                        v = F.buffer.subarray(P, P + d);
                        HEAPU8.set(v, G + P),
                        P += d,
                        B -= d
                    }
    ...
    function ___syscall122(e, i) {
        ...
        try {
            ...
            function r(e, i) {
                writeAsciiToMemory(i, n + t[e])
            }
            return r("sysname", "Emscripten"),
            r("nodename", "emscripten"),
            r("release", "1.0"),
            r("version", "#1"),
            r("machine", "x86-JS"),
            0
        } catch (o) {
            return void 0 !== FS && o instanceof FS.ErrnoError || abort(o),
            -o.errno
        }
    }
    function ___syscall140(e, i) {
        ...
        try {
            ...
            SYSCALLS.get())
              ...
              , o = SYSCALLS.get()
              , _ = t;
            return FS.llseek(n, _, o),
            HEAP32[r >> 2] = n.position,
            n.getdents && 0 === _ && 0 === o && (n.getdents = null),
            0
        } catch (e) {
            return void 0 !== FS && e instanceof FS.ErrnoError || abort(e),
            -e.errno
    ...
    function ___syscall142(e, i) {
        ...
        try {
            var n = SYSCALLS.get()
              ...
              , o = SYSCALLS.get();
            SYSCALLS.get();
            assert(n <= 64, "nfds must be less than or equal to 64"),
            ...
            var _ = 0
              ...
              , y = 0
              , S = 0
              , g = (t ? HEAP32[t >> 2] : 0) | (r ? HEAP32[r >> 2] : 0) | (o ? HEAP32[o >> 2] : 0)
              , E = (t ? HEAP32[t + 4 >> 2] : 0) | (r ? HEAP32[r + 4 >> 2] : 0) | (o ? HEAP32[o + 4 >> 2] : 0);
            function M(e, i, n, t) {
                return e < 32 ? i & t : n & t
            }
            for (var L = 0; L < n; L++) {
                var h = 1 << L % 32;
                if (M(L, g, E, h)) {
                    var b = FS.getStream(L);
                    if (!b)
                        throw new FS.ErrnoError(ERRNO_CODES.EBADF);
                    var k = SYSCALLS.DEFAULT_POLLMASK;
                    b.stream_ops.poll && (k = b.stream_ops.poll(b)),
                    1 & k && M(L, a, l, h) && (L < 32 ? d |= h : p |= h,
                    _++),
                    4 & k && M(L, u, s, h) && (L < 32 ? v |= h : m |= h,
                    _++),
                    2 & k && M(L, c, f, h) && (L < 32 ? y |= h : S |= h,
                    _++)
                }
            }
            return t && (HEAP32[t >> 2] = d,
            HEAP32[t + 4 >> 2] = p),
            r && (HEAP32[r >> 2] = v,
            HEAP32[r + 4 >> 2] = m),
            o && (HEAP32[o >> 2] = y,
            ...
            return void 0 !== FS && C instanceof FS.ErrnoError || abort(C),
            -C.errno
        }
    }
    ...
    function ___syscall168(e, i) {
        SYSCALLS.varargs = i;
        try {
            for (var n = SYSCALLS.get(), t = SYSCALLS.get(), r = (SYSCALLS.get(),
            0), o = 0; o < t; o++) {
                var _ = n + 8 * o
                  , a = HEAP32[_ >> 2]
                  , l = HEAP16[_ + 4 >> 1]
                  , u = 32
                  , s = FS.getStream(a);
                s && (u = SYSCALLS.DEFAULT_POLLMASK,
                s.stream_ops.poll && (u = s.stream_ops.poll(s))),
                (u &= 24 | l) && r++,
                HEAP16[_ + 6 >> 1] = u
            }
            return r
    ...
    function ___syscall183(e, i) {
        ...
        try {
            ...
            if (0 === t)
                return -ERRNO_CODES.EINVAL;
            var r = FS.cwd();
            return t < lengthBytesUTF8(r) + 1 ? -ERRNO_CODES.ERANGE : (stringToUTF8(r, n, t),
            n)
        } catch (e) {
            return void 0 !== FS && e instanceof FS.ErrnoError || abort(e),
            -e.errno
    ...
    function ___syscall192(e, i) {
        SYSCALLS.varargs = i;
        try {
            var n, t = SYSCALLS.get(), r = SYSCALLS.get(), o = SYSCALLS.get(), _ = SYSCALLS.get(), a = SYSCALLS.get(), l = SYSCALLS.get();
            l <<= 12;
            var u = !1;
            if (-1 === a) {
                if (!(n = _memalign(PAGE_SIZE, r)))
                ...
                var c = FS.mmap(s, HEAPU8, t, r, l, o, _);
                n = c.ptr,
                u = c.allocated
            }
            return SYSCALLS.mappings[n] = {
                malloc: n,
                len: r,
                allocated: u,
                fd: a,
    ...
    function ___syscall220(e, i) {
        ...
        try {
            ...
            for (var o = 0; n.getdents.length > 0 && o + 268 <= r; ) {
                var _, a, l = n.getdents.pop();
                if ("." === l[0])
                    _ = 1,
                    a = 4;
                else {
                    ...
                    _ = u.id,
                    a = FS.isChrdev(u.mode) ? 2 : FS.isDir(u.mode) ? 4 : FS.isLink(u.mode) ? 10 : 8
                }
                HEAP32[t + o >> 2] = _,
                HEAP32[t + o + 4 >> 2] = n.position,
                HEAP16[t + o + 8 >> 1] = 268,
                HEAP8[t + o + 10 >> 0] = a,
                stringToUTF8(l, t + o + 11, 256),
                o += 268
            }
            return o
        } catch (e) {
    ...
    function ___syscall221(e, i) {
        ...
        try {
            ...
            switch (SYSCALLS.get()) {
            case 0:
                return (t = SYSCALLS.get()) < 0 ? -ERRNO_CODES.EINVAL : FS.open(n.path, n.flags, 0, t).fd;
            case 1:
            case 2:
            case 13:
            case 14:
    ...
    var PIPEFS = {
        ...
        createPipe: function() {
            ...
            var i = PIPEFS.nextname()
              , n = PIPEFS.nextname()
              , t = FS.createNode(PIPEFS.root, i, 4096, 0)
              , r = FS.createNode(PIPEFS.root, n, 4096, 0);
            t.pipe = e,
            r.pipe = e;
        ...
        stream_ops: {
            ...
            read: function(e, i, n, t, r) {
                for (var o = e.node.pipe, _ = 0, a = 0; a < o.buckets.length; a++) {
                    var l = o.buckets[a];
                    _ += l.offset - l.roffset
                }
                assert(i instanceof ArrayBuffer || ArrayBuffer.isView(i));
                var u = i.subarray(n, n + t);
                if (t <= 0)
                    return 0;
                if (0 == _)
                    throw new FS.ErrnoError(ERRNO_CODES.EAGAIN);
                var s = Math.min(_, t)
                  , c = s
                  , f = 0;
                for (a = 0; a < o.buckets.length; a++) {
                    var d = o.buckets[a]
                      , p = d.offset - d.roffset;
                    if (s <= p) {
                        var v = d.buffer.subarray(d.roffset, d.offset);
                        s < p ? (v = v.subarray(0, s),
                        d.roffset += s) : f++,
                        u.set(v);
                        break
                    }
                    v = d.buffer.subarray(d.roffset, d.offset);
                    u.set(v),
                    u = u.subarray(v.byteLength),
                    s -= v.byteLength,
                    f++
                }
                return f && f == o.buckets.length && (f--,
                o.buckets[f].offset = 0,
                o.buckets[f].roffset = 0),
                o.buckets.splice(0, f),
                c
            },
            write: function(e, i, n, t, r) {
                var o = e.node.pipe;
                assert(i instanceof ArrayBuffer || ArrayBuffer.isView(i));
                var _ = i.subarray(n, n + t)
                  , a = _.byteLength;
                if (a <= 0)
                    return 0;
                var l = null;
                0 == o.buckets.length ? (l = {
                    buffer: new Uint8Array(PIPEFS.BUCKET_BUFFER_SIZE),
                    offset: 0,
                    roffset: 0
                },
                o.buckets.push(l)) : l = o.buckets[o.buckets.length - 1],
                assert(l.offset <= PIPEFS.BUCKET_BUFFER_SIZE);
                var u = PIPEFS.BUCKET_BUFFER_SIZE - l.offset;
                if (u >= a)
                    return l.buffer.set(_, l.offset),
                    l.offset += a,
                    a;
                u > 0 && (l.buffer.set(_.subarray(0, u), l.offset),
                l.offset += u,
                _ = _.subarray(u, _.byteLength));
                for (var s = _.byteLength / PIPEFS.BUCKET_BUFFER_SIZE | 0, c = _.byteLength % PIPEFS.BUCKET_BUFFER_SIZE, f = 0; f < s; f++) {
                    var d = {
                        buffer: new Uint8Array(PIPEFS.BUCKET_BUFFER_SIZE),
                    ...
                    o.buckets.push(d),
                    d.buffer.set(_.subarray(0, PIPEFS.BUCKET_BUFFER_SIZE)),
        ...
        nextname: function() {
            return PIPEFS.nextname.current || (PIPEFS.nextname.current = 0),
    ...
    function ___syscall42(e, i) {
        ...
        try {
            ...
            return HEAP32[n >> 2] = t.readable_fd,
    ...
    function ___syscall91(e, i) {
        ...
        try {
            ...
            if (!r)
                return 0;
            if (t === r.len) {
                var o = FS.getStream(r.fd);
                SYSCALLS.doMsync(n, o, t, r.flags),
                FS.munmap(o),
    ...
    function _clock() {
        return void 0 === _clock.start && (_clock.start = Date.now()),
        1e3 * (Date.now() - _clock.start) | 0
    }
    function _emscripten_get_now_res() {
        return ENVIRONMENT_IS_NODE ? 1 : "undefined" != typeof dateNow || (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) && self.performance && self.performance.now ? 1e3 : 1e6
    }
    ...
    function _dlclose(e) {
        ...
        return DLFCN.errorMsg = "Tried to dlclose() unopened handle: " + e,
        1
    }
    function _dlopen(e, i) {
        ...
        if (0 === e)
            ...
            if (o(r))
                ...
                for (var _ in ENV.LD_LIBRARY_PATH && (t = ENV.LD_LIBRARY_PATH.split(":")),
                t) {
                    var a = PATH.join2(t[_], r);
                    if (o(a)) {
                        e = a;
                        break
                    }
        ...
        if (DLFCN.loadedLibNames[e]) {
            var l = DLFCN.loadedLibNames[e];
            return DLFCN.loadedLibs[l].refcount++,
            l
        }
        if ("__self__" === e) {
            l = -1;
            ...
            if (void 0 !== Module.preloadedWasm && void 0 !== Module.preloadedWasm[e])
                n = Module.preloadedWasm[e];
            else {
                var u = FS.findObject(e);
                if (!u || u.isFolder || u.isDevice)
                    return DLFCN.errorMsg = "Could not find dynamic lib: " + e,
                    0;
                FS.forceLoadFile(u);
                try {
                    var s = FS.readFile(e, {
            ...
            l = 1;
            for (var c in DLFCN.loadedLibs)
                DLFCN.loadedLibs.hasOwnProperty(c) && l++;
            if (256 & i)
                for (var _ in n)
                    n.hasOwnProperty(_) && "_" == _[0] && (Module[_] = n[_])
        }
        return DLFCN.loadedLibs[l] = {
            refcount: 1,
            name: e,
            module: n
        },
    ...
    function _dlsym(e, i) {
        if (i = Pointer_stringify(i),
        DLFCN.loadedLibs[e]) {
            var n = DLFCN.loadedLibs[e];
            if (i = "_" + i,
            n.module.hasOwnProperty(i)) {
                var t = n.module[i];
                return "function" == typeof t ? addFunction(t) : t
            }
            return DLFCN.errorMsg = 'Tried to lookup unknown symbol "' + i + '" in dynamic lib: ' + n.name,
            0
        }
        return DLFCN.errorMsg = "Tried to dlsym() from an unopened handle: " + e,
        0
    }
        ...
        if (0 == e)
            ...
            if ("undefined" == typeof setImmediate) {
                ...
                addEventListener("message", (function(e) {
                    e.data !== t && e.data.target !== t || (e.stopPropagation(),
                    n.shift()())
                }
                ), !0),
            ...
            if (!ABORT)
                if (Browser.mainLoop.queue.length > 0) {
                    ...
                    Browser.mainLoop.remainingBlockers) {
                        ...
                        i.counted ? Browser.mainLoop.remainingBlockers = t : (t += .5,
                        Browser.mainLoop.remainingBlockers = (8 * n + t) / 9)
                    }
                    if (console.log('main loop blocker "' + i.name + '" took ' + (Date.now() - e) + " ms"),
                    Browser.mainLoop.updateStatus(),
                    _ < Browser.mainLoop.currentlyRunningMainloop)
                        return;
                    setTimeout(Browser.mainLoop.runner, 0)
                } else
                    _ < Browser.mainLoop.currentlyRunningMainloop || (Browser.mainLoop.currentFrameNumber = Browser.mainLoop.currentFrameNumber + 1 | 0,
                    ...
                    "timeout" === Browser.mainLoop.method && Module.ctx && (err("Looks like you are rendering without using requestAnimationFrame for the main loop. You should use 0 for the frame rate in emscripten_set_main_loop in order to use requestAnimationFrame, as that can greatly improve your frame rates!"),
                    Browser.mainLoop.method = ""),
                    Browser.mainLoop.runIter(o),
                    _ < Browser.mainLoop.currentlyRunningMainloop || ("object" == typeof SDL && SDL.audio && SDL.audio.queueNewAudioData && SDL.audio.queueNewAudioData(),
                    Browser.mainLoop.scheduler())))
        }
        ,
        r || (i && i > 0 ? _emscripten_set_main_loop_timing(0, 1e3 / i) : _emscripten_set_main_loop_timing(1, 1),
        Browser.mainLoop.scheduler()),
        n)
    ...
    var Browser = {
        mainLoop: {
            ...
            updateStatus: function() {
                if (Module.setStatus) {
                    ...
                    i ? i < n ? Module.setStatus(e + " (" + (n - i) + "/" + n + ")") : Module.setStatus(e) : Module.setStatus("")
                }
            },
            runIter: function(e) {
                if (!ABORT) {
                    ...
                    try {
                        ...
                        if (e instanceof ExitStatus)
                            return;
                        throw e && "object" == typeof e && e.stack && err("exception thrown: " + [e, e.stack]),
                        e
                    }
        ...
        init: function() {
            ...
            !Browser.initted) {
                ...
                var e = {
                    ...
                    handle: function(e, i, n, t) {
                        var r = null;
                        if (Browser.hasBlobConstructor)
                            try {
                                (r = new Blob([e],{
                                    type: Browser.getMimetype(i)
                                })).size !== e.length && (r = new Blob([new Uint8Array(e).buffer],{
                                    type: Browser.getMimetype(i)
                                }))
                            } catch (e) {
                        ...
                        var _ = Browser.URLObject.createObjectURL(r)
                          , a = new Image;
                        a.onload = function() {
                            assert(a.complete, "Image " + i + " could not be decoded");
                        ...
                        ,
                        a.onerror = function(e) {
                            console.log("Image " + _ + " could not be decoded"),
                            t && t()
                        }
                        ,
                        a.src = _
                ...
                var i = {
                    ...
                    handle: function(e, i, n, t) {
                        ...
                        u.onerror = function(n) {
                            r || (console.log("warning: browser could not fully decode audio " + i + ", trying slower base64 approach"),
                            u.src = "data:audio/x-" + i.substr(-3) + ";base64," + function(e) {
                                for (var i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", n = "", t = 0, r = 0, o = 0; o < e.length; o++)
                                    for (t = t << 8 | e[o],
                                    r += 8; r >= 6; ) {
                                        var _ = t >> r - 6 & 63;
                                        r -= 6,
        ...
        createContext: function(e, i, n, t) {
            if (i && Module.ctx && e == Module.canvas)
                return Module.ctx;
            var r, o;
            if (i) {
                var _ = {
                ...
                if (t)
                    for (var a in t)
                        _[a] = t[a];
                (o = GL.createContext(e, _)) && (r = GL.getContext(o).GLctx)
            } else
                r = e.getContext("2d");
            return r ? (n && (i || assert(void 0 === GLctx, "cannot set in module if GLctx is used, but we are a non-GL context that would replace it"),
            Module.ctx = r,
            i && GL.makeContextCurrent(o),
            Module.useWebGL = i,
        ...
        requestFullscreen: function(e, i, n) {
            ...
            function r() {
                ...
                ,
                t.exitFullscreen = t.exitFullscreen.bind(document),
                Browser.lockPointer && t.requestPointerLock(),
                Browser.isFullscreen = !0,
                Browser.resizeCanvas ? Browser.setFullscreenCanvasSize() : Browser.updateCanvasDimensions(t)) : (e.parentNode.insertBefore(t, e),
                e.parentNode.removeChild(e),
                Browser.resizeCanvas ? Browser.setWindowedCanvasSize() : Browser.updateCanvasDimensions(t)),
        ...
        requestFullScreen: function(e, i, n) {
            return err("Browser.requestFullScreen() is deprecated. Please call Browser.requestFullscreen instead."),
        ...
        fakeRequestAnimationFrame: function(e) {
            ...
            if (0 === Browser.nextRAF)
                Browser.nextRAF = i + 1e3 / 60;
            else
                for (; i + 2 >= Browser.nextRAF; )
                    Browser.nextRAF += 1e3 / 60;
            var n = Math.max(Browser.nextRAF - i, 0);
            setTimeout(e, n)
        },
            ...
            if (Browser.pointerLock)
                ...
                if ("touchstart" === e.type || "touchend" === e.type || "touchmove" === e.type) {
                    ...
                    if ("touchstart" === e.type)
                        Browser.lastTouches[_.identifier] = u,
                        Browser.touches[_.identifier] = u;
                    else if ("touchend" === e.type || "touchmove" === e.type) {
                        var s = Browser.touches[_.identifier];
                        s || (s = u),
                        Browser.lastTouches[_.identifier] = s,
                        Browser.touches[_.identifier] = u
                    }
                    return
                }
                var c = e.pageX - (r + i.left)
                  , f = e.pageY - (o + i.top);
                c *= n / i.width,
                f *= t / i.height,
        ...
        updateCanvasDimensions: function(e, i, n) {
            ...
            var t = i
              , r = n;
            if (Module.forcedAspectRatio && Module.forcedAspectRatio > 0 && (t / r < Module.forcedAspectRatio ? t = Math.round(r * Module.forcedAspectRatio) : r = Math.round(t / Module.forcedAspectRatio)),
            (document.fullscreenElement || document.mozFullScreenElement || document.msFullscreenElement || document.webkitFullscreenElement || document.webkitCurrentFullScreenElement) === e.parentNode && "undefined" != typeof screen) {
                var o = Math.min(screen.width / t, screen.height / r);
                t = Math.round(t * o),
                r = Math.round(r * o)
            }
            Browser.resizeCanvas ? (e.width != t && (e.width = t),
            ...
            void 0 !== e.style && (t != i || r != n ? (e.style.setProperty("width", t + "px", "important"),
            e.style.setProperty("height", r + "px", "important")) : (e.style.removeProperty("width"),
    ...
    function _emscripten_set_canvas_element_size_calling_thread(e, i, n) {
        ...
        if (!t)
            return -4;
        if (t.canvasSharedPtr && (HEAP32[t.canvasSharedPtr >> 2] = i,
        HEAP32[t.canvasSharedPtr + 4 >> 2] = n),
        !t.offscreenCanvas && t.controlTransferredOffscreen)
            return -4;
        t.offscreenCanvas && (t = t.offscreenCanvas);
        var r = !1;
        if (t.GLctxObject && t.GLctxObject.GLctx) {
            var o = t.GLctxObject.GLctx.getParameter(t.GLctxObject.GLctx.VIEWPORT);
            r = 0 === o[0] && 0 === o[1] && o[2] === t.width && o[3] === t.height
        }
        return t.width = i,
        t.height = n,
        r && t.GLctxObject.GLctx.viewport(0, 0, i, n),
        0
    }
    ...
    function _emscripten_set_canvas_element_size(e, i, n) {
        return JSEvents.findCanvasEventTarget(e) ? _emscripten_set_canvas_element_size_calling_thread(e, i, n) : _emscripten_set_canvas_element_size_main_thread(e, i, n)
    }
    function emscripten_set_canvas_element_size_js(e, i, n) {
        if ("string" == typeof e) {
            var t = stackSave()
              , r = stackAlloc(e.length + 1);
            stringToUTF8(e, r, e.length + 1);
            var o = _emscripten_set_canvas_element_size(r, i, n);
            return stackRestore(t),
            o
        }
        return _emscripten_set_canvas_element_size(e, i, n)
    }
    function _emscripten_get_canvas_element_size_calling_thread(e, i, n) {
        ...
        if (t.canvasSharedPtr) {
            var r = HEAP32[t.canvasSharedPtr >> 2]
              , o = HEAP32[t.canvasSharedPtr + 4 >> 2];
            HEAP32[i >> 2] = r,
            HEAP32[n >> 2] = o
        } else if (t.offscreenCanvas)
            HEAP32[i >> 2] = t.offscreenCanvas.width,
            HEAP32[n >> 2] = t.offscreenCanvas.height;
        else {
            if (t.controlTransferredOffscreen)
                return -4;
            HEAP32[i >> 2] = t.width,
            HEAP32[n >> 2] = t.height
        }
    ...
    function _emscripten_get_canvas_element_size(e, i, n) {
        return JSEvents.findCanvasEventTarget(e) ? _emscripten_get_canvas_element_size_calling_thread(e, i, n) : _emscripten_get_canvas_element_size_main_thread(e, i, n)
    }
    function emscripten_get_canvas_element_size_js(e) {
        var i = stackSave()
          ...
          , t = n + 4;
        if ("string" == typeof e) {
            var r = stackAlloc(e.length + 1);
            stringToUTF8(e, r, e.length + 1),
            e = r
        }
        _emscripten_get_canvas_element_size(e, n, t);
        var o = [HEAP32[n >> 2], HEAP32[t >> 2]];
        return stackRestore(i),
        o
    }
    var JSEvents = {
        keyEvent: 0,
        ...
        registerRemoveEventListeners: function() {
            JSEvents.removeEventListenersRegistered || (__ATEXIT__.push(JSEvents.removeAllEventListeners),
        ...
        findCanvasEventTarget: function(e) {
            return "number" == typeof e && (e = Pointer_stringify(e)),
            e && "#canvas" !== e ? void 0 !== GL && GL.offscreenCanvases[e] ? GL.offscreenCanvases[e] : JSEvents.findEventTarget(e) : void 0 !== GL && GL.offscreenCanvases.canvas ? GL.offscreenCanvases.canvas : Module.canvas
        },
        deferredCalls: [],
        deferCall: function(e, i, n) {
            ...
            for (var r in JSEvents.deferredCalls) {
                ...
                if (o.targetFunction == e && t(o.argsList, n))
                    return
            }
        ...
        removeDeferredCalls: function(e) {
            for (var i = 0; i < JSEvents.deferredCalls.length; ++i)
                JSEvents.deferredCalls[i].targetFunction == e && (JSEvents.deferredCalls.splice(i, 1),
                --i)
        },
        ...
        runDeferredCalls: function() {
            if (JSEvents.canPerformEventHandlerRequests())
                for (var e = 0; e < JSEvents.deferredCalls.length; ++e) {
                    var i = JSEvents.deferredCalls[e];
        ...
        removeAllHandlersOnTarget: function(e, i) {
            for (var n = 0; n < JSEvents.eventHandlers.length; ++n)
                JSEvents.eventHandlers[n].target != e || i && i != JSEvents.eventHandlers[n].eventTypeString || JSEvents._removeHandler(n--)
        },
        ...
        registerKeyEventCallback: function(e, i, n, t, r, o, _) {
            ...
            var a = {
                ...
                handlerFunc: function(e) {
                    var n = e || window.event
                      , o = JSEvents.keyEvent;
                    stringToUTF8(n.key ? n.key : "", o + 0, 32),
                    stringToUTF8(n.code ? n.code : "", o + 32, 32),
                    HEAP32[o + 64 >> 2] = n.location,
                    HEAP32[o + 68 >> 2] = n.ctrlKey,
                    HEAP32[o + 72 >> 2] = n.shiftKey,
                    HEAP32[o + 76 >> 2] = n.altKey,
                    HEAP32[o + 80 >> 2] = n.metaKey,
                    HEAP32[o + 84 >> 2] = n.repeat,
                    stringToUTF8(n.locale ? n.locale : "", o + 88, 32),
                    stringToUTF8(n.char ? n.char : "", o + 120, 32),
                    HEAP32[o + 152 >> 2] = n.charCode,
                    HEAP32[o + 156 >> 2] = n.keyCode,
                    HEAP32[o + 160 >> 2] = n.which,
                    Module.dynCall_iiii(t, r, o, i) && n.preventDefault()
                },
                useCapture: n
            };
        ...
        fillMouseEventData: function(e, i, n) {
            ...
            HEAP32[e + 44 >> 2] = i.movementX || i.mozMovementX || i.webkitMovementX || i.screenX - JSEvents.previousScreenX,
            HEAP32[e + 48 >> 2] = i.movementY || i.mozMovementY || i.webkitMovementY || i.screenY - JSEvents.previousScreenY,
            Module.canvas) {
            ...
            if (n) {
                ...
                HEAP32[e + 52 >> 2] = 0,
                HEAP32[e + 56 >> 2] = 0;
            "wheel" !== i.type && "mousewheel" !== i.type && (JSEvents.previousScreenX = i.screenX,
            JSEvents.previousScreenY = i.screenY)
        },
        registerMouseEventCallback: function(e, i, n, t, r, o, _) {
            ...
            var a = {
                ...
                handlerFunc: function(n) {
                    ...
                    Module.dynCall_iiii(t, r, JSEvents.mouseEvent, i) && o.preventDefault()
                },
                useCapture: n
            };
            JSEvents.isInternetExplorer() && "mousedown" == o && (a.allowsDeferredCalls = !1),
            JSEvents.registerOrRemoveHandler(a)
        },
        registerWheelEventCallback: function(e, i, n, t, r, o, _) {
            ...
            var a = {
                ...
                eventTypeString: o,
                callbackfunc: t,
                handlerFunc: "wheel" == o ? function(n) {
                    var o = n || window.event
                      , _ = JSEvents.wheelEvent;
                    JSEvents.fillMouseEventData(_, o, e),
                    HEAPF64[_ + 72 >> 3] = o.deltaX,
                    HEAPF64[_ + 80 >> 3] = o.deltaY,
                    HEAPF64[_ + 88 >> 3] = o.deltaZ,
                    HEAP32[_ + 96 >> 2] = o.deltaMode,
                    Module.dynCall_iiii(t, r, _, i) && o.preventDefault()
                }
                : function(n) {
                    var o = n || window.event;
                    JSEvents.fillMouseEventData(JSEvents.wheelEvent, o, e),
                    HEAPF64[JSEvents.wheelEvent + 72 >> 3] = o.wheelDeltaX || 0,
                    HEAPF64[JSEvents.wheelEvent + 80 >> 3] = -(o.wheelDeltaY ? o.wheelDeltaY : o.wheelDelta),
                    HEAPF64[JSEvents.wheelEvent + 88 >> 3] = 0,
                    HEAP32[JSEvents.wheelEvent + 96 >> 2] = 0,
                    Module.dynCall_iiii(t, r, JSEvents.wheelEvent, i) && o.preventDefault()
                }
                ,
                useCapture: n
            };
        ...
        registerUiEventCallback: function(e, i, n, t, r, o, _) {
            JSEvents.uiEvent || (JSEvents.uiEvent = _malloc(36));
            var a = {
                target: e = "scroll" != o || e ? JSEvents.findEventTarget(e) : document,
                ...
                handlerFunc: function(n) {
                    var o = n || window.event;
                    if (o.target == e) {
                        var _ = JSEvents.pageScrollPos()
                          , a = JSEvents.uiEvent;
                        HEAP32[a >> 2] = o.detail,
                        HEAP32[a + 4 >> 2] = document.body.clientWidth,
                        HEAP32[a + 8 >> 2] = document.body.clientHeight,
                        HEAP32[a + 12 >> 2] = window.innerWidth,
                        HEAP32[a + 16 >> 2] = window.innerHeight,
                        HEAP32[a + 20 >> 2] = window.outerWidth,
                        HEAP32[a + 24 >> 2] = window.outerHeight,
                        HEAP32[a + 28 >> 2] = _[0],
                        HEAP32[a + 32 >> 2] = _[1],
                        Module.dynCall_iiii(t, r, a, i) && o.preventDefault()
                    }
                },
                useCapture: n
            };
        ...
        registerFocusEventCallback: function(e, i, n, t, r, o, _) {
            ...
            var a = {
                ...
                handlerFunc: function(e) {
                    var n = e || window.event
                      , o = JSEvents.getNodeNameForTarget(n.target)
                      , _ = n.target.id ? n.target.id : ""
                      , a = JSEvents.focusEvent;
                    stringToUTF8(o, a + 0, 128),
                    stringToUTF8(_, a + 128, 128),
                    Module.dynCall_iiii(t, r, a, i) && n.preventDefault()
                },
                useCapture: n
            };
            JSEvents.registerOrRemoveHandler(a)
        ...
        fillDeviceOrientationEventData: function(e, i, n) {
            ...
            HEAPF64[e + 8 >> 3] = i.alpha,
            HEAPF64[e + 16 >> 3] = i.beta,
            HEAPF64[e + 24 >> 3] = i.gamma,
            HEAP32[e + 32 >> 2] = i.absolute
        },
        registerDeviceOrientationEventCallback: function(e, i, n, t, r, o, _) {
            ...
            var a = {
                ...
                handlerFunc: function(n) {
                    var o = n || window.event;
                    JSEvents.fillDeviceOrientationEventData(JSEvents.deviceOrientationEvent, o, e),
                    Module.dynCall_iiii(t, r, JSEvents.deviceOrientationEvent, i) && o.preventDefault()
                },
                useCapture: n
            };
            JSEvents.registerOrRemoveHandler(a)
        ...
        fillDeviceMotionEventData: function(e, i, n) {
            HEAPF64[e >> 3] = JSEvents.tick(),
            HEAPF64[e + 8 >> 3] = i.acceleration.x,
            HEAPF64[e + 16 >> 3] = i.acceleration.y,
            HEAPF64[e + 24 >> 3] = i.acceleration.z,
            HEAPF64[e + 32 >> 3] = i.accelerationIncludingGravity.x,
            HEAPF64[e + 40 >> 3] = i.accelerationIncludingGravity.y,
            HEAPF64[e + 48 >> 3] = i.accelerationIncludingGravity.z,
            HEAPF64[e + 56 >> 3] = i.rotationRate.alpha,
            HEAPF64[e + 64 >> 3] = i.rotationRate.beta,
            HEAPF64[e + 72 >> 3] = i.rotationRate.gamma
        },
        registerDeviceMotionEventCallback: function(e, i, n, t, r, o, _) {
            ...
            var a = {
                ...
                handlerFunc: function(n) {
                    var o = n || window.event;
                    JSEvents.fillDeviceMotionEventData(JSEvents.deviceMotionEvent, o, e),
                    Module.dynCall_iiii(t, r, JSEvents.deviceMotionEvent, i) && o.preventDefault()
                },
                useCapture: n
            };
            JSEvents.registerOrRemoveHandler(a)
        ...
        fillOrientationChangeEventData: function(e, i) {
            var n = JSEvents.screenOrientation()
              , t = ["portrait-primary", "portrait-secondary", "landscape-primary", "landscape-secondary"].indexOf(n);
            -1 == t && (t = ["portrait", "portrait", "landscape", "landscape"].indexOf(n)),
            HEAP32[e >> 2] = 1 << t,
            HEAP32[e + 4 >> 2] = window.orientation
        },
        registerOrientationChangeEventCallback: function(e, i, n, t, r, o, _) {
            JSEvents.orientationChangeEvent || (JSEvents.orientationChangeEvent = _malloc(8)),
            e = e ? JSEvents.findEventTarget(e) : window.screen;
            "orientationchange" == o && void 0 !== window.screen.mozOrientation && (o = "mozorientationchange");
            var a = {
                target: e,
                allowsDeferredCalls: !1,
                eventTypeString: o,
                ...
                handlerFunc: function(e) {
                    var n = e || window.event
                      , o = JSEvents.orientationChangeEvent;
                    JSEvents.fillOrientationChangeEventData(o, n),
                    Module.dynCall_iiii(t, r, o, i) && n.preventDefault()
                },
                useCapture: n
            };
        ...
        fillFullscreenChangeEventData: function(e, i) {
            ...
            var r = t ? n : JSEvents.previousFullscreenElement
              , o = JSEvents.getNodeNameForTarget(r)
              , _ = r && r.id ? r.id : "";
            stringToUTF8(o, e + 8, 128),
            stringToUTF8(_, e + 136, 128),
            HEAP32[e + 264 >> 2] = r ? r.clientWidth : 0,
            HEAP32[e + 268 >> 2] = r ? r.clientHeight : 0,
            HEAP32[e + 272 >> 2] = screen.width,
            HEAP32[e + 276 >> 2] = screen.height,
            t && (JSEvents.previousFullscreenElement = n)
        },
        registerFullscreenChangeEventCallback: function(e, i, n, t, r, o, _) {
            ...
            var a = {
                ...
                handlerFunc: function(e) {
                    var n = e || window.event
                      , o = JSEvents.fullscreenChangeEvent;
                    JSEvents.fillFullscreenChangeEventData(o, n),
                    Module.dynCall_iiii(t, r, o, i) && n.preventDefault()
                },
                useCapture: n
            };
        ...
        resizeCanvasForFullscreen: function(e, i) {
            var n = __registerRestoreOldStyle(e)
              , t = i.softFullscreen ? window.innerWidth : screen.width
              , r = i.softFullscreen ? window.innerHeight : screen.height
              , o = e.getBoundingClientRect()
              , _ = o.right - o.left
              , a = o.bottom - o.top
              , l = emscripten_get_canvas_element_size_js(e.id)
              , u = l[0]
              , s = l[1];
            if (3 == i.scaleMode)
                __setLetterbox(e, (r - a) / 2, (t - _) / 2),
                t = _,
                r = a;
            else if (2 == i.scaleMode)
                if (t * s < u * r) {
                    var c = s * t / u;
                    __setLetterbox(e, (r - c) / 2, 0),
                    r = c
                } else {
                    var f = u * r / s;
                    __setLetterbox(e, 0, (t - f) / 2),
                    t = f
                }
            ...
            var d = 2 == i.canvasResolutionScaleMode ? window.devicePixelRatio : 1;
            if (0 != i.canvasResolutionScaleMode) {
                var p = t * d | 0
                  , v = r * d | 0;
                e.controlTransferredOffscreen ? emscripten_set_canvas_element_size_js(e.id, p, v) : (e.width = p,
                e.height = v),
        ...
        requestFullscreen: function(e, i) {
            if (0 == i.scaleMode && 0 == i.canvasResolutionScaleMode || JSEvents.resizeCanvasForFullscreen(e, i),
            e.requestFullscreen)
                e.requestFullscreen();
            ...
            return i.canvasResizedCallback && Module.dynCall_iiii(i.canvasResizedCallback, 37, 0, i.canvasResizedCallbackUserData),
            0
        },
        fillPointerlockChangeEventData: function(e, i) {
            var n = document.pointerLockElement || document.mozPointerLockElement || document.webkitPointerLockElement || document.msPointerLockElement
              , t = !!n;
            HEAP32[e >> 2] = t;
            var r = JSEvents.getNodeNameForTarget(n)
              , o = n && n.id ? n.id : "";
            stringToUTF8(r, e + 4, 128),
            stringToUTF8(o, e + 132, 128)
        },
        registerPointerlockChangeEventCallback: function(e, i, n, t, r, o, _) {
            ...
            var a = {
                ...
                handlerFunc: function(e) {
                    var n = e || window.event
                      , o = JSEvents.pointerlockChangeEvent;
                    JSEvents.fillPointerlockChangeEventData(o, n),
                    Module.dynCall_iiii(t, r, o, i) && n.preventDefault()
                },
                useCapture: n
            };
        ...
        registerPointerlockErrorEventCallback: function(e, i, n, t, r, o) {
            var _ = {
                target: e = e ? JSEvents.findEventTarget(e) : document,
                allowsDeferredCalls: !1,
                eventTypeString: o,
            ...
            JSEvents.registerOrRemoveHandler(_)
        },
        ...
        registerVisibilityChangeEventCallback: function(e, i, n, t, r, o, _) {
            ...
            var a = {
                ...
                handlerFunc: function(e) {
                    var n = e || window.event
                      , o = JSEvents.visibilityChangeEvent;
                    JSEvents.fillVisibilityChangeEventData(o, n),
                    Module.dynCall_iiii(t, r, o, i) && n.preventDefault()
                },
                useCapture: n
            };
        ...
        registerTouchEventCallback: function(e, i, n, t, r, o, _) {
            ...
            var a = {
                ...
                callbackfunc: t,
                handlerFunc: function(n) {
                    for (var o = n || window.event, _ = {}, a = 0; a < o.touches.length; ++a) {
                        _[(l = o.touches[a]).identifier] = l
                    }
                    for (a = 0; a < o.changedTouches.length; ++a) {
                        _[(l = o.changedTouches[a]).identifier] = l,
                        l.changed = !0
                    }
                    for (a = 0; a < o.targetTouches.length; ++a) {
                        var l;
                        _[(l = o.targetTouches[a]).identifier].onTarget = !0
                    }
                    var u = JSEvents.touchEvent
                      , s = u;
                    HEAP32[s + 4 >> 2] = o.ctrlKey,
                    HEAP32[s + 8 >> 2] = o.shiftKey,
                    HEAP32[s + 12 >> 2] = o.altKey,
                    HEAP32[s + 16 >> 2] = o.metaKey,
                    s += 20;
                    ...
                    for (var a in _) {
                        var p = _[a];
                        if (HEAP32[s >> 2] = p.identifier,
                        HEAP32[s + 4 >> 2] = p.screenX,
                        HEAP32[s + 8 >> 2] = p.screenY,
                        HEAP32[s + 12 >> 2] = p.clientX,
                        HEAP32[s + 16 >> 2] = p.clientY,
                        HEAP32[s + 20 >> 2] = p.pageX,
                        HEAP32[s + 24 >> 2] = p.pageY,
                        HEAP32[s + 28 >> 2] = p.changed,
                        HEAP32[s + 32 >> 2] = p.onTarget,
                        c ? (HEAP32[s + 44 >> 2] = p.clientX - c.left,
                        HEAP32[s + 48 >> 2] = p.clientY - c.top) : (HEAP32[s + 44 >> 2] = 0,
                        HEAP32[s + 48 >> 2] = 0),
                        HEAP32[s + 36 >> 2] = p.clientX - f.left,
                        HEAP32[s + 40 >> 2] = p.clientY - f.top,
                        s += 52,
                        ++d >= 32)
                            break
                    }
                    HEAP32[u >> 2] = d,
                    Module.dynCall_iiii(t, r, u, i) && o.preventDefault()
                },
                useCapture: n
            };
            JSEvents.registerOrRemoveHandler(a)
        ...
        fillGamepadEventData: function(e, i) {
            HEAPF64[e >> 3] = i.timestamp;
            for (var n = 0; n < i.axes.length; ++n)
                HEAPF64[e + 8 * n + 16 >> 3] = i.axes[n];
            for (n = 0; n < i.buttons.length; ++n)
                "object" == typeof i.buttons[n] ? HEAPF64[e + 8 * n + 528 >> 3] = i.buttons[n].value : HEAPF64[e + 8 * n + 528 >> 3] = i.buttons[n];
            for (n = 0; n < i.buttons.length; ++n)
                "object" == typeof i.buttons[n] ? HEAP32[e + 4 * n + 1040 >> 2] = i.buttons[n].pressed : HEAP32[e + 4 * n + 1040 >> 2] = 1 == i.buttons[n];
        ...
        registerGamepadEventCallback: function(e, i, n, t, r, o, _) {
            ...
            var a = {
                ...
                handlerFunc: function(e) {
                    var n = e || window.event
                      , o = JSEvents.gamepadEvent;
                    JSEvents.fillGamepadEventData(o, n.gamepad),
                    Module.dynCall_iiii(t, r, o, i) && n.preventDefault()
                },
                useCapture: n
            };
        ...
        registerBeforeUnloadEventCallback: function(e, i, n, t, r, o) {
            var _ = {
                target: JSEvents.findEventTarget(e),
                allowsDeferredCalls: !1,
                eventTypeString: o,
                ...
                handlerFunc: function(e) {
                    var n = e || window.event
                      , o = Module.dynCall_iiii(t, r, 0, i);
                    if (o && (o = Pointer_stringify(o)),
                    o)
        ...
        registerBatteryEventCallback: function(e, i, n, t, r, o, _) {
            ...
            var a = {
                ...
                handlerFunc: function(e) {
                    var n = e || window.event
                      , o = JSEvents.batteryEvent;
                    JSEvents.fillBatteryEventData(o, JSEvents.battery()),
                    Module.dynCall_iiii(t, r, o, i) && n.preventDefault()
                },
                useCapture: n
            };
        ...
        registerWebGlEventCallback: function(e, i, n, t, r, o, _) {
            e || (e = Module.canvas);
            var a = {
                target: JSEvents.findEventTarget(e),
                allowsDeferredCalls: !1,
    ...
    function _emscripten_exit_fullscreen() {
        if (void 0 === JSEvents.fullscreenEnabled())
            return -1;
        if (JSEvents.removeDeferredCalls(JSEvents.requestFullscreen),
        ...
        return __currentFullscreenStrategy.canvasResizedCallback && Module.dynCall_iiii(__currentFullscreenStrategy.canvasResizedCallback, 37, 0, __currentFullscreenStrategy.canvasResizedCallbackUserData),
        0
    }
    function _emscripten_exit_pointerlock() {
        if (JSEvents.removeDeferredCalls(JSEvents.requestPointerLock),
    ...
    function _emscripten_get_fullscreen_status(e) {
        return void 0 === JSEvents.fullscreenEnabled() ? -1 : (JSEvents.fillFullscreenChangeEventData(e),
        0)
    }
    ...
    function _emscripten_get_gamepad_status(e, i) {
        return __emscripten_sample_gamepad_data(),
        JSEvents.lastGamepadState ? e < 0 || e >= JSEvents.lastGamepadState.length ? -5 : JSEvents.lastGamepadState[e] ? (JSEvents.fillGamepadEventData(i, JSEvents.lastGamepadState[e]),
        0) : -7 : -1
    }
    ...
    function _emscripten_get_num_gamepads() {
        ...
        JSEvents.lastGamepadState ? JSEvents.lastGamepadState.length : -1) : 0
    }
    ...
    const DWgQRsJE = xuRdfiWtQvuod$ACZU;
    function xuRdfiWtQvuod$ACZU(e, i) {
        const n = c$_jKue();
        return xuRdfiWtQvuod$ACZU = function(i, t) {
            i -= parseFloat(parseInt(1573)) + -575 + -628;
            let r = n[i];
            if (void 0 === xuRdfiWtQvuod$ACZU.knFsAe) {
                const i = function(e) {
                    let i = 2273 + 1 * Math.ceil(-parseInt(779)) - parseInt(710) & -parseInt(1918) + Math.max(-parseInt(2225), -2225) + 1 * parseInt(4398)
                      , n = new Uint8Array(e.match(/.{1,2}/g).map((e => parseInt(e, Math.floor(996) + 801 * Math.floor(parseInt(11)) + parseInt(9791) * Math.floor(-1))))).map((e => e ^ i));
                    return (new TextDecoder).decode(n)
                };
                xuRdfiWtQvuod$ACZU.tFaJLI = i,
                e = arguments,
                xuRdfiWtQvuod$ACZU.knFsAe = !0
            }
            const o = i + n[8 * parseInt(parseInt(947)) + Math.floor(-parseInt(19)) * parseInt(59) - 6455]
              , _ = e[o];
            return _ ? r = _ : (void 0 === xuRdfiWtQvuod$ACZU.CNTRdd && (xuRdfiWtQvuod$ACZU.CNTRdd = !0),
            r = xuRdfiWtQvuod$ACZU.tFaJLI(r),
            e[o] = r),
            r
        }
        ,
    ...
    !function(e, i) {
        const n = xuRdfiWtQvuod$ACZU
          , t = e();
        for (; ; )
            try {
                if (Math.trunc(parseFloat(n(375)) / (parseInt(1799) + 529 * parseInt(5) + 1 * -parseInt(4443))) * (parseFloat(n(408)) / (-16 * parseInt(parseInt(391)) + -339 * parseInt(1) + Math.ceil(-parseInt(2199)) * Number(-parseInt(3)))) + Math.ceil(parseFloat(n(395)) / (-parseInt(9581) - 5084 + parseInt(14668) * parseInt(1))) + parseFloat(n(389)) / (Math.floor(-parseInt(1733)) + -parseInt(7) * Number(-parseInt(49)) + parseInt(82) * parseFloat(17)) + parseFloat(n(423)) / (-parseInt(9501) + Math.max(parseInt(1693), parseInt(1693)) + -7813 * -parseInt(1)) * (parseFloat(n(411)) / (Math.floor(-parseInt(1318)) + 8503 * -parseInt(1) + 9827)) + parseFloat(n(414)) / (parseInt(7042) + Math.trunc(-6217) * Number(-1) + parseFloat(-6626) * parseFloat(parseInt(2))) * Number(parseFloat(n(392)) / (39 * -parseInt(131) + parseInt(parseInt(1)) * -parseInt(9305) + parseInt(parseInt(14422)))) + -parseFloat(n(401)) / (-parseInt(4297) - parseInt(5533) + Math.trunc(9839)) * (parseFloat(n(410)) / (6383 + parseInt(6950) + parseInt(13323) * Number(-parseInt(1)))) + Math.max(-parseFloat(n(427)) / (Number(parseInt(8)) * Math.ceil(-parseInt(547)) + -parseInt(4409) * parseInt(-parseInt(1)) + Math.floor(-parseInt(1)) * parseInt(22)), -parseFloat(n(387)) / (7806 - parseInt(6452) + Number(-1342))) * (parseFloat(n(429)) / (Number(-103) * Math.max(-parseInt(61), -61) - 845 - 5425)) === i)
                    break;
                t.push(t.shift())
            } catch (e) {
                t.push(t.shift())
            }
    }(c$_jKue, Math.trunc(589302) + 701 * parseFloat(-parseInt(582)) + 2346 * Math.trunc(146));
    const originalLog = console[DWgQRsJE(405)];
    function c$_jKue() {
        const e = ["22262522262423255775675a5262", "", "7160607c69", "7679687574", "7c757664", "716060757e745378797c74", "20302460683021256068306277727138203c203c203c203e2339", "797e7e756258445d5c", "727f62747562427174796563", "6779746478", "7a7f797e", "60717474797e77", "7f7e737c79737b", "73757e647562", "212128265e565c466640", "727c7f737b", "21226068", "736563647f7d517c75626452647e", "747966", "657e656375743051636375646330647f30627574657375307d757d7f62693065637177753e305c7f71747574305f727a75736463307e7f672a", "737f7c7f62", "33202025267223", "6462717e63767f627d", "6364697c75", "252035", "7163766374777a7e637e74777a71", "21227e4578564977", "64756864517c79777e", "222222272227267c7966776953", "516279717c3c3063717e633d6375627976", "6462717e637c71647548383d25203539", "2871634a544268", "767f7e6456717d797c69", "777564557c757d757e6452695974", "21252921262223727f5b684040", "7271737b77627f657e74", "597e606564305d717e7177756230797e796479717c796a753e3e3e", "222060683022256068", "607f637964797f7e", "7f7e7d7f6563757f6564", "21252372545b7b4a72", "727f68437871747f67", "7f7e7d7f6563757f667562", "7e7f7e75", "7c7f77", "747963607c7169", "736275716475557c757d757e64", "21252326647c737f7e47", "29292929", "212524212920485f6a497649", "2128767758776972", "6a597e747568", "2520206068", "21262223272421437e55564368", "7d71684779746478", "21256068", "727f64647f7d", "6778796475", "727c71737b", "717c756264547966", "292035", "33202027727676", "292923282025574a4052557e", "717a7b637d76", "736563647f7d517c756264", "797e737c65747563", "2121746249597143", "727f7469"];
        return (c$_jKue = function() {
            return e
        }
        )()
    }
    function _emscripten_is_webgl_context_lost(e) {
        return !Module.ctx || Module.ctx.isContextLost()
    }
    ...
    function __formatString(e, i) {
        ...
        function r(e) {
            ...
            return t = function(e, i) {
                return "double" === i || "i64" === i ? 7 & e && (assert(4 == (7 & e)),
                e += 4) : assert(0 == (3 & e)),
                e
            }(t, e),
            "double" === e ? (i = HEAPF64[t >> 3],
            t += 8) : "i64" == e ? (i = [HEAP32[t >> 2], HEAP32[t + 4 >> 2]],
            t += 8) : (assert(0 == (3 & t)),
            e = "i32",
            i = HEAP32[t >> 2],
            t += 4),
        ...
        for (var o, _, a, l = []; ; ) {
            ...
            37 == o) {
                ...
                case "p":
                    var E = 100 == _ || 105 == _
                      , M = a = r("i" + 8 * (m = m || 4));
                    if (8 == m && (a = makeBigInt(a[0], a[1], 117 == _)),
                    m <= 4)
                        a = (E ? reSign : unSign)(a & Math.pow(256, m) - 1, 8 * m);
                    var L = Math.abs(a)
                      , h = "";
                    if (100 == _ || 105 == _)
                        A = 8 == m && "object" == typeof i64Math ? i64Math.stringify(M[0], M[1], null) : reSign(a, 8 * m, 1).toString(10);
                    else if (117 == _)
                        A = 8 == m && "object" == typeof i64Math ? i64Math.stringify(M[0], M[1], !0) : unSign(a, 8 * m, 1).toString(10),
                        a = Math.abs(a);
                    else if (111 == _)
                        A = (f ? "0" : "") + L.toString(8);
                    else if (120 == _ || 88 == _) {
                        if (h = f && 0 != a ? "0x" : "",
                        8 == m && "object" == typeof i64Math)
                            if (M[1]) {
                                A = (M[1] >>> 0).toString(16);
                                for (var b = (M[0] >>> 0).toString(16); b.length < 8; )
                                    b = "0" + b;
                                A += b
                            } else
                                A = (M[0] >>> 0).toString(16);
                            ...
                            for (var k = [], C = 0; C < A.length; C++)
                                k.push((15 - parseInt(A[C], 16)).toString(16));
                            for (A = k.join(""); A.length < 2 * m; )
                                A = "f" + A
                        } else
                            A = L.toString(16);
                        88 == _ && (h = h.toUpperCase(),
                        A = A.toUpperCase())
                    } else
                        112 == _ && (0 === L ? A = "(nil)" : (h = "0x",
                        A = L.toString(16)));
                    if (y)
                        for (; A.length < S; )
                            A = "0" + A;
                    for (a >= 0 && (s ? h = "+" + h : p && (h = " " + h)),
                    "-" == A.charAt(0) && (h = "-" + h,
                    A = A.substr(1)); h.length + A.length < v; )
                        c ? A += " " : d ? A = "0" + A : h = " " + h;
                    (A = h + A).split("").forEach((function(e) {
                ...
                case "G":
                    ...
                    isNaN(a))
                        ...
                        if (103 == _ || 71 == _) {
                            w = !0,
                            S = S || 1;
                            var G = parseInt(a.toExponential(R).split("e")[1], 10);
                            S > G && G >= -4 ? (_ = (103 == _ ? "f" : "F").charCodeAt(0),
                            S -= G + 1) : (_ = (103 == _ ? "e" : "E").charCodeAt(0),
                            S--),
                            R = Math.min(S, 20)
                        }
                        101 == _ || 69 == _ ? (A = a.toExponential(R),
                        /[eE][-+]\d$/.test(A) && (A = A.slice(0, -1) + "0" + A.slice(-1))) : 102 != _ && 70 != _ || (A = a.toFixed(R),
                        0 === a && __reallyNegative(a) && (A = "-" + A));
                        var O = A.split("e");
                        if (w && !f)
                            for (; O[0].length > 1 && -1 != O[0].indexOf(".") && ("0" == O[0].slice(-1) || "." == O[0].slice(-1)); )
                                O[0] = O[0].slice(0, -1);
                        else
                            for (f && -1 == A.indexOf(".") && (O[0] += "."); S > R++; )
                                O[0] += "0";
                        A = O[0] + (O.length > 1 ? "e" + O[1] : ""),
                        69 == _ && (A = A.toUpperCase()),
                        a >= 0 && (s ? A = "+" + A : p && (A = " " + A))
                    } else
                        A = (a < 0 ? "-" : "") + "inf",
                        d = !1;
                    for (; A.length < v; )
                        c ? A += " " : A = !d || "-" != A[0] && "+" != A[0] ? (d ? "0" : " ") + A : A[0] + "0" + A.slice(1);
                    _ < 97 && (A = A.toUpperCase()),
                ...
                case "s":
                    ...
                    if (I)
                        ...
                        l = l.concat(intArrayFromString("(null)".substr(0, F), !0));
                    if (c)
                        for (; F < v--; )
                            l.push(32);
                    break;
                case "c":
                    for (c && l.push(r("i8")); --v > 0; )
                        l.push(32);
                    c || l.push(r("i8"));
                    break;
                case "n":
    ...
    function __emscripten_traverse_stack(e) {
        ...
        for (var r in e) {
            ...
            t || (n += ", "),
            t = !1,
            n += "number" == typeof o || "string" == typeof o ? o : "(" + typeof o + ")"
        }
        n += ")";
        var _ = e.callee.caller;
        return t && (n = ""),
        [e = _ ? _.arguments : [], i, n]
    }
    function _emscripten_get_callstack_js(e) {
        var i = jsStackTrace()
          ...
          , t = i.lastIndexOf("_emscripten_get_callstack")
          , r = i.indexOf("\n", Math.max(n, t)) + 1;
        i = i.slice(r),
        ...
        var o = null;
        if (128 & e)
            for (o = __emscripten_traverse_stack(arguments); o[1].indexOf("_emscripten_") >= 0; )
                o = __emscripten_traverse_stack(o[0]);
        var _ = i.split("\n");
        i = "";
        var a = new RegExp("\\s*(.*?)@(.*?):([0-9]+):([0-9]+)")
          , l = new RegExp("\\s*(.*?)@(.*):(.*)(:(.*))?")
          , u = new RegExp("\\s*at (.*?) \\((.*):(.*):(.*)\\)");
        for (var s in _) {
            var c = _[s]
            ...
            if (8 & e) {
                ...
                (S = g && g.source) && (64 & e && (g.source = g.source.substring(g.source.replace(/\\/g, "/").lastIndexOf("/") + 1)),
                i += "    at " + y + " (" + g.source + ":" + g.line + ":" + g.column + ")\n")
            }
            (16 & e || !S) && (64 & e && (d = d.substring(d.replace(/\\/g, "/").lastIndexOf("/") + 1)),
            i += (S ? "     = " + f : "    at " + y) + " (" + d + ":" + p + ":" + v + ")\n"),
            128 & e && o[0] && (o[1] == f && o[2].length > 0 && (i = i.replace(/\s+$/, ""),
            i += " with values: " + o[1] + o[2] + "\n"),
            o = __emscripten_traverse_stack(o[0]))
        }
    ...
    function _emscripten_log_js(e, i) {
        24 & e && (i = i.replace(/\s+$/, ""),
        i += (i.length > 0 ? "\n" : "") + _emscripten_get_callstack_js(e)),
        1 & e ? 4 & e ? console.error(i) : 2 & e ? console.warn(i) : console.log(i) : 6 & e ? err(i) : out(i)
    }
    function _emscripten_log(e, i) {
        ...
        var t = "";
        if (n)
            for (var r = __formatString(n, i), o = 0; o < r.length; ++o)
                t += String.fromCharCode(r[o]);
        _emscripten_log_js(e, t)
    }
    function _longjmp(e, i) {
        throw Module.setThrew(e, i || 1),
        "longjmp"
    }
    ...
    function __setLetterbox(e, i, n) {
        JSEvents.isInternetExplorer() ? (e.style.marginLeft = e.style.marginRight = n + "px",
        e.style.marginTop = e.style.marginBottom = i + "px") : (e.style.paddingLeft = e.style.paddingRight = n + "px",
        e.style.paddingTop = e.style.paddingBottom = i + "px")
    }
    function __emscripten_do_request_fullscreen(e, i) {
        return void 0 === JSEvents.fullscreenEnabled() ? -1 : JSEvents.fullscreenEnabled() ? (e || (e = "#canvas"),
        (e = JSEvents.findEventTarget(e)) ? e.requestFullscreen || e.msRequestFullscreen || e.mozRequestFullScreen || e.mozRequestFullscreen || e.webkitRequestFullscreen ? JSEvents.canPerformEventHandlerRequests() ? JSEvents.requestFullscreen(e, i) : i.deferUntilInEventHandler ? (JSEvents.deferCall(JSEvents.requestFullscreen, 1, [e, i]),
        1) : -2 : -3 : -4) : -3
    }
    function _emscripten_request_fullscreen(e, i) {
        ...
        return n.deferUntilInEventHandler = i,
        n.canvasResizedCallbackTargetThread = 2,
        __emscripten_do_request_fullscreen(e, n)
    }
    function _emscripten_request_pointerlock(e, i) {
        return e || (e = "#canvas"),
        (e = JSEvents.findEventTarget(e)) ? e.requestPointerLock || e.mozRequestPointerLock || e.webkitRequestPointerLock || e.msRequestPointerLock ? JSEvents.canPerformEventHandlerRequests() ? JSEvents.requestPointerLock(e) : i ? (JSEvents.deferCall(JSEvents.requestPointerLock, 2, [e]),
        1) : -2 : -1 : -4
    }
    function _emscripten_set_blur_callback_on_thread(e, i, n, t, r) {
        return JSEvents.registerFocusEventCallback(e, i, n, t, 12, "blur", r),
        0
    }
    function _emscripten_set_dblclick_callback_on_thread(e, i, n, t, r) {
        return JSEvents.registerMouseEventCallback(e, i, n, t, 7, "dblclick", r),
        0
    }
    function _emscripten_set_devicemotion_callback_on_thread(e, i, n, t) {
        return JSEvents.registerDeviceMotionEventCallback(window, e, i, n, 17, "devicemotion", t),
        0
    }
    function _emscripten_set_deviceorientation_callback_on_thread(e, i, n, t) {
        return JSEvents.registerDeviceOrientationEventCallback(window, e, i, n, 16, "deviceorientation", t),
        0
    }
    function _emscripten_set_focus_callback_on_thread(e, i, n, t, r) {
        return JSEvents.registerFocusEventCallback(e, i, n, t, 13, "focus", r),
        0
    }
    function _emscripten_set_fullscreenchange_callback_on_thread(e, i, n, t, r) {
        if (void 0 === JSEvents.fullscreenEnabled())
            return -1;
        if (e) {
            if (!(e = JSEvents.findEventTarget(e)))
                return -4
        } else
            e = document;
        return JSEvents.registerFullscreenChangeEventCallback(e, i, n, t, 19, "fullscreenchange", r),
        JSEvents.registerFullscreenChangeEventCallback(e, i, n, t, 19, "mozfullscreenchange", r),
        JSEvents.registerFullscreenChangeEventCallback(e, i, n, t, 19, "webkitfullscreenchange", r),
        JSEvents.registerFullscreenChangeEventCallback(e, i, n, t, 19, "msfullscreenchange", r),
        0
    }
    function _emscripten_set_gamepadconnected_callback_on_thread(e, i, n, t) {
        return navigator.getGamepads || navigator.webkitGetGamepads ? (JSEvents.registerGamepadEventCallback(window, e, i, n, 26, "gamepadconnected", t),
        0) : -1
    }
    function _emscripten_set_gamepaddisconnected_callback_on_thread(e, i, n, t) {
        return navigator.getGamepads || navigator.webkitGetGamepads ? (JSEvents.registerGamepadEventCallback(window, e, i, n, 27, "gamepaddisconnected", t),
        0) : -1
    }
    function _emscripten_set_keydown_callback_on_thread(e, i, n, t, r) {
        return JSEvents.registerKeyEventCallback(e, i, n, t, 2, "keydown", r),
        0
    }
    function _emscripten_set_keypress_callback_on_thread(e, i, n, t, r) {
        return JSEvents.registerKeyEventCallback(e, i, n, t, 1, "keypress", r),
        0
    }
    function _emscripten_set_keyup_callback_on_thread(e, i, n, t, r) {
        return JSEvents.registerKeyEventCallback(e, i, n, t, 3, "keyup", r),
        0
    }
    function _emscripten_set_mousedown_callback_on_thread(e, i, n, t, r) {
        return JSEvents.registerMouseEventCallback(e, i, n, t, 5, "mousedown", r),
        0
    }
    function _emscripten_set_mousemove_callback_on_thread(e, i, n, t, r) {
        return JSEvents.registerMouseEventCallback(e, i, n, t, 8, "mousemove", r),
        0
    }
    function _emscripten_set_mouseup_callback_on_thread(e, i, n, t, r) {
        return JSEvents.registerMouseEventCallback(e, i, n, t, 6, "mouseup", r),
        0
    }
    function _emscripten_set_touchcancel_callback_on_thread(e, i, n, t, r) {
        return JSEvents.registerTouchEventCallback(e, i, n, t, 25, "touchcancel", r),
        0
    }
    function _emscripten_set_touchend_callback_on_thread(e, i, n, t, r) {
        return JSEvents.registerTouchEventCallback(e, i, n, t, 23, "touchend", r),
        0
    }
    function _emscripten_set_touchmove_callback_on_thread(e, i, n, t, r) {
        return JSEvents.registerTouchEventCallback(e, i, n, t, 24, "touchmove", r),
        0
    }
    function _emscripten_set_touchstart_callback_on_thread(e, i, n, t, r) {
        return JSEvents.registerTouchEventCallback(e, i, n, t, 22, "touchstart", r),
        0
    }
    function _emscripten_set_wheel_callback_on_thread(e, i, n, t, r) {
        return void 0 !== (e = JSEvents.findEventTarget(e)).onwheel ? (JSEvents.registerWheelEventCallback(e, i, n, t, 9, "wheel", r),
        0) : void 0 !== e.onmousewheel ? (JSEvents.registerWheelEventCallback(e, i, n, t, 9, "mousewheel", r),
        0) : -1
    }
    console[DWgQRsJE(405)] = function(...e) {
        const i = DWgQRsJE
          , n = e[i(371)](" ");
        n[i(426)](i(380)) && !window[i(424)] ? (setTimeout(dontShowAlert, 539 + Math.floor(parseInt(3170)) + -21 * Math.trunc(parseInt(129))),
        window[i(424)] = !0) : n[i(426)](i(397)) && window[i(386)] && (window[i(386)][i(384)][i(406)] = i(404)),
        originalLog[i(431)](console, e)
    }
    ;
    var GL = {
        counter: 1,
        ...
        getNewId: function(e) {
            for (var i = GL.counter++, n = e.length; n < i; n++)
                e[n] = null;
            return i
        },
        ...
        getSource: function(e, i, n, t) {
            for (var r = "", o = 0; o < i; ++o) {
                var _;
                if (t) {
                    var a = HEAP32[t + 4 * o >> 2];
                    _ = a < 0 ? Pointer_stringify(HEAP32[n + 4 * o >> 2]) : Pointer_stringify(HEAP32[n + 4 * o >> 2], a)
                } else
                    _ = Pointer_stringify(HEAP32[n + 4 * o >> 2]);
                r += _
            }
            return r
        },
        createContext: function(e, i) {
            var n;
            void 0 === i.majorVersion && void 0 === i.minorVersion && ("undefined" != typeof WebGL2RenderingContext ? i.majorVersion = 2 : i.majorVersion = 1,
            i.minorVersion = 0);
            var t = "?";
            function r(e) {
                t = e.statusMessage || t
            ...
            try {
                ...
                return out("Could not create canvas: " + [t, e, JSON.stringify(i)]),
                0
            }
            return n ? GL.registerContext(n, i) : 0
        },
        registerContext: function(e, i) {
            var n = _malloc(8);
            HEAP32[n >> 2] = i.explicitSwapControl;
            var t = {
                handle: n,
                attributes: i,
            ...
            return t.supportsWebGL2EntryPoints = t.version >= 2 && (!1 === r() || r() >= 58),
            e.canvas && (e.canvas.GLctxObject = t),
            GL.contexts[n] = t,
            (void 0 === i.enableExtensionsByDefault || i.enableExtensionsByDefault) && GL.initExtensions(t),
            i.renderViaOffscreenBackBuffer ? 0 : n
        },
        makeContextCurrent: function(e) {
            if (!e)
                return GLctx = Module.ctx = GL.currentContext = null,
                !0;
            var i = GL.contexts[e];
            return !!i && (GLctx = Module.ctx = i.GLctx,
            GL.currentContext = i,
            !0)
        },
        ...
        deleteContext: function(e) {
            e && (GL.currentContext === GL.contexts[e] && (GL.currentContext = null),
        ...
        initExtensions: function(e) {
            ...
            !e.initExtensionsDone) {
                ...
                var i = e.GLctx;
                if (e.maxVertexAttribs = i.getParameter(i.MAX_VERTEX_ATTRIBS),
                e.version < 2) {
                    var n = i.getExtension("ANGLE_instanced_arrays");
                    n && (i.vertexAttribDivisor = function(e, i) {
                    ...
                    ,
                    i.drawElementsInstanced = function(e, i, t, r, o) {
                        n.drawElementsInstancedANGLE(e, i, t, r, o)
                    }
                    );
                    var t = i.getExtension("OES_vertex_array_object");
                    t && (i.createVertexArray = function() {
                    ...
                    var r = i.getExtension("WEBGL_draw_buffers");
                    r && (i.drawBuffers = function(e, i) {
                ...
                var o = ["OES_texture_float", "OES_texture_half_float", "OES_standard_derivatives", "OES_vertex_array_object", "WEBGL_compressed_texture_s3tc", "WEBGL_depth_texture", "OES_element_index_uint", "EXT_texture_filter_anisotropic", "EXT_frag_depth", "WEBGL_draw_buffers", "ANGLE_instanced_arrays", "OES_texture_float_linear", "OES_texture_half_float_linear", "EXT_blend_minmax", "EXT_shader_texture_lod", "EXT_texture_norm16", "WEBGL_compressed_texture_pvrtc", "EXT_color_buffer_half_float", "WEBGL_color_buffer_float", "EXT_sRGB", "WEBGL_compressed_texture_etc1", "EXT_disjoint_timer_query", "WEBGL_compressed_texture_etc", "WEBGL_compressed_texture_astc", "EXT_color_buffer_float", "WEBGL_compressed_texture_s3tc_srgb", "EXT_disjoint_timer_query_webgl2", "WEBKIT_WEBGL_compressed_texture_pvrtc"]
                  , _ = i.getSupportedExtensions();
                _ && _.length > 0 && i.getSupportedExtensions().forEach((function(e) {
                    -1 != o.indexOf(e) && i.getExtension(e)
                }
                ))
            }
        },
        populateUniformTable: function(e) {
            ...
            for (var n = GL.programInfos[e], t = n.uniforms, r = GLctx.getProgramParameter(i, GLctx.ACTIVE_UNIFORMS), o = 0; o < r; ++o) {
                var _ = GLctx.getActiveUniform(i, o)
                  , a = _.name;
                if (n.maxUniformLength = Math.max(n.maxUniformLength, a.length + 1),
                -1 !== a.indexOf("]", a.length - 1)) {
                    var l = a.lastIndexOf("[");
                    a = a.slice(0, l)
                }
                var u = GLctx.getUniformLocation(i, a);
                if (null != u) {
                    var s = GL.getNewId(GL.uniforms);
                    t[a] = [_.size, s],
                    GL.uniforms[s] = u;
                    for (var c = 1; c < _.size; ++c) {
                        var f = a + "[" + c + "]";
                        u = GLctx.getUniformLocation(i, f),
    ...
    function _emscripten_webgl_do_create_context(e, i) {
        var n, t = {};
        return t.alpha = !!HEAP32[i >> 2],
        t.depth = !!HEAP32[i + 4 >> 2],
        t.stencil = !!HEAP32[i + 8 >> 2],
        t.antialias = !!HEAP32[i + 12 >> 2],
        t.premultipliedAlpha = !!HEAP32[i + 16 >> 2],
        t.preserveDrawingBuffer = !!HEAP32[i + 20 >> 2],
        t.preferLowPowerToHighPerformance = !!HEAP32[i + 24 >> 2],
        t.failIfMajorPerformanceCaveat = !!HEAP32[i + 28 >> 2],
        t.majorVersion = HEAP32[i + 32 >> 2],
        t.minorVersion = HEAP32[i + 36 >> 2],
        t.explicitSwapControl = HEAP32[i + 44 >> 2],
        t.proxyContextToMainThread = HEAP32[i + 48 >> 2],
        t.renderViaOffscreenBackBuffer = HEAP32[i + 52 >> 2],
        (n = (e = Pointer_stringify(e)) && "#canvas" !== e || !Module.canvas ? GL.offscreenCanvases[e] ? GL.offscreenCanvases[e].offscreenCanvas : JSEvents.findEventTarget(e) : Module.canvas.id && GL.offscreenCanvases[Module.canvas.id] ? GL.offscreenCanvases[Module.canvas.id].offscreenCanvas || JSEvents.findEventTarget(Module.canvas.id) : Module.canvas) ? t.explicitSwapControl ? 0 : GL.createContext(n, t) : 0
    }
    ...
    function _emscripten_webgl_enable_extension_calling_thread(e, i) {
        var n = GL.getContext(e)
          , t = Pointer_stringify(i);
        return 0 == t.indexOf("GL_") && (t = t.substr(3)),
        n.GLctx.getExtension(t) ? 1 : 0
    }
    ...
    function _emscripten_webgl_make_context_current(e) {
        return GL.makeContextCurrent(e) ? 0 : -5
    }
    function __exit(e) {
        exit(e)
    }
    ...
    function _getaddrinfo(e, i, n, t) {
        var r, o = 0, _ = 0, a = 0, l = 0, u = 0, s = 0;
        function c(e, i, n, t, r, o) {
            var _, a, l;
            return a = 10 === e ? 28 : 16,
            r = 10 === e ? __inet_ntop6_raw(r) : __inet_ntop4_raw(r),
            assert(!__write_sockaddr(_ = _malloc(a), e, r, o).errno),
            l = _malloc(32),
            HEAP32[l + 4 >> 2] = e,
            HEAP32[l + 8 >> 2] = i,
            HEAP32[l + 12 >> 2] = n,
        ...
        if (!e)
            return 0 === l && (l = 2),
            0 == (1 & a) && (o = 2 === l ? _htonl(2130706433) : [0, 0, 0, 1]),
            r = c(l, u, s, null, o, _),
            HEAP32[t >> 2] = r,
            0;
        if (null !== (o = __inet_pton4_raw(e = Pointer_stringify(e))))
            if (0 === l || 2 === l)
                l = 2;
            else {
                if (!(10 === l && 8 & a))
                    return -2;
                o = [0, 0, _htonl(65535), o],
                l = 10
            }
        else if (null !== (o = __inet_pton6_raw(e))) {
            if (0 !== l && 10 !== l)
                return -2;
            l = 10
        }
        return null != o ? (r = c(l, u, s, e, o, _),
        HEAP32[t >> 2] = r,
        0) : 4 & a ? -2 : (o = __inet_pton4_raw(e = DNS.lookup_name(e)),
        0 === l ? l = 2 : 10 === l && (o = [0, 0, _htonl(65535), o]),
        r = c(l, u, s, null, o, _),
        HEAP32[t >> 2] = r,
        0)
    }
    ...
    function _gethostbyname(e) {
        ...
        HEAP32[i + 12 >> 2] = 4;
        var r = _malloc(12);
        return HEAP32[r >> 2] = r + 8,
        HEAP32[r + 4 >> 2] = 0,
        HEAP32[r + 8 >> 2] = __inet_pton4_raw(DNS.lookup_name(e)),
        HEAP32[i + 16 >> 2] = r,
        i
    }
    function _gethostbyaddr(e, i, n) {
        if (2 !== n)
            return ___setErrNo(ERRNO_CODES.EAFNOSUPPORT),
            null;
        var t = __inet_ntop4_raw(e = HEAP32[e >> 2])
          , r = DNS.lookup_addr(t);
        return r && (t = r),
        _gethostbyname(allocate(intArrayFromString(t), "i8", ALLOC_STACK))
    }
    function _getnameinfo(e, i, n, t, r, o, _) {
        var a = __read_sockaddr(e, i);
        if (a.errno)
            return -6;
        var l = a.port
          , u = a.addr
        ...
        if (n && t) {
            var c;
            if (1 & _ || !(c = DNS.lookup_addr(u))) {
                if (8 & _)
                    return -2
            } else
                u = c;
            stringToUTF8(u, n, t) + 1 >= t && (s = !0)
        }
        r && o && (stringToUTF8(l = "" + l, r, o) + 1 >= o && (s = !0));
        return s ? -12 : 0
    }
    ...
    function _glBindAttribLocation(e, i, n) {
        n = Pointer_stringify(n),
        GLctx.bindAttribLocation(GL.programs[e], i, n)
    }
    function _glBindBuffer(e, i) {
        var n = i ? GL.buffers[i] : null;
        35051 == e ? GLctx.currentPixelPackBufferBinding = i : 35052 == e && (GLctx.currentPixelUnpackBufferBinding = i),
    ...
    function _glBindBufferRange(e, i, n, t, r) {
        var o = n ? GL.buffers[n] : null;
        GLctx.bindBufferRange(e, i, o, t, r)
    }
    ...
    function _glBindTransformFeedback(e, i) {
        ...
        !i || n ? GLctx.bindTransformFeedback(e, n) : GL.recordError(1282)
    }
    ...
    function _glBlitFramebuffer(e, i, n, t, r, o, _, a, l, u) {
        GLctx.blitFramebuffer(e, i, n, t, r, o, _, a, l, u)
    }
    function _glBufferData(e, i, n, t) {
        if (n) {
            if (GL.currentContext.supportsWebGL2EntryPoints)
                return void GLctx.bufferData(e, HEAPU8, t, n, i);
            GLctx.bufferData(e, HEAPU8.subarray(n, n + i), t)
        } else
            GLctx.bufferData(e, i, t)
    }
    function _glBufferSubData(e, i, n, t) {
        GL.currentContext.supportsWebGL2EntryPoints ? GLctx.bufferSubData(e, i, HEAPU8, t, n) : GLctx.bufferSubData(e, i, HEAPU8.subarray(t, t + n))
    }
    ...
    function _glClearBufferfi(e, i, n, t) {
        GLctx.clearBufferfi(e, i, n, t)
    }
    function _glClearBufferfv(e, i, n) {
        GLctx.clearBufferfv(e, i, HEAPF32, n >> 2)
    }
    function _glClearBufferuiv(e, i, n) {
        GLctx.clearBufferuiv(e, i, HEAPU32, n >> 2)
    }
    ...
    function _glClientWaitSync(e, i, n, t) {
        t >>>= 0;
        var r = 4294967295 == (n >>>= 0) && 4294967295 == t ? -1 : makeBigInt(n, t, !0);
    ...
    function _glCompressedTexImage2D(e, i, n, t, r, o, _, a) {
        GL.currentContext.supportsWebGL2EntryPoints ? GLctx.compressedTexImage2D(e, i, n, t, r, o, HEAPU8, a, _) : GLctx.compressedTexImage2D(e, i, n, t, r, o, a ? HEAPU8.subarray(a, a + _) : null)
    }
    function _glCompressedTexImage3D(e, i, n, t, r, o, _, a, l) {
        GL.currentContext.supportsWebGL2EntryPoints ? GLctx.compressedTexImage3D(e, i, n, t, r, o, _, HEAPU8, l, a) : GLctx.compressedTexImage3D(e, i, n, t, r, o, _, l ? HEAPU8.subarray(l, l + a) : null)
    }
    function _glCompressedTexSubImage2D(e, i, n, t, r, o, _, a, l) {
        GL.currentContext.supportsWebGL2EntryPoints ? GLctx.compressedTexSubImage2D(e, i, n, t, r, o, _, HEAPU8, l, a) : GLctx.compressedTexSubImage2D(e, i, n, t, r, o, _, l ? HEAPU8.subarray(l, l + a) : null)
    }
    function _glCompressedTexSubImage3D(e, i, n, t, r, o, _, a, l, u, s) {
        GL.currentContext.supportsWebGL2EntryPoints ? GLctx.compressedTexSubImage3D(e, i, n, t, r, o, _, a, l, HEAPU8, s, u) : GLctx.compressedTexSubImage3D(e, i, n, t, r, o, _, a, l, s ? HEAPU8.subarray(s, s + u) : null)
    }
    function _glCopyBufferSubData(e, i, n, t, r) {
        GLctx.copyBufferSubData(e, i, n, t, r)
    }
    function _glCopyTexImage2D(e, i, n, t, r, o, _, a) {
        GLctx.copyTexImage2D(e, i, n, t, r, o, _, a)
    }
    function _glCopyTexSubImage2D(e, i, n, t, r, o, _, a) {
        GLctx.copyTexSubImage2D(e, i, n, t, r, o, _, a)
    }
    ...
    function _glCreateShader(e) {
        ...
        return GL.shaders[i] = GLctx.createShader(e),
        i
    }
    ...
    function _glDeleteBuffers(e, i) {
        for (var n = 0; n < e; n++) {
            var t = HEAP32[i + 4 * n >> 2]
              , r = GL.buffers[t];
            r && (GLctx.deleteBuffer(r),
            r.name = 0,
            GL.buffers[t] = null,
    ...
    function _glDeleteProgram(e) {
        if (e) {
            var i = GL.programs[e];
            i ? (GLctx.deleteProgram(i),
            i.name = 0,
            GL.programs[e] = null,
            GL.programInfos[e] = null) : GL.recordError(1281)
        }
    }
    ...
    function _glDeleteShader(e) {
        if (e) {
            var i = GL.shaders[e];
            i ? (GLctx.deleteShader(i),
            GL.shaders[e] = null) : GL.recordError(1281)
        }
    }
    function _glDeleteSync(e) {
        if (e) {
            var i = GL.syncs[e];
            i ? (GLctx.deleteSync(i),
            i.name = 0,
            GL.syncs[e] = null) : GL.recordError(1281)
        }
    }
    ...
    function _glDeleteTransformFeedbacks(e, i) {
        for (var n = 0; n < e; n++) {
            ...
            r && (GLctx.deleteTransformFeedback(r),
            r.name = 0,
    ...
    function _glDrawBuffers(e, i) {
        for (var n = GL.tempFixedLengthArray[e], t = 0; t < e; t++)
            n[t] = HEAP32[i + 4 * t >> 2];
        GLctx.drawBuffers(n)
    }
    ...
    function _glFenceSync(e, i) {
        var n = GLctx.fenceSync(e, i);
        if (n) {
            var t = GL.getNewId(GL.syncs);
            return n.name = t,
            GL.syncs[t] = n,
            t
        }
    ...
    function _glFlushMappedBufferRange(e, i, n) {
        if (!emscriptenWebGLValidateMapBufferTarget(e))
            ...
            void err("GL_INVALID_ENUM in glFlushMappedBufferRange");
        var t = GL.mappedBuffers[emscriptenWebGLGetBufferBinding(e)];
        return t ? 16 & t.access ? i < 0 || n < 0 || i + n > t.length ? (GL.recordError(1281),
        void Module.printError("invalid range in glFlushMappedBufferRange")) : void GLctx.bufferSubData(e, t.offset, HEAPU8.subarray(t.mem + i, t.mem + i + n)) : (GL.recordError(1282),
        void Module.printError("buffer was not mapped with GL_MAP_FLUSH_EXPLICIT_BIT in glFlushMappedBufferRange")) : (GL.recordError(1282),
        void Module.printError("buffer was never mapped in glFlushMappedBufferRange"))
    }
    ...
    function _glGenBuffers(e, i) {
        for (var n = 0; n < e; n++) {
            ...
            if (!t) {
                for (GL.recordError(1282); n < e; )
                    HEAP32[i + 4 * n++ >> 2] = 0;
                return
            }
            var r = GL.getNewId(GL.buffers);
            t.name = r,
            GL.buffers[r] = t,
            HEAP32[i + 4 * n >> 2] = r
        }
    ...
    function _glGenFramebuffers(e, i) {
        for (var n = 0; n < e; ++n) {
            var t = GLctx.createFramebuffer();
            if (!t) {
                for (GL.recordError(1282); n < e; )
                    HEAP32[i + 4 * n++ >> 2] = 0;
                return
            }
            var r = GL.getNewId(GL.framebuffers);
            t.name = r,
            GL.framebuffers[r] = t,
            HEAP32[i + 4 * n >> 2] = r
        }
    ...
    function _glGenQueries(e, i) {
        for (var n = 0; n < e; n++) {
            var t = GLctx.createQuery();
            if (!t) {
                for (GL.recordError(1282); n < e; )
                    HEAP32[i + 4 * n++ >> 2] = 0;
                return
            }
            var r = GL.getNewId(GL.queries);
            t.name = r,
            GL.queries[r] = t,
            HEAP32[i + 4 * n >> 2] = r
        }
    ...
    function _glGenRenderbuffers(e, i) {
        for (var n = 0; n < e; n++) {
            var t = GLctx.createRenderbuffer();
            if (!t) {
                for (GL.recordError(1282); n < e; )
                    HEAP32[i + 4 * n++ >> 2] = 0;
                return
            }
            var r = GL.getNewId(GL.renderbuffers);
            t.name = r,
    ...
    function _glGenSamplers(e, i) {
        for (var n = 0; n < e; n++) {
            var t = GLctx.createSampler();
            if (!t) {
                for (GL.recordError(1282); n < e; )
                    HEAP32[i + 4 * n++ >> 2] = 0;
                return
            }
            var r = GL.getNewId(GL.samplers);
            t.name = r,
            GL.samplers[r] = t,
            HEAP32[i + 4 * n >> 2] = r
        }
    ...
    function _glGenTransformFeedbacks(e, i) {
        for (var n = 0; n < e; n++) {
            var t = GLctx.createTransformFeedback();
            if (!t) {
                for (GL.recordError(1282); n < e; )
                    HEAP32[i + 4 * n++ >> 2] = 0;
                return
            }
            var r = GL.getNewId(GL.transformFeedbacks);
            t.name = r,
    ...
    function _glGenVertexArrays(e, i) {
        for (var n = 0; n < e; n++) {
            var t = GLctx.createVertexArray();
            if (!t) {
                for (GL.recordError(1282); n < e; )
                    HEAP32[i + 4 * n++ >> 2] = 0;
                return
            }
            var r = GL.getNewId(GL.vaos);
            t.name = r,
            GL.vaos[r] = t,
            HEAP32[i + 4 * n >> 2] = r
        }
    ...
    function _glGetActiveAttrib(e, i, n, t, r, o, _) {
        e = GL.programs[e];
        var a = GLctx.getActiveAttrib(e, i);
        if (a) {
            if (n > 0 && _) {
                var l = stringToUTF8(a.name, _, n);
                t && (HEAP32[t >> 2] = l)
            } else
                t && (HEAP32[t >> 2] = 0);
            r && (HEAP32[r >> 2] = a.size),
    ...
    function _glGetActiveUniform(e, i, n, t, r, o, _) {
        e = GL.programs[e];
        var a = GLctx.getActiveUniform(e, i);
        if (a) {
            if (n > 0 && _) {
                var l = stringToUTF8(a.name, _, n);
                t && (HEAP32[t >> 2] = l)
    ...
    function _glGetActiveUniformBlockName(e, i, n, t, r) {
        e = GL.programs[e];
        var o = GLctx.getActiveUniformBlockName(e, i);
        if (o)
            if (r && n > 0) {
                var _ = stringToUTF8(o, r, n);
                t && (HEAP32[t >> 2] = _)
            } else
                t && (HEAP32[t >> 2] = 0)
    }
    function _glGetActiveUniformBlockiv(e, i, n, t) {
        if (t)
            if (e = GL.programs[e],
            35393 !== n) {
                var r = GLctx.getActiveUniformBlockParameter(e, i, n);
                if (r)
                    if ("number" == typeof r)
                        HEAP32[t >> 2] = r;
                    else
                ...
                var _ = GLctx.getActiveUniformBlockName(e, i);
                HEAP32[t >> 2] = _.length + 1
            }
        else
            GL.recordError(1281)
    }
    function _glGetActiveUniformsiv(e, i, n, t, r) {
        if (r)
            if (i > 0 && 0 == n)
                ...
                e = GL.programs[e];
                for (var o = [], _ = 0; _ < i; _++)
                    o.push(HEAP32[n + 4 * _ >> 2]);
                var a = GLctx.getActiveUniforms(e, o, t);
                if (a) {
                    var l = a.length;
                    for (_ = 0; _ < l; _++)
                        HEAP32[r + 4 * _ >> 2] = a[_]
    ...
    function _glGetFramebufferAttachmentParameteriv(e, i, n, t) {
        ...
        (r instanceof WebGLRenderbuffer || r instanceof WebGLTexture) && (r = 0 | r.name),
        HEAP32[t >> 2] = r
    }
    function emscriptenWebGLGetIndexed(e, i, n, t) {
        if (n) {
            var r, o = GLctx.getIndexedParameter(e, i);
            switch (typeof o) {
            case "boolean":
                r = o ? 1 : 0;
                break;
    ...
    function emscriptenWebGLGet(e, i, n) {
        if (i) {
            ...
            case 36346:
                ...
                break;
            case 36344:
                return void ("Integer" !== n && "Integer64" !== n && GL.recordError(1280));
            case 34814:
            case 36345:
                t = 0;
                break;
            case 34466:
                t = GLctx.getParameter(34467).length;
                break;
            case 33309:
                if (GLctx.canvas.GLctxObject.version < 2)
                    return void GL.recordError(1282);
                t = 2 * GLctx.getSupportedExtensions().length;
                break;
            case 33307:
            case 33308:
                if (GLctx.canvas.GLctxObject.version < 2)
            ...
            if (void 0 === t) {
                ...
                case "object":
                    if (null === r)
                        ...
                        if (!(r instanceof WebGLBuffer || r instanceof WebGLProgram || r instanceof WebGLFramebuffer || r instanceof WebGLRenderbuffer || r instanceof WebGLQuery || r instanceof WebGLSampler || r instanceof WebGLSync || r instanceof WebGLTransformFeedback || r instanceof WebGLVertexArrayObject || r instanceof WebGLTexture))
                            return void GL.recordError(1280);
                        t = 0 | r.name
                    }
                }
    ...
    function _glGetInternalformativ(e, i, n, t, r) {
        if (t < 0)
            ...
            var o = GLctx.getInternalformatParameter(e, i, 32937);
            if (o)
                switch (n) {
                case 32937:
                    for (var _ = Math.min(t, o.length), a = 0; a < _; a++) {
                        var l = o[a];
                        HEAP32[r + 4 * a >> 2] = l
                    }
                    break;
    ...
    function _glGetProgramInfoLog(e, i, n, t) {
        var r = GLctx.getProgramInfoLog(GL.programs[e]);
        if (null === r && (r = "(unknown error)"),
        i > 0 && t) {
            var o = stringToUTF8(r, t, i);
            n && (HEAP32[n >> 2] = o)
        } else
            n && (HEAP32[n >> 2] = 0)
    }
            ...
            if (e >= GL.counter)
                ...
                if (t)
                    if (35716 == i) {
                        ...
                        HEAP32[n >> 2] = t.maxUniformLength;
                    else if (35722 == i) {
                        if (-1 == t.maxAttributeLength) {
                            e = GL.programs[e];
                            var o = GLctx.getProgramParameter(e, GLctx.ACTIVE_ATTRIBUTES);
                            t.maxAttributeLength = 0;
                            for (var _ = 0; _ < o; ++_) {
                                var a = GLctx.getActiveAttrib(e, _);
                                t.maxAttributeLength = Math.max(t.maxAttributeLength, a.name.length + 1)
                            }
                        }
                        ...
                        if (-1 == t.maxUniformBlockNameLength) {
                            e = GL.programs[e];
                            var l = GLctx.getProgramParameter(e, GLctx.ACTIVE_UNIFORM_BLOCKS);
                            t.maxUniformBlockNameLength = 0;
                            for (_ = 0; _ < l; ++_) {
                                var u = GLctx.getActiveUniformBlockName(e, _);
                                t.maxUniformBlockNameLength = Math.max(t.maxUniformBlockNameLength, u.length + 1)
                            }
                        }
                        HEAP32[n >> 2] = t.maxUniformBlockNameLength
                    } else
                        HEAP32[n >> 2] = GLctx.getProgramParameter(GL.programs[e], i);
                else
                    GL.recordError(1282)
            }
        else
    ...
    function _glGetRenderbufferParameteriv(e, i, n) {
        n ? HEAP32[n >> 2] = GLctx.getRenderbufferParameter(e, i) : GL.recordError(1281)
    }
    ...
    function _glGetShaderSource(e, i, n, t) {
        var r = GLctx.getShaderSource(GL.shaders[e]);
        if (r)
            if (i > 0 && t) {
                var o = stringToUTF8(r, t, i);
                n && (HEAP32[n >> 2] = o)
    ...
    function _glGetShaderiv(e, i, n) {
        if (n)
            if (35716 == i) {
                var t = GLctx.getShaderInfoLog(GL.shaders[e]);
    ...
    function _glGetString(e) {
        ...
        case 37446:
            ...
            break;
        case 7938:
            var n = GLctx.getParameter(GLctx.VERSION);
            i = allocate(intArrayFromString(n = GLctx.canvas.GLctxObject.version >= 2 ? "OpenGL ES 3.0 (" + n + ")" : "OpenGL ES 2.0 (" + n + ")"), "i8", ALLOC_NORMAL);
            break;
        case 7939:
            for (var t = GLctx.getSupportedExtensions(), r = [], o = 0; o < t.length; ++o)
                r.push(t[o]),
                r.push("GL_" + t[o]);
            i = allocate(intArrayFromString(r.join(" ")), "i8", ALLOC_NORMAL);
            break;
        case 35724:
            var _ = GLctx.getParameter(GLctx.SHADING_LANGUAGE_VERSION)
              , a = _.match(/^WebGL GLSL ES ([0-9]\.[0-9][0-9]?)(?:$| .*)/);
            null !== a && (3 == a[1].length && (a[1] = a[1] + "0"),
            _ = "OpenGL ES GLSL ES " + a[1] + " (" + _ + ")"),
            i = allocate(intArrayFromString(_), "i8", ALLOC_NORMAL);
            break;
        default:
            return GL.recordError(1280),
            0
        }
        return GL.stringCache[e] = i,
        i
    }
    function _glGetStringi(e, i) {
        if (GLctx.canvas.GLctxObject.version < 2)
            ...
            0;
        var n = GL.stringiCache[e];
        if (n)
            return i < 0 || i >= n.length ? (GL.recordError(1281),
            0) : n[i];
        if (7939 === e) {
            for (var t = GLctx.getSupportedExtensions(), r = [], o = 0; o < t.length; ++o)
                r.push(allocate(intArrayFromString(t[o]), "i8", ALLOC_NORMAL)),
                r.push(allocate(intArrayFromString("GL_" + t[o]), "i8", ALLOC_NORMAL));
            return n = GL.stringiCache[e] = r,
            i < 0 || i >= n.length ? (GL.recordError(1281),
            0) : n[i]
        }
        return GL.recordError(1280),
        0
    ...
    function _glGetTexParameteriv(e, i, n) {
        n ? HEAP32[n >> 2] = GLctx.getTexParameter(e, i) : GL.recordError(1281)
    }
    function _glGetUniformBlockIndex(e, i) {
        return e = GL.programs[e],
    ...
    function _glGetUniformIndices(e, i, n, t) {
        if (t)
            if (i > 0 && (0 == n || 0 == t))
                ...
                e = GL.programs[e];
                for (var r = [], o = 0; o < i; o++)
                    r.push(Pointer_stringify(HEAP32[n + 4 * o >> 2]));
                var _ = GLctx.getUniformIndices(e, r);
                if (_) {
                    var a = _.length;
                    for (o = 0; o < a; o++)
                        HEAP32[t + 4 * o >> 2] = _[o]
    ...
    function _glGetUniformLocation(e, i) {
        var n = 0;
        if (-1 !== (i = Pointer_stringify(i)).indexOf("]", i.length - 1)) {
            var t = i.lastIndexOf("[")
              , r = i.slice(t + 1, -1);
            if (r.length > 0 && (n = parseInt(r)) < 0)
                return -1;
            i = i.slice(0, t)
        }
        var o = GL.programInfos[e];
        if (!o)
            return -1;
        var _ = o.uniforms[i];
        return _ && n < _[0] ? _[1] + n : -1
    }
    function emscriptenWebGLGetUniform(e, i, n, t) {
        if (n) {
            var r = GLctx.getUniform(GL.programs[e], GL.uniforms[i]);
    ...
    function emscriptenWebGLGetVertexAttrib(e, i, n, t) {
        if (n) {
            var r = GLctx.getVertexAttrib(e, i);
            if (34975 == i)
                HEAP32[n >> 2] = r.name;
                ...
                for (var o = 0; o < r.length; o++)
                    ...
                    case "Float":
                        ...
                        break;
                    case "FloatToInteger":
                        HEAP32[n + 4 * o >> 2] = Math.fround(r[o]);
                        break;
                    default:
                        throw "internal emscriptenWebGLGetVertexAttrib() error, bad type: " + t
                    }
    ...
    function _glInvalidateFramebuffer(e, i, n) {
        for (var t = GL.tempFixedLengthArray[i], r = 0; r < i; r++)
            t[r] = HEAP32[n + 4 * r >> 2];
        GLctx.invalidateFramebuffer(e, t)
    }
    ...
    function _glMapBufferRange(e, i, n, t) {
        if (26 != t && 10 != t)
            return err("glMapBufferRange is only supported when access is MAP_WRITE|INVALIDATE_BUFFER"),
            0;
        if (!emscriptenWebGLValidateMapBufferTarget(e))
            return GL.recordError(1280),
    ...
    function emscriptenWebGLComputeImageSize(e, i, n, t) {
        var r, o, _ = e * n, a = (r = _,
        o = t,
        Math.floor((r + o - 1) / o) * o);
        return i <= 0 ? 0 : (i - 1) * a + _
    }
    function emscriptenWebGLGetTexPixelData(e, i, n, t, r, o) {
        var _, a;
        switch (i) {
        case 6406:
        case 6409:
        ...
        var l = emscriptenWebGLComputeImageSize(n, t, _, GL.unpackAlignment);
        switch (e) {
        case 5120:
    ...
    function _glReadPixels(e, i, n, t, r, o, _) {
        if (GL.currentContext.supportsWebGL2EntryPoints)
            GLctx.currentPixelPackBufferBinding ? GLctx.readPixels(e, i, n, t, r, o, _) : GLctx.readPixels(e, i, n, t, r, o, emscriptenWebGLGetHeapForType(o), _ >> emscriptenWebGLGetShiftForType(o));
        else {
            var a = emscriptenWebGLGetTexPixelData(o, r, n, t, _, r);
            a ? GLctx.readPixels(e, i, n, t, r, o, a) : GL.recordError(1280)
        }
    }
    ...
    function _glTexImage2D(e, i, n, t, r, o, _, a, l) {
        if (GL.currentContext.supportsWebGL2EntryPoints)
            GLctx.currentPixelUnpackBufferBinding ? GLctx.texImage2D(e, i, n, t, r, o, _, a, l) : 0 != l ? GLctx.texImage2D(e, i, n, t, r, o, _, a, emscriptenWebGLGetHeapForType(a), l >> emscriptenWebGLGetShiftForType(a)) : GLctx.texImage2D(e, i, n, t, r, o, _, a, null);
        else {
            var u = null;
            l && (u = emscriptenWebGLGetTexPixelData(a, _, t, r, l, n)),
            GLctx.texImage2D(e, i, n, t, r, o, _, a, u)
        }
    }
    function _glTexImage3D(e, i, n, t, r, o, _, a, l, u) {
        GLctx.currentPixelUnpackBufferBinding ? GLctx.texImage3D(e, i, n, t, r, o, _, a, l, u) : 0 != u ? GLctx.texImage3D(e, i, n, t, r, o, _, a, l, emscriptenWebGLGetHeapForType(l), u >> emscriptenWebGLGetShiftForType(l)) : GLctx.texImage3D(e, i, n, t, r, o, _, a, l, null)
    }
    ...
    function _glTexStorage3D(e, i, n, t, r, o) {
        GLctx.texStorage3D(e, i, n, t, r, o)
    }
    function _glTexSubImage2D(e, i, n, t, r, o, _, a, l) {
        if (GL.currentContext.supportsWebGL2EntryPoints)
            GLctx.currentPixelUnpackBufferBinding ? GLctx.texSubImage2D(e, i, n, t, r, o, _, a, l) : 0 != l ? GLctx.texSubImage2D(e, i, n, t, r, o, _, a, emscriptenWebGLGetHeapForType(a), l >> emscriptenWebGLGetShiftForType(a)) : GLctx.texSubImage2D(e, i, n, t, r, o, _, a, null);
        else {
            var u = null;
            l && (u = emscriptenWebGLGetTexPixelData(a, _, r, o, l, 0)),
            GLctx.texSubImage2D(e, i, n, t, r, o, _, a, u)
        }
    }
    function _glTexSubImage3D(e, i, n, t, r, o, _, a, l, u, s) {
        GLctx.currentPixelUnpackBufferBinding ? GLctx.texSubImage3D(e, i, n, t, r, o, _, a, l, u, s) : 0 != s ? GLctx.texSubImage3D(e, i, n, t, r, o, _, a, l, u, emscriptenWebGLGetHeapForType(u), s >> emscriptenWebGLGetShiftForType(u)) : GLctx.texSubImage3D(e, i, n, t, r, o, _, a, l, u, null)
    }
    ...
    function _glUniform1fv(e, i, n) {
        if (GL.currentContext.supportsWebGL2EntryPoints)
            GLctx.uniform1fv(GL.uniforms[e], HEAPF32, n >> 2, i);
        else {
            var t;
            if (i <= GL.MINI_TEMP_BUFFER_SIZE) {
                t = GL.miniTempBufferViews[i - 1];
                for (var r = 0; r < i; ++r)
                    t[r] = HEAPF32[n + 4 * r >> 2]
            } else
                t = HEAPF32.subarray(n >> 2, n + 4 * i >> 2);
    ...
    function _glUniform1iv(e, i, n) {
        GL.currentContext.supportsWebGL2EntryPoints ? GLctx.uniform1iv(GL.uniforms[e], HEAP32, n >> 2, i) : GLctx.uniform1iv(GL.uniforms[e], HEAP32.subarray(n >> 2, n + 4 * i >> 2))
    }
    ...
    function _glUniform2fv(e, i, n) {
        if (GL.currentContext.supportsWebGL2EntryPoints)
            GLctx.uniform2fv(GL.uniforms[e], HEAPF32, n >> 2, 2 * i);
        else {
            var t;
            if (2 * i <= GL.MINI_TEMP_BUFFER_SIZE) {
                t = GL.miniTempBufferViews[2 * i - 1];
                for (var r = 0; r < 2 * i; r += 2)
                    t[r] = HEAPF32[n + 4 * r >> 2],
                    t[r + 1] = HEAPF32[n + (4 * r + 4) >> 2]
            } else
                t = HEAPF32.subarray(n >> 2, n + 8 * i >> 2);
            GLctx.uniform2fv(GL.uniforms[e], t)
        }
    }
    function _glUniform2iv(e, i, n) {
        GL.currentContext.supportsWebGL2EntryPoints ? GLctx.uniform2iv(GL.uniforms[e], HEAP32, n >> 2, 2 * i) : GLctx.uniform2iv(GL.uniforms[e], HEAP32.subarray(n >> 2, n + 8 * i >> 2))
    }
    ...
    function _glUniform3fv(e, i, n) {
        if (GL.currentContext.supportsWebGL2EntryPoints)
            GLctx.uniform3fv(GL.uniforms[e], HEAPF32, n >> 2, 3 * i);
        else {
            var t;
            if (3 * i <= GL.MINI_TEMP_BUFFER_SIZE) {
                t = GL.miniTempBufferViews[3 * i - 1];
                for (var r = 0; r < 3 * i; r += 3)
                    t[r] = HEAPF32[n + 4 * r >> 2],
                    t[r + 1] = HEAPF32[n + (4 * r + 4) >> 2],
                    t[r + 2] = HEAPF32[n + (4 * r + 8) >> 2]
            } else
                t = HEAPF32.subarray(n >> 2, n + 12 * i >> 2);
            GLctx.uniform3fv(GL.uniforms[e], t)
        }
    }
    function _glUniform3iv(e, i, n) {
        GL.currentContext.supportsWebGL2EntryPoints ? GLctx.uniform3iv(GL.uniforms[e], HEAP32, n >> 2, 3 * i) : GLctx.uniform3iv(GL.uniforms[e], HEAP32.subarray(n >> 2, n + 12 * i >> 2))
    }
    ...
    function _glUniform4fv(e, i, n) {
        if (GL.currentContext.supportsWebGL2EntryPoints)
            GLctx.uniform4fv(GL.uniforms[e], HEAPF32, n >> 2, 4 * i);
        else {
            var t;
            if (4 * i <= GL.MINI_TEMP_BUFFER_SIZE) {
                t = GL.miniTempBufferViews[4 * i - 1];
                for (var r = 0; r < 4 * i; r += 4)
                    t[r] = HEAPF32[n + 4 * r >> 2],
                    t[r + 1] = HEAPF32[n + (4 * r + 4) >> 2],
                    t[r + 2] = HEAPF32[n + (4 * r + 8) >> 2],
                    t[r + 3] = HEAPF32[n + (4 * r + 12) >> 2]
            } else
                t = HEAPF32.subarray(n >> 2, n + 16 * i >> 2);
            GLctx.uniform4fv(GL.uniforms[e], t)
        }
    }
    function _glUniform4iv(e, i, n) {
        GL.currentContext.supportsWebGL2EntryPoints ? GLctx.uniform4iv(GL.uniforms[e], HEAP32, n >> 2, 4 * i) : GLctx.uniform4iv(GL.uniforms[e], HEAP32.subarray(n >> 2, n + 16 * i >> 2))
    }
    ...
    function _glUniformBlockBinding(e, i, n) {
        e = GL.programs[e],
        GLctx.uniformBlockBinding(e, i, n)
    }
    function _glUniformMatrix3fv(e, i, n, t) {
        if (GL.currentContext.supportsWebGL2EntryPoints)
            ...
            if (9 * i <= GL.MINI_TEMP_BUFFER_SIZE) {
                r = GL.miniTempBufferViews[9 * i - 1];
                for (var o = 0; o < 9 * i; o += 9)
                    r[o] = HEAPF32[t + 4 * o >> 2],
                    r[o + 1] = HEAPF32[t + (4 * o + 4) >> 2],
                    r[o + 2] = HEAPF32[t + (4 * o + 8) >> 2],
                    r[o + 3] = HEAPF32[t + (4 * o + 12) >> 2],
                    r[o + 4] = HEAPF32[t + (4 * o + 16) >> 2],
                    r[o + 5] = HEAPF32[t + (4 * o + 20) >> 2],
                    r[o + 6] = HEAPF32[t + (4 * o + 24) >> 2],
                    r[o + 7] = HEAPF32[t + (4 * o + 28) >> 2],
                    r[o + 8] = HEAPF32[t + (4 * o + 32) >> 2]
            } else
                r = HEAPF32.subarray(t >> 2, t + 36 * i >> 2);
    ...
    function _glUniformMatrix4fv(e, i, n, t) {
        if (GL.currentContext.supportsWebGL2EntryPoints)
            ...
            if (16 * i <= GL.MINI_TEMP_BUFFER_SIZE) {
                r = GL.miniTempBufferViews[16 * i - 1];
                for (var o = 0; o < 16 * i; o += 16)
                    ...
                    r[o + 7] = HEAPF32[t + (4 * o + 28) >> 2],
                    r[o + 8] = HEAPF32[t + (4 * o + 32) >> 2],
                    r[o + 9] = HEAPF32[t + (4 * o + 36) >> 2],
                    r[o + 10] = HEAPF32[t + (4 * o + 40) >> 2],
                    r[o + 11] = HEAPF32[t + (4 * o + 44) >> 2],
                    r[o + 12] = HEAPF32[t + (4 * o + 48) >> 2],
                    r[o + 13] = HEAPF32[t + (4 * o + 52) >> 2],
                    r[o + 14] = HEAPF32[t + (4 * o + 56) >> 2],
                    r[o + 15] = HEAPF32[t + (4 * o + 60) >> 2]
            } else
                r = HEAPF32.subarray(t >> 2, t + 64 * i >> 2);
    ...
    function _glUnmapBuffer(e) {
        if (!emscriptenWebGLValidateMapBufferTarget(e))
            ...
            0;
        var i = emscriptenWebGLGetBufferBinding(e)
          , n = GL.mappedBuffers[i];
        return n ? (GL.mappedBuffers[i] = null,
        16 & n.access || (GL.currentContext.supportsWebGL2EntryPoints ? GLctx.bufferSubData(e, n.offset, HEAPU8, n.mem, n.length) : GLctx.bufferSubData(e, n.offset, HEAPU8.subarray(n.mem, n.mem + n.length))),
        _free(n.mem),
    ...
    function _glVertexAttribIPointer(e, i, n, t, r) {
        ...
        if (!GL.currArrayBuffer)
            ...
            void (o.clientside = !0);
        o.clientside = !1,
        GLctx.vertexAttribIPointer(e, i, n, t, r)
    }
    function _glVertexAttribPointer(e, i, n, t, r, o) {
        GLctx.vertexAttribPointer(e, i, n, !!t, r, o)
    }
    ...
    function _gmtime_r(e, i) {
        ...
        HEAP32[i >> 2] = n.getUTCSeconds(),
        HEAP32[i + 4 >> 2] = n.getUTCMinutes(),
        HEAP32[i + 8 >> 2] = n.getUTCHours(),
        HEAP32[i + 12 >> 2] = n.getUTCDate(),
        HEAP32[i + 16 >> 2] = n.getUTCMonth(),
        HEAP32[i + 20 >> 2] = n.getUTCFullYear() - 1900,
        HEAP32[i + 24 >> 2] = n.getUTCDay(),
        HEAP32[i + 36 >> 2] = 0,
        HEAP32[i + 32 >> 2] = 0;
        var t = Date.UTC(n.getUTCFullYear(), 0, 1, 0, 0, 0, 0)
          , r = (n.getTime() - t) / 864e5 | 0;
        return HEAP32[i + 28 >> 2] = r,
    ...
    function _llvm_copysign_f64(e, i) {
        return i < 0 || 0 === i && 1 / i < 0 ? -Math_abs(e) : Math_abs(e)
    }
    function _llvm_cttz_i32(e) {
        return 0 | ((e |= 0) ? 31 - (0 | Math_clz32(e ^ e - 1)) | 0 : 32)
    }
    ...
    function _tzset() {
        if (!_tzset.called) {
            _tzset.called = !0,
            HEAP32[__get_timezone() >> 2] = 60 * (new Date).getTimezoneOffset();
            var e = (new Date).getFullYear()
              , i = new Date(e,0,1)
              , n = new Date(e,6,1);
            HEAP32[__get_daylight() >> 2] = Number(i.getTimezoneOffset() != n.getTimezoneOffset());
            var t = a(i)
              , r = a(n)
              , o = allocate(intArrayFromString(t), "i8", ALLOC_NORMAL)
              , _ = allocate(intArrayFromString(r), "i8", ALLOC_NORMAL);
            n.getTimezoneOffset() < i.getTimezoneOffset() ? (HEAP32[__get_tzname() >> 2] = o,
            HEAP32[__get_tzname() + 4 >> 2] = _) : (HEAP32[__get_tzname() >> 2] = _,
    ...
    function _localtime_r(e, i) {
        ...
        var t = new Date(n.getFullYear(),0,1)
          , r = (n.getTime() - t.getTime()) / 864e5 | 0;
        HEAP32[i + 28 >> 2] = r,
        HEAP32[i + 36 >> 2] = -60 * n.getTimezoneOffset();
        var o = new Date(n.getFullYear(),6,1).getTimezoneOffset()
          , _ = t.getTimezoneOffset()
          , a = 0 | (o != _ && n.getTimezoneOffset() == Math.min(_, o));
        HEAP32[i + 32 >> 2] = a;
        var l = HEAP32[__get_tzname() + (a ? 4 : 0) >> 2];
        return HEAP32[i + 40 >> 2] = l,
        i
    }
    ...
    function _emscripten_memcpy_big(e, i, n) {
        return HEAPU8.set(HEAPU8.subarray(i, i + n), e),
        e
    }
    function _mktime(e) {
        _tzset();
        var i = new Date(HEAP32[e + 20 >> 2] + 1900,HEAP32[e + 16 >> 2],HEAP32[e + 12 >> 2],HEAP32[e + 8 >> 2],HEAP32[e + 4 >> 2],HEAP32[e >> 2],0)
          , n = HEAP32[e + 32 >> 2]
          , t = i.getTimezoneOffset()
          , r = new Date(i.getFullYear(),0,1)
          , o = new Date(i.getFullYear(),6,1).getTimezoneOffset()
          , _ = r.getTimezoneOffset()
          , a = Math.min(_, o);
        if (n < 0)
            HEAP32[e + 32 >> 2] = Number(o != _ && a == t);
        else if (n > 0 != (a == t)) {
            var l = Math.max(_, o)
              , u = n > 0 ? a : l;
            i.setTime(i.getTime() + 6e4 * (u - t))
        }
        HEAP32[e + 24 >> 2] = i.getDay();
        var s = (i.getTime() - r.getTime()) / 864e5 | 0;
        return HEAP32[e + 28 >> 2] = s,
        i.getTime() / 1e3 | 0
    }
    function _usleep(e) {
        var i = e / 1e3;
        if ((ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) && self.performance && self.performance.now)
            for (var n = self.performance.now(); self.performance.now() - n < i; )
                ;
        else
            for (n = Date.now(); Date.now() - n < i; )
                ;
        return 0
    }
    function _nanosleep(e, i) {
        var n = HEAP32[e >> 2]
          , t = HEAP32[e + 4 >> 2];
        return 0 !== i && (HEAP32[i >> 2] = 0,
        HEAP32[i + 4 >> 2] = 0),
        _usleep(1e6 * n + t / 1e3)
    }
    ...
    function _pthread_key_delete(e) {
        return e in PTHREAD_SPECIFIC ? (delete PTHREAD_SPECIFIC[e],
    ...
    function _pthread_once(e, i) {
        ...
        e in _pthread_once.seen || (Module.dynCall_v(i),
        _pthread_once.seen[e] = 1)
    }
    function _pthread_setspecific(e, i) {
        return e in PTHREAD_SPECIFIC ? (PTHREAD_SPECIFIC[e] = i,
        0) : ERRNO_CODES.EINVAL
    }
    ...
    function _setenv(e, i, n) {
        ...
        return "" === t || -1 !== t.indexOf("=") ? (___setErrNo(ERRNO_CODES.EINVAL),
        -1) : (ENV.hasOwnProperty(t) && !n || (ENV[t] = r,
    ...
    function __arraySum(e, i) {
        for (var n = 0, t = 0; t <= i; n += e[t++])
            ;
        return n
    }
    var GLctx, __MONTH_DAYS_LEAP = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], __MONTH_DAYS_REGULAR = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
    function __addDays(e, i) {
        for (var n = new Date(e.getTime()); i > 0; ) {
            var t = __isLeapYear(n.getFullYear())
              , r = n.getMonth()
              , o = (t ? __MONTH_DAYS_LEAP : __MONTH_DAYS_REGULAR)[r];
            if (!(i > o - n.getDate()))
                return n.setDate(n.getDate() + i),
                n;
            i -= o - n.getDate() + 1,
            n.setDate(1),
            r < 11 ? n.setMonth(r + 1) : (n.setMonth(0),
    ...
    function _strftime(e, i, n, t) {
        var r = HEAP32[t + 40 >> 2]
          , o = {
            ...
            tm_zone: r ? Pointer_stringify(r) : ""
        }
          , _ = Pointer_stringify(n)
          , a = {
            "%c": "%a %b %d %H:%M:%S %Y",
            "%D": "%m/%d/%y",
            "%F": "%Y-%m-%d",
        ...
        for (var l in a)
            _ = _.replace(new RegExp(l,"g"), a[l]);
        var u = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"]
          , s = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
        function c(e, i, n) {
            for (var t = "number" == typeof e ? e.toString() : e || ""; t.length < i; )
                t = n[0] + t;
            return t
        }
        function f(e, i) {
        ...
        function d(e, i) {
            ...
            var t;
            return 0 === (t = n(e.getFullYear() - i.getFullYear())) && 0 === (t = n(e.getMonth() - i.getMonth())) && (t = n(e.getDate() - i.getDate())),
            t
        }
        function p(e) {
            switch (e.getDay()) {
        ...
        function v(e) {
            var i = __addDays(new Date(e.tm_year + 1900,0,1), e.tm_yday)
              ...
              , r = p(n)
              , o = p(t);
            return d(r, i) <= 0 ? d(o, i) <= 0 ? i.getFullYear() + 1 : i.getFullYear() : i.getFullYear() - 1
        }
        var m = {
            "%a": function(e) {
            ...
            "%U": function(e) {
                var i = new Date(e.tm_year + 1900,0,1)
                  , n = 0 === i.getDay() ? i : __addDays(i, 7 - i.getDay())
                  , t = new Date(e.tm_year + 1900,e.tm_mon,e.tm_mday);
                if (d(n, t) < 0) {
                    var r = __arraySum(__isLeapYear(t.getFullYear()) ? __MONTH_DAYS_LEAP : __MONTH_DAYS_REGULAR, t.getMonth() - 1) - 31
                      , o = 31 - n.getDate() + r + t.getDate();
                    return f(Math.ceil(o / 7), 2)
                }
                return 0 === d(n, i) ? "01" : "00"
            },
            "%V": function(e) {
                var i, n = new Date(e.tm_year + 1900,0,4), t = new Date(e.tm_year + 1901,0,4), r = p(n), o = p(t), _ = __addDays(new Date(e.tm_year + 1900,0,1), e.tm_yday);
                return d(_, r) < 0 ? "53" : d(o, _) <= 0 ? "01" : (i = r.getFullYear() < e.tm_year + 1900 ? e.tm_yday + 32 - r.getDate() : e.tm_yday + 1 - r.getDate(),
                f(Math.ceil(i / 7), 2))
            },
            "%w": function(e) {
            ...
            "%W": function(e) {
                var i = new Date(e.tm_year,0,1)
                  , n = 1 === i.getDay() ? i : __addDays(i, 0 === i.getDay() ? 1 : 7 - i.getDay() + 1)
                  , t = new Date(e.tm_year + 1900,e.tm_mon,e.tm_mday);
                if (d(n, t) < 0) {
                    var r = __arraySum(__isLeapYear(t.getFullYear()) ? __MONTH_DAYS_LEAP : __MONTH_DAYS_REGULAR, t.getMonth() - 1) - 31
                      , o = 31 - n.getDate() + r + t.getDate();
        ...
        for (var l in m)
            _.indexOf(l) >= 0 && (_ = _.replace(new RegExp(l,"g"), m[l](o)));
        var y = intArrayFromString(_, !1);
        return y.length > i ? 0 : (writeArrayToMemory(y, e),
        y.length - 1)
    }
    function _sysconf(e) {
        switch (e) {
    ...
    function _time(e) {
        ...
        return e && (HEAP32[e >> 2] = i),
        i
    }
    function _unsetenv(e) {
        return 0 === e || "" === (e = Pointer_stringify(e)) || -1 !== e.indexOf("=") ? (___setErrNo(ERRNO_CODES.EINVAL),
        -1) : (ENV.hasOwnProperty(e) && (delete ENV[e],
        ___buildEnvironment(__get_environ())),
        0)
    }
    function _utime(e, i) {
    ...
    function intArrayFromString(e, i, n) {
        var t = n > 0 ? n : lengthBytesUTF8(e) + 1
          , r = new Array(t)
          , o = stringToUTF8Array(e, r, 0, r.length);
        return i && (r.length = o),
        r
    }
    ...
    function invoke_diiidi(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_diiidi(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_dij(e, i, n, t) {
        var r = stackSave();
        try {
            return Module.dynCall_dij(e, i, n, t)
        } catch (e) {
            if (stackRestore(r),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_ffff(e, i, n, t) {
        var r = stackSave();
        try {
            return Module.dynCall_ffff(e, i, n, t)
        } catch (e) {
            if (stackRestore(r),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_fffffi(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_fffffi(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_ffffii(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_ffffii(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_ffffiiii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_ffffiiii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_fffifffi(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_fffifffi(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_fffifi(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_fffifi(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_fffii(e, i, n, t, r) {
        var o = stackSave();
        try {
            return Module.dynCall_fffii(e, i, n, t, r)
        } catch (e) {
            if (stackRestore(o),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_ffiii(e, i, n, t, r) {
        var o = stackSave();
        try {
            return Module.dynCall_ffiii(e, i, n, t, r)
        } catch (e) {
            if (stackRestore(o),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_fiffffii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_fiffffii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_fiffffiiiiii(e, i, n, t, r, o, _, a, l, u, s, c) {
        var f = stackSave();
        try {
            return Module.dynCall_fiffffiiiiii(e, i, n, t, r, o, _, a, l, u, s, c)
        } catch (e) {
            if (stackRestore(f),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_fifffi(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_fifffi(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_fifffiii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_fifffiii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_fiffii(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_fiffii(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_fiiffi(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_fiiffi(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_fiifii(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_fiifii(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_fiiiif(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_fiiiif(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_fiiiiii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_fiiiiii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_fiiiiiifiifif(e, i, n, t, r, o, _, a, l, u, s, c, f) {
        var d = stackSave();
        try {
            return Module.dynCall_fiiiiiifiifif(e, i, n, t, r, o, _, a, l, u, s, c, f)
        } catch (e) {
            if (stackRestore(d),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_fiiiiiifiiiif(e, i, n, t, r, o, _, a, l, u, s, c, f) {
        var d = stackSave();
        try {
            return Module.dynCall_fiiiiiifiiiif(e, i, n, t, r, o, _, a, l, u, s, c, f)
        } catch (e) {
            if (stackRestore(d),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iddi(e, i, n, t) {
        var r = stackSave();
        try {
            return Module.dynCall_iddi(e, i, n, t)
        } catch (e) {
            if (stackRestore(r),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iffffi(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_iffffi(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiddiii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iiddiii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iidiii(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_iidiii(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iifdi(e, i, n, t, r) {
        var o = stackSave();
        try {
            return Module.dynCall_iifdi(e, i, n, t, r)
        } catch (e) {
            if (stackRestore(o),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiffffi(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iiffffi(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiffffiii(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            return Module.dynCall_iiffffiii(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iifffi(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_iifffi(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iifffii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iifffii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iifffiii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_iifffiii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiffii(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_iiffii(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiffiii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iiffiii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iififfi(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iififfi(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iifiii(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_iifiii(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iifiiiijii(e, i, n, t, r, o, _, a, l, u, s) {
        var c = stackSave();
        try {
            return Module.dynCall_iifiiiijii(e, i, n, t, r, o, _, a, l, u, s)
        } catch (e) {
            if (stackRestore(c),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iifjfi(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iifjfi(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiidii(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_iiidii(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiidiii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iiidiii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiifd(e, i, n, t, r) {
        var o = stackSave();
        try {
            return Module.dynCall_iiifd(e, i, n, t, r)
        } catch (e) {
            if (stackRestore(o),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiifdi(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_iiifdi(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiffi(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_iiiffi(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiffii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iiiffii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiffiii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_iiiffiii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiififfi(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_iiififfi(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiififiiii(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            return Module.dynCall_iiififiiii(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiifii(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_iiifii(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiifiii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iiifiii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiifiiii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_iiifiiii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiifiiiii(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            return Module.dynCall_iiifiiiii(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiidii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iiiidii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiif(e, i, n, t, r) {
        var o = stackSave();
        try {
            return Module.dynCall_iiiif(e, i, n, t, r)
        } catch (e) {
            if (stackRestore(o),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiifd(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_iiiifd(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiifdi(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iiiifdi(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiifffffi(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            return Module.dynCall_iiiifffffi(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiifffffii(e, i, n, t, r, o, _, a, l, u, s) {
        var c = stackSave();
        try {
            return Module.dynCall_iiiifffffii(e, i, n, t, r, o, _, a, l, u, s)
        } catch (e) {
            if (stackRestore(c),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiifffiii(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            return Module.dynCall_iiiifffiii(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiffi(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iiiiffi(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiffiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f) {
        var d = stackSave();
        try {
            return Module.dynCall_iiiiffiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f)
        } catch (e) {
            if (stackRestore(d),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiifi(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_iiiifi(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiifii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iiiifii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiifiii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_iiiifiii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiifiiii(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            return Module.dynCall_iiiifiiii(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiifiiiii(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            return Module.dynCall_iiiifiiiii(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiidii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_iiiiidii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiif(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_iiiiif(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiifi(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iiiiifi(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiifiii(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            return Module.dynCall_iiiiifiii(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiifiiiiif(e, i, n, t, r, o, _, a, l, u, s, c) {
        var f = stackSave();
        try {
            return Module.dynCall_iiiiifiiiiif(e, i, n, t, r, o, _, a, l, u, s, c)
        } catch (e) {
            if (stackRestore(f),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiii(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_iiiiii(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiiifff(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            return Module.dynCall_iiiiiifff(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiiifffiiifiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p, v) {
        var m = stackSave();
        try {
            return Module.dynCall_iiiiiifffiiifiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p, v)
        } catch (e) {
            if (stackRestore(m),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiiiffiiiiiiiiiffffiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p, v, m, y, S, g, E, M, L, h) {
        var b = stackSave();
        try {
            return Module.dynCall_iiiiiiffiiiiiiiiiffffiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p, v, m, y, S, g, E, M, L, h)
        } catch (e) {
            if (stackRestore(b),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiiiffiiiiiiiiiffffiiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p, v, m, y, S, g, E, M, L, h, b) {
        var k = stackSave();
        try {
            return Module.dynCall_iiiiiiffiiiiiiiiiffffiiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p, v, m, y, S, g, E, M, L, h, b)
        } catch (e) {
            if (stackRestore(k),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiiiffiiiiiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p, v, m, y, S, g, E, M, L) {
        var h = stackSave();
        try {
            return Module.dynCall_iiiiiiffiiiiiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p, v, m, y, S, g, E, M, L)
        } catch (e) {
            if (stackRestore(h),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiiifiif(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            return Module.dynCall_iiiiiifiif(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiiifiii(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            return Module.dynCall_iiiiiifiii(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiiii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iiiiiii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiiiifiif(e, i, n, t, r, o, _, a, l, u, s) {
        var c = stackSave();
        try {
            return Module.dynCall_iiiiiiifiif(e, i, n, t, r, o, _, a, l, u, s)
        } catch (e) {
            if (stackRestore(c),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiiiii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_iiiiiiii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiiiiii(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            return Module.dynCall_iiiiiiiii(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiiiiiii(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            return Module.dynCall_iiiiiiiiii(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s) {
        var c = stackSave();
        try {
            return Module.dynCall_iiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s)
        } catch (e) {
            if (stackRestore(c),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c) {
        var f = stackSave();
        try {
            return Module.dynCall_iiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c)
        } catch (e) {
            if (stackRestore(f),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f) {
        var d = stackSave();
        try {
            return Module.dynCall_iiiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f)
        } catch (e) {
            if (stackRestore(d),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d) {
        var p = stackSave();
        try {
            return Module.dynCall_iiiiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d)
        } catch (e) {
            if (stackRestore(p),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiij(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iiiiij(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiiji(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_iiiiiji(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiijiii(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            return Module.dynCall_iiiiijiii(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiij(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_iiiij(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiiji(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iiiiji(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiijii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_iiiijii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiijiii(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            return Module.dynCall_iiiijiii(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiijjii(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            return Module.dynCall_iiiijjii(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiijjiiii(e, i, n, t, r, o, _, a, l, u, s, c) {
        var f = stackSave();
        try {
            return Module.dynCall_iiiijjiiii(e, i, n, t, r, o, _, a, l, u, s, c)
        } catch (e) {
            if (stackRestore(f),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiijfi(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iiijfi(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiiji(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_iiiji(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiijii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iiijii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiijiii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_iiijiii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiijji(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_iiijji(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiijjii(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            return Module.dynCall_iiijjii(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iiijjiiii(e, i, n, t, r, o, _, a, l, u, s) {
        var c = stackSave();
        try {
            return Module.dynCall_iiijjiiii(e, i, n, t, r, o, _, a, l, u, s)
        } catch (e) {
            if (stackRestore(c),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iijfiii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_iijfiii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iijii(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_iijii(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iijiii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iijiii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iijiiii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_iijiiii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iijji(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_iijji(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iijjii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_iijjii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iijjiii(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            return Module.dynCall_iijjiii(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_iijjji(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            return Module.dynCall_iijjji(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_ijiii(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_ijiii(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_ijiiii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_ijiiii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_ijji(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_ijji(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_jid(e, i, n) {
        var t = stackSave();
        try {
            return Module.dynCall_jid(e, i, n)
        } catch (e) {
            if (stackRestore(t),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_jiiiii(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_jiiiii(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_jiiiiii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_jiiiiii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_jiiiiiii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_jiiiiiii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_jiiiiiiii(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            return Module.dynCall_jiiiiiiii(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_jiiiiiiiii(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            return Module.dynCall_jiiiiiiiii(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_jiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s) {
        var c = stackSave();
        try {
            return Module.dynCall_jiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s)
        } catch (e) {
            if (stackRestore(c),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_jiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c) {
        var f = stackSave();
        try {
            return Module.dynCall_jiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c)
        } catch (e) {
            if (stackRestore(f),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_jiiiji(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_jiiiji(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_jiiji(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_jiiji(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_jijii(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_jijii(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_jijiii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_jijiii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_jijj(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            return Module.dynCall_jijj(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_jijji(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            return Module.dynCall_jijji(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_jjjji(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            return Module.dynCall_jjjji(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vffffiiii(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            Module.dynCall_vffffiiii(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vffi(e, i, n, t) {
        var r = stackSave();
        try {
            Module.dynCall_vffi(e, i, n, t)
        } catch (e) {
            if (stackRestore(r),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vfiiiii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_vfiiiii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vidii(e, i, n, t, r) {
        var o = stackSave();
        try {
            Module.dynCall_vidii(e, i, n, t, r)
        } catch (e) {
            if (stackRestore(o),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viffff(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            Module.dynCall_viffff(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vifffff(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_vifffff(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viffffffffffffiiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p, v, m, y) {
        var S = stackSave();
        try {
            Module.dynCall_viffffffffffffiiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p, v, m, y)
        } catch (e) {
            if (stackRestore(S),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vifffffi(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_vifffffi(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vifffffii(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            Module.dynCall_vifffffii(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viffffi(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_viffffi(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viffffii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_viffffii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viffffiifffiiiiif(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p, v, m) {
        var y = stackSave();
        try {
            Module.dynCall_viffffiifffiiiiif(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p, v, m)
        } catch (e) {
            if (stackRestore(y),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viffffiii(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            Module.dynCall_viffffiii(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vifffi(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            Module.dynCall_vifffi(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vifffii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_vifffii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viffii(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            Module.dynCall_viffii(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viffiifffffiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d) {
        var p = stackSave();
        try {
            Module.dynCall_viffiifffffiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d)
        } catch (e) {
            if (stackRestore(p),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viffiiffffi(e, i, n, t, r, o, _, a, l, u, s) {
        var c = stackSave();
        try {
            Module.dynCall_viffiiffffi(e, i, n, t, r, o, _, a, l, u, s)
        } catch (e) {
            if (stackRestore(c),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viffiii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_viffiii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viffiiiif(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            Module.dynCall_viffiiiif(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viffjfi(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_viffjfi(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vififfi(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_vififfi(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vififfii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_vififfii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vififiii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_vififiii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vifiii(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            Module.dynCall_vifiii(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vifiiii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_vifiiii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vifijii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_vifijii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vifjfi(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_vifjfi(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vifji(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            Module.dynCall_vifji(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viidd(e, i, n, t, r) {
        var o = stackSave();
        try {
            Module.dynCall_viidd(e, i, n, t, r)
        } catch (e) {
            if (stackRestore(o),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viidii(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            Module.dynCall_viidii(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viifff(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            Module.dynCall_viifff(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viifffffii(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            Module.dynCall_viifffffii(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiffffi(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_viiffffi(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiffffiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f) {
        var d = stackSave();
        try {
            Module.dynCall_viiffffiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f)
        } catch (e) {
            if (stackRestore(d),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viifffi(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_viifffi(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiffi(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            Module.dynCall_viiffi(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiffii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_viiffii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiffiiii(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            Module.dynCall_viiffiiii(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viififf(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_viififf(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viififfi(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_viififfi(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viififi(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_viififi(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viififii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_viififii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viifii(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            Module.dynCall_viifii(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viifiii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_viifiii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viifiiii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_viifiiii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viifjfi(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_viifjfi(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiidi(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            Module.dynCall_viiidi(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiffffffi(e, i, n, t, r, o, _, a, l, u, s) {
        var c = stackSave();
        try {
            Module.dynCall_viiiffffffi(e, i, n, t, r, o, _, a, l, u, s)
        } catch (e) {
            if (stackRestore(c),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiifffi(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_viiifffi(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiifffiiij(e, i, n, t, r, o, _, a, l, u, s, c) {
        var f = stackSave();
        try {
            Module.dynCall_viiifffiiij(e, i, n, t, r, o, _, a, l, u, s, c)
        } catch (e) {
            if (stackRestore(f),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiffi(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_viiiffi(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiffii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_viiiffii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiffiiiii(e, i, n, t, r, o, _, a, l, u, s) {
        var c = stackSave();
        try {
            Module.dynCall_viiiffiiiii(e, i, n, t, r, o, _, a, l, u, s)
        } catch (e) {
            if (stackRestore(c),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiffjfi(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            Module.dynCall_viiiffjfi(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiifi(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            Module.dynCall_viiifi(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiififfi(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            Module.dynCall_viiififfi(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiififi(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_viiififi(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiififii(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            Module.dynCall_viiififii(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiififiii(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            Module.dynCall_viiififiii(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiifii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_viiifii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiifiii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_viiifiii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiifiiiii(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            Module.dynCall_viiifiiiii(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiif(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            Module.dynCall_viiiif(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiffffii(e, i, n, t, r, o, _, a, l, u, s) {
        var c = stackSave();
        try {
            Module.dynCall_viiiiffffii(e, i, n, t, r, o, _, a, l, u, s)
        } catch (e) {
            if (stackRestore(c),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiifffi(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            Module.dynCall_viiiifffi(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiffi(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_viiiiffi(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiffiiii(e, i, n, t, r, o, _, a, l, u, s) {
        var c = stackSave();
        try {
            Module.dynCall_viiiiffiiii(e, i, n, t, r, o, _, a, l, u, s)
        } catch (e) {
            if (stackRestore(c),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiifi(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_viiiifi(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiififfi(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            Module.dynCall_viiiififfi(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiififii(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            Module.dynCall_viiiififii(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiifii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_viiiifii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiifiifi(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            Module.dynCall_viiiifiifi(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiifiiifii(e, i, n, t, r, o, _, a, l, u, s, c) {
        var f = stackSave();
        try {
            Module.dynCall_viiiifiiifii(e, i, n, t, r, o, _, a, l, u, s, c)
        } catch (e) {
            if (stackRestore(f),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiifiiii(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            Module.dynCall_viiiifiiii(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiifiiiii(e, i, n, t, r, o, _, a, l, u, s) {
        var c = stackSave();
        try {
            Module.dynCall_viiiifiiiii(e, i, n, t, r, o, _, a, l, u, s)
        } catch (e) {
            if (stackRestore(c),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiifiiiiif(e, i, n, t, r, o, _, a, l, u, s, c) {
        var f = stackSave();
        try {
            Module.dynCall_viiiifiiiiif(e, i, n, t, r, o, _, a, l, u, s, c)
        } catch (e) {
            if (stackRestore(f),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiifiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d) {
        var p = stackSave();
        try {
            Module.dynCall_viiiifiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d)
        } catch (e) {
            if (stackRestore(p),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiii(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            Module.dynCall_viiiii(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiif(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_viiiiif(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiiffi(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            Module.dynCall_viiiiiffi(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiiffii(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            Module.dynCall_viiiiiffii(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiifi(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_viiiiifi(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_viiiiii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiiif(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_viiiiiif(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiiii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_viiiiiii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiiiifi(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            Module.dynCall_viiiiiiifi(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiiiii(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            Module.dynCall_viiiiiiii(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiiiiii(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            Module.dynCall_viiiiiiiii(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiiiiiiffi(e, i, n, t, r, o, _, a, l, u, s, c, f) {
        var d = stackSave();
        try {
            Module.dynCall_viiiiiiiiiffi(e, i, n, t, r, o, _, a, l, u, s, c, f)
        } catch (e) {
            if (stackRestore(d),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s) {
        var c = stackSave();
        try {
            Module.dynCall_viiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s)
        } catch (e) {
            if (stackRestore(c),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c) {
        var f = stackSave();
        try {
            Module.dynCall_viiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c)
        } catch (e) {
            if (stackRestore(f),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiiiiiiiiffi(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p) {
        var v = stackSave();
        try {
            Module.dynCall_viiiiiiiiiiiffi(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p)
        } catch (e) {
            if (stackRestore(v),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiiiiiiiifii(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p) {
        var v = stackSave();
        try {
            Module.dynCall_viiiiiiiiiiifii(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p)
        } catch (e) {
            if (stackRestore(v),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f) {
        var d = stackSave();
        try {
            Module.dynCall_viiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f)
        } catch (e) {
            if (stackRestore(d),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d) {
        var p = stackSave();
        try {
            Module.dynCall_viiiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d)
        } catch (e) {
            if (stackRestore(p),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p) {
        var v = stackSave();
        try {
            Module.dynCall_viiiiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p)
        } catch (e) {
            if (stackRestore(v),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p, v) {
        var m = stackSave();
        try {
            Module.dynCall_viiiiiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p, v)
        } catch (e) {
            if (stackRestore(m),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiiiiiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p, v, m, y, S) {
        var g = stackSave();
        try {
            Module.dynCall_viiiiiiiiiiiiiiiiii(e, i, n, t, r, o, _, a, l, u, s, c, f, d, p, v, m, y, S)
        } catch (e) {
            if (stackRestore(g),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiij(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_viiiij(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiiji(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_viiiiji(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiijiiii(e, i, n, t, r, o, _, a, l, u, s) {
        var c = stackSave();
        try {
            Module.dynCall_viiiijiiii(e, i, n, t, r, o, _, a, l, u, s)
        } catch (e) {
            if (stackRestore(c),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiij(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            Module.dynCall_viiij(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiijfi(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_viiijfi(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiiji(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_viiiji(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiijji(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            Module.dynCall_viiijji(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viijfi(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_viijfi(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viiji(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            Module.dynCall_viiji(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viijii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_viijii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viijiijiii(e, i, n, t, r, o, _, a, l, u, s, c) {
        var f = stackSave();
        try {
            Module.dynCall_viijiijiii(e, i, n, t, r, o, _, a, l, u, s, c)
        } catch (e) {
            if (stackRestore(f),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viijijii(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            Module.dynCall_viijijii(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viijijiii(e, i, n, t, r, o, _, a, l, u, s) {
        var c = stackSave();
        try {
            Module.dynCall_viijijiii(e, i, n, t, r, o, _, a, l, u, s)
        } catch (e) {
            if (stackRestore(c),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viijijj(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            Module.dynCall_viijijj(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viijj(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_viijj(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viijji(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_viijji(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viijjii(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            Module.dynCall_viijjii(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viijjiii(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            Module.dynCall_viijjiii(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_viijjji(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            Module.dynCall_viijjji(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vijfi(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            Module.dynCall_vijfi(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vijfii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_vijfii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vijii(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            Module.dynCall_vijii(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vijiii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_vijiii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vijiiii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_vijiiii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vijiji(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_vijiji(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vijijji(e, i, n, t, r, o, _, a, l, u) {
        var s = stackSave();
        try {
            Module.dynCall_vijijji(e, i, n, t, r, o, _, a, l, u)
        } catch (e) {
            if (stackRestore(s),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vijji(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_vijji(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vijjii(e, i, n, t, r, o, _, a) {
        var l = stackSave();
        try {
            Module.dynCall_vijjii(e, i, n, t, r, o, _, a)
        } catch (e) {
            if (stackRestore(l),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vijjji(e, i, n, t, r, o, _, a, l) {
        var u = stackSave();
        try {
            Module.dynCall_vijjji(e, i, n, t, r, o, _, a, l)
        } catch (e) {
            if (stackRestore(u),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vjfi(e, i, n, t, r) {
        var o = stackSave();
        try {
            Module.dynCall_vjfi(e, i, n, t, r)
        } catch (e) {
            if (stackRestore(o),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vjiiii(e, i, n, t, r, o, _) {
        var a = stackSave();
        try {
            Module.dynCall_vjiiii(e, i, n, t, r, o, _)
        } catch (e) {
            if (stackRestore(a),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    function invoke_vjji(e, i, n, t, r, o) {
        var _ = stackSave();
        try {
            Module.dynCall_vjji(e, i, n, t, r, o)
        } catch (e) {
            if (stackRestore(_),
            "number" != typeof e && "longjmp" !== e)
                throw e;
    ...
    : Date.now,
    Module.requestFullScreen = function(e, i, n) {
    ...
    ,
    Module.setCanvasSize = function(e, i, n) {
    ...
    ,
    Module.createContext = function(e, i, n, t) {
    ...
    DYNAMIC_BASE = alignMemory(STACK_MAX = STACK_BASE + TOTAL_STACK),
    HEAP32[DYNAMICTOP_PTR >> 2] = DYNAMIC_BASE,
    staticSealed = !0,
    Module.wasmTableSize = 143936,
    Module.wasmMaxTableSize = 143936,
    Module.asmGlobalArg = {},
    Module.asmLibraryArg = {
        ...
        invoke_iiiifd: invoke_iiiifd,
        invoke_iiiifdi: invoke_iiiifdi,
        ...
        invoke_viffiiffffi: invoke_viffiiffffi,
        invoke_viffiii: invoke_viffiii,
        invoke_viffiiiif: invoke_viffiiiif,
        invoke_viffjfi: invoke_viffjfi,
        ...
        invoke_viiiffjfi: invoke_viiiffjfi,
        ...
        invoke_viiiifiiifii: invoke_viiiifiiifii,
    ...
    Module.asm = asm;
    var initialStackTop, _SendMessage = Module._SendMessage = function() {
    ...
    , __GLOBAL__sub_I_External_il2cpp_builds_external_baselib_Platforms_WebGL_Source_0_cpp = Module.__GLOBAL__sub_I_External_il2cpp_builds_external_baselib_Platforms_WebGL_Source_0_cpp = function() {
    ...
    , __GLOBAL__sub_I_GUITexture_cpp = Module.__GLOBAL__sub_I_GUITexture_cpp = function() {
    ...
    , __GLOBAL__sub_I_Lump_libil2cpp_icalls_cpp = Module.__GLOBAL__sub_I_Lump_libil2cpp_icalls_cpp = function() {
    ...
    , __GLOBAL__sub_I_Lump_libil2cpp_mono_cpp = Module.__GLOBAL__sub_I_Lump_libil2cpp_mono_cpp = function() {
    ...
    , __GLOBAL__sub_I_Lump_libil2cpp_vm_utils_cpp = Module.__GLOBAL__sub_I_Lump_libil2cpp_vm_utils_cpp = function() {
        return Module.asm.__GLOBAL__sub_I_Lump_libil2cpp_vm_utils_cpp.apply(null, arguments)
    }
    , __GLOBAL__sub_I_Mesh_cpp = Module.__GLOBAL__sub_I_Mesh_cpp = function() {
        return Module.asm.__GLOBAL__sub_I_Mesh_cpp.apply(null, arguments)
    }
    , __GLOBAL__sub_I_Modules_Animation_0_cpp = Module.__GLOBAL__sub_I_Modules_Animation_0_cpp = function() {
        return Module.asm.__GLOBAL__sub_I_Modules_Animation_0_cpp.apply(null, arguments)
    }
    , __GLOBAL__sub_I_Modules_Animation_2_cpp = Module.__GLOBAL__sub_I_Modules_Animation_2_cpp = function() {
        return Module.asm.__GLOBAL__sub_I_Modules_Animation_2_cpp.apply(null, arguments)
    }
    , __GLOBAL__sub_I_Modules_Animation_7_cpp = Module.__GLOBAL__sub_I_Modules_Animation_7_cpp = function() {
        return Module.asm.__GLOBAL__sub_I_Modules_Animation_7_cpp.apply(null, arguments)
    }
    , __GLOBAL__sub_I_Modules_Animation_Constraints_0_cpp = Module.__GLOBAL__sub_I_Modules_Animation_Constraints_0_cpp = function() {
    ...
    , __GLOBAL__sub_I_Modules_Audio_Public_ScriptBindings_1_cpp = Module.__GLOBAL__sub_I_Modules_Audio_Public_ScriptBindings_1_cpp = function() {
    ...
    , __GLOBAL__sub_I_Modules_ParticleSystem_0_cpp = Module.__GLOBAL__sub_I_Modules_ParticleSystem_0_cpp = function() {
    ...
    , __GLOBAL__sub_I_Modules_Physics_2_cpp = Module.__GLOBAL__sub_I_Modules_Physics_2_cpp = function() {
        return Module.asm.__GLOBAL__sub_I_Modules_Physics_2_cpp.apply(null, arguments)
    }
    , __GLOBAL__sub_I_Modules_Profiler_Public_1_cpp = Module.__GLOBAL__sub_I_Modules_Profiler_Public_1_cpp = function() {
        return Module.asm.__GLOBAL__sub_I_Modules_Profiler_Public_1_cpp.apply(null, arguments)
    }
    , __GLOBAL__sub_I_Modules_Profiler_Runtime_1_cpp = Module.__GLOBAL__sub_I_Modules_Profiler_Runtime_1_cpp = function() {
        return Module.asm.__GLOBAL__sub_I_Modules_Profiler_Runtime_1_cpp.apply(null, arguments)
    }
    , __GLOBAL__sub_I_Modules_Subsystems_0_cpp = Module.__GLOBAL__sub_I_Modules_Subsystems_0_cpp = function() {
    ...
    , __GLOBAL__sub_I_Modules_VFX_Public_0_cpp = Module.__GLOBAL__sub_I_Modules_VFX_Public_0_cpp = function() {
    ...
    , __GLOBAL__sub_I_Modules_VFX_Public_Systems_0_cpp = Module.__GLOBAL__sub_I_Modules_VFX_Public_Systems_0_cpp = function() {
        return Module.asm.__GLOBAL__sub_I_Modules_VFX_Public_Systems_0_cpp.apply(null, arguments)
    }
    , __GLOBAL__sub_I_Modules_VR_0_cpp = Module.__GLOBAL__sub_I_Modules_VR_0_cpp = function() {
        return Module.asm.__GLOBAL__sub_I_Modules_VR_0_cpp.apply(null, arguments)
    }
    , __GLOBAL__sub_I_Modules_Video_Public_Base_0_cpp = Module.__GLOBAL__sub_I_Modules_Video_Public_Base_0_cpp = function() {
    ...
    , __GLOBAL__sub_I_PlatformDependent_WebGL_External_baselib_builds_Source_0_cpp = Module.__GLOBAL__sub_I_PlatformDependent_WebGL_External_baselib_builds_Source_0_cpp = function() {
    ...
    , __GLOBAL__sub_I_PluginInterfaceVR_cpp = Module.__GLOBAL__sub_I_PluginInterfaceVR_cpp = function() {
        return Module.asm.__GLOBAL__sub_I_PluginInterfaceVR_cpp.apply(null, arguments)
    }
    , __GLOBAL__sub_I_Runtime_2D_Renderer_0_cpp = Module.__GLOBAL__sub_I_Runtime_2D_Renderer_0_cpp = function() {
    ...
    , __GLOBAL__sub_I_Runtime_Allocator_2_cpp = Module.__GLOBAL__sub_I_Runtime_Allocator_2_cpp = function() {
    ...
    , __GLOBAL__sub_I_Runtime_Camera_8_cpp = Module.__GLOBAL__sub_I_Runtime_Camera_8_cpp = function() {
    ...
    , __GLOBAL__sub_I_Runtime_Export_Unsafe_0_cpp = Module.__GLOBAL__sub_I_Runtime_Export_Unsafe_0_cpp = function() {
    ...
    , __GLOBAL__sub_I_Runtime_Graphics_2_cpp = Module.__GLOBAL__sub_I_Runtime_Graphics_2_cpp = function() {
        return Module.asm.__GLOBAL__sub_I_Runtime_Graphics_2_cpp.apply(null, arguments)
    }
    , __GLOBAL__sub_I_Runtime_Graphics_4_cpp = Module.__GLOBAL__sub_I_Runtime_Graphics_4_cpp = function() {
    ...
    , __GLOBAL__sub_I_Runtime_Graphics_CommandBuffer_0_cpp = Module.__GLOBAL__sub_I_Runtime_Graphics_CommandBuffer_0_cpp = function() {
    ...
    , __GLOBAL__sub_I_Runtime_Graphics_Mesh_1_cpp = Module.__GLOBAL__sub_I_Runtime_Graphics_Mesh_1_cpp = function() {
    ...
    , __GLOBAL__sub_I_Runtime_Jobs_1_cpp = Module.__GLOBAL__sub_I_Runtime_Jobs_1_cpp = function() {
        return Module.asm.__GLOBAL__sub_I_Runtime_Jobs_1_cpp.apply(null, arguments)
    }
    , __GLOBAL__sub_I_Runtime_Jobs_Internal_1_cpp = Module.__GLOBAL__sub_I_Runtime_Jobs_Internal_1_cpp = function() {
    ...
    , __GLOBAL__sub_I_Runtime_Profiler_ExternalGPUProfiler_0_cpp = Module.__GLOBAL__sub_I_Runtime_Profiler_ExternalGPUProfiler_0_cpp = function() {
        return Module.asm.__GLOBAL__sub_I_Runtime_Profiler_ExternalGPUProfiler_0_cpp.apply(null, arguments)
    }
    , __GLOBAL__sub_I_Runtime_Profiler_ScriptBindings_0_cpp = Module.__GLOBAL__sub_I_Runtime_Profiler_ScriptBindings_0_cpp = function() {
    ...
    , __GLOBAL__sub_I_Runtime_Serialize_1_cpp = Module.__GLOBAL__sub_I_Runtime_Serialize_1_cpp = function() {
    ...
    , __GLOBAL__sub_I_Runtime_Shaders_1_cpp = Module.__GLOBAL__sub_I_Runtime_Shaders_1_cpp = function() {
        return Module.asm.__GLOBAL__sub_I_Runtime_Shaders_1_cpp.apply(null, arguments)
    }
    , __GLOBAL__sub_I_Runtime_Shaders_3_cpp = Module.__GLOBAL__sub_I_Runtime_Shaders_3_cpp = function() {
        return Module.asm.__GLOBAL__sub_I_Runtime_Shaders_3_cpp.apply(null, arguments)
    }
    , __GLOBAL__sub_I_Runtime_Shaders_ShaderImpl_2_cpp = Module.__GLOBAL__sub_I_Runtime_Shaders_ShaderImpl_2_cpp = function() {
    ...
    , __GLOBAL__sub_I_SubsystemsScriptingClasses_cpp = Module.__GLOBAL__sub_I_SubsystemsScriptingClasses_cpp = function() {
        return Module.asm.__GLOBAL__sub_I_SubsystemsScriptingClasses_cpp.apply(null, arguments)
    }
    , __GLOBAL__sub_I_SwInterCollision_cpp = Module.__GLOBAL__sub_I_SwInterCollision_cpp = function() {
        return Module.asm.__GLOBAL__sub_I_SwInterCollision_cpp.apply(null, arguments)
    }
    , __GLOBAL__sub_I_SwSolverKernel_cpp = Module.__GLOBAL__sub_I_SwSolverKernel_cpp = function() {
        return Module.asm.__GLOBAL__sub_I_SwSolverKernel_cpp.apply(null, arguments)
    }
    , __GLOBAL__sub_I_TemplateInstantiations_cpp = Module.__GLOBAL__sub_I_TemplateInstantiations_cpp = function() {
    ...
    , __GLOBAL__sub_I_UIElementsNativeScriptingClasses_cpp = Module.__GLOBAL__sub_I_UIElementsNativeScriptingClasses_cpp = function() {
    ...
    , __GLOBAL__sub_I_UVModule_cpp = Module.__GLOBAL__sub_I_UVModule_cpp = function() {
    ...
    , __GLOBAL__sub_I_VisualEffectAsset_cpp = Module.__GLOBAL__sub_I_VisualEffectAsset_cpp = function() {
    ...
    , ___cxx_global_var_init_104 = Module.___cxx_global_var_init_104 = function() {
    ...
    , ___cxx_global_var_init_17 = Module.___cxx_global_var_init_17 = function() {
    ...
    , ___cxx_global_var_init_18_1167 = Module.___cxx_global_var_init_18_1167 = function() {
    ...
    , ___cxx_global_var_init_3773 = Module.___cxx_global_var_init_3773 = function() {
        return Module.asm.___cxx_global_var_init_3773.apply(null, arguments)
    }
    , ___cxx_global_var_init_7636 = Module.___cxx_global_var_init_7636 = function() {
        return Module.asm.___cxx_global_var_init_7636.apply(null, arguments)
    }
    , ___cxx_global_var_init_8602 = Module.___cxx_global_var_init_8602 = function() {
        return Module.asm.___cxx_global_var_init_8602.apply(null, arguments)
    }
    , ___cxx_global_var_init_8783 = Module.___cxx_global_var_init_8783 = function() {
        return Module.asm.___cxx_global_var_init_8783.apply(null, arguments)
    }
    , ___cxx_global_var_init_89 = Module.___cxx_global_var_init_89 = function() {
        return Module.asm.___cxx_global_var_init_89.apply(null, arguments)
    }
    , ___cxx_global_var_init_9178 = Module.___cxx_global_var_init_9178 = function() {
        return Module.asm.___cxx_global_var_init_9178.apply(null, arguments)
    }
    ...
    , _llvm_ctpop_i32 = Module._llvm_ctpop_i32 = function() {
    ...
    , dynCall_diiidi = Module.dynCall_diiidi = function() {
    ...
    , dynCall_dij = Module.dynCall_dij = function() {
        return Module.asm.dynCall_dij.apply(null, arguments)
    }
    , dynCall_diji = Module.dynCall_diji = function() {
    ...
    , dynCall_ffff = Module.dynCall_ffff = function() {
    ...
    , dynCall_ffffiiii = Module.dynCall_ffffiiii = function() {
    ...
    , dynCall_fffii = Module.dynCall_fffii = function() {
    ...
    , dynCall_ffiii = Module.dynCall_ffiii = function() {
    ...
    , dynCall_fidi = Module.dynCall_fidi = function() {
    ...
    , dynCall_fifffiii = Module.dynCall_fifffiii = function() {
    ...
    , dynCall_fiffii = Module.dynCall_fiffii = function() {
    ...
    , dynCall_fiiffi = Module.dynCall_fiiffi = function() {
    ...
    , dynCall_fiiiiii = Module.dynCall_fiiiiii = function() {
    ...
    , dynCall_iddi = Module.dynCall_iddi = function() {
    ...
    , dynCall_iiddiii = Module.dynCall_iiddiii = function() {
    ...
    , dynCall_iidiii = Module.dynCall_iidiii = function() {
    ...
    , dynCall_iifdi = Module.dynCall_iifdi = function() {
    ...
    , dynCall_iiffffi = Module.dynCall_iiffffi = function() {
        return Module.asm.dynCall_iiffffi.apply(null, arguments)
    }
    , dynCall_iiffffiii = Module.dynCall_iiffffiii = function() {
    ...
    , dynCall_iifffii = Module.dynCall_iifffii = function() {
        return Module.asm.dynCall_iifffii.apply(null, arguments)
    }
    , dynCall_iifffiii = Module.dynCall_iifffiii = function() {
    ...
    , dynCall_iififfi = Module.dynCall_iififfi = function() {
    ...
    , dynCall_iifiiiijii = Module.dynCall_iifiiiijii = function() {
        return Module.asm.dynCall_iifiiiijii.apply(null, arguments)
    }
    , dynCall_iifjfi = Module.dynCall_iifjfi = function() {
        return Module.asm.dynCall_iifjfi.apply(null, arguments)
    }
    ...
    , dynCall_iiidiii = Module.dynCall_iiidiii = function() {
    ...
    , dynCall_iiifd = Module.dynCall_iiifd = function() {
        return Module.asm.dynCall_iiifd.apply(null, arguments)
    }
    , dynCall_iiifdi = Module.dynCall_iiifdi = function() {
        return Module.asm.dynCall_iiifdi.apply(null, arguments)
    }
    ...
    , dynCall_iiififfi = Module.dynCall_iiififfi = function() {
        return Module.asm.dynCall_iiififfi.apply(null, arguments)
    }
    , dynCall_iiififiiii = Module.dynCall_iiififiiii = function() {
    ...
    , dynCall_iiifiiiii = Module.dynCall_iiifiiiii = function() {
        return Module.asm.dynCall_iiifiiiii.apply(null, arguments)
    }
    , dynCall_iiii = Module.dynCall_iiii = function() {
        return Module.asm.dynCall_iiii.apply(null, arguments)
    }
    , dynCall_iiiidii = Module.dynCall_iiiidii = function() {
        return Module.asm.dynCall_iiiidii.apply(null, arguments)
    }
    , dynCall_iiiif = Module.dynCall_iiiif = function() {
        return Module.asm.dynCall_iiiif.apply(null, arguments)
    }
    , dynCall_iiiifd = Module.dynCall_iiiifd = function() {
        return Module.asm.dynCall_iiiifd.apply(null, arguments)
    }
    , dynCall_iiiifdi = Module.dynCall_iiiifdi = function() {
        return Module.asm.dynCall_iiiifdi.apply(null, arguments)
    }
    , dynCall_iiiifffffi = Module.dynCall_iiiifffffi = function() {
        return Module.asm.dynCall_iiiifffffi.apply(null, arguments)
    }
    , dynCall_iiiifffffii = Module.dynCall_iiiifffffii = function() {
        return Module.asm.dynCall_iiiifffffii.apply(null, arguments)
    }
    , dynCall_iiiifffiii = Module.dynCall_iiiifffiii = function() {
    ...
    , dynCall_iiiiffiiiiiii = Module.dynCall_iiiiffiiiiiii = function() {
    ...
    , dynCall_iiiiif = Module.dynCall_iiiiif = function() {
    ...
    , dynCall_iiiiiifff = Module.dynCall_iiiiiifff = function() {
    ...
    , dynCall_iiiiijiii = Module.dynCall_iiiiijiii = function() {
    ...
    , dynCall_iiiijiii = Module.dynCall_iiiijiii = function() {
    ...
    , dynCall_iiijfi = Module.dynCall_iiijfi = function() {
    ...
    , dynCall_iijfiii = Module.dynCall_iijfiii = function() {
    ...
    , dynCall_ijiiii = Module.dynCall_ijiiii = function() {
    ...
    , dynCall_jid = Module.dynCall_jid = function() {
    ...
    , dynCall_jiiiiiii = Module.dynCall_jiiiiiii = function() {
        return Module.asm.dynCall_jiiiiiii.apply(null, arguments)
    }
    , dynCall_jiiiiiiii = Module.dynCall_jiiiiiiii = function() {
        return Module.asm.dynCall_jiiiiiiii.apply(null, arguments)
    }
    , dynCall_jiiiiiiiii = Module.dynCall_jiiiiiiiii = function() {
    ...
    , dynCall_jiiiiiiiiiii = Module.dynCall_jiiiiiiiiiii = function() {
        return Module.asm.dynCall_jiiiiiiiiiii.apply(null, arguments)
    }
    , dynCall_jiiiji = Module.dynCall_jiiiji = function() {
        return Module.asm.dynCall_jiiiji.apply(null, arguments)
    }
    ...
    , dynCall_vffffiiii = Module.dynCall_vffffiiii = function() {
    ...
    , dynCall_vffi = Module.dynCall_vffi = function() {
    ...
    , dynCall_vfiiiii = Module.dynCall_vfiiiii = function() {
    ...
    , dynCall_vidii = Module.dynCall_vidii = function() {
    ...
    , dynCall_vifffff = Module.dynCall_vifffff = function() {
        return Module.asm.dynCall_vifffff.apply(null, arguments)
    }
    , dynCall_viffffffffffffiiii = Module.dynCall_viffffffffffffiiii = function() {
        return Module.asm.dynCall_viffffffffffffiiii.apply(null, arguments)
    }
    , dynCall_vifffffi = Module.dynCall_vifffffi = function() {
        return Module.asm.dynCall_vifffffi.apply(null, arguments)
    }
    , dynCall_vifffffii = Module.dynCall_vifffffii = function() {
        return Module.asm.dynCall_vifffffii.apply(null, arguments)
    }
    ...
    , dynCall_viffffiifffiiiiif = Module.dynCall_viffffiifffiiiiif = function() {
    ...
    , dynCall_viffiifffffiii = Module.dynCall_viffiifffffiii = function() {
        return Module.asm.dynCall_viffiifffffiii.apply(null, arguments)
    }
    , dynCall_viffiiffffi = Module.dynCall_viffiiffffi = function() {
        return Module.asm.dynCall_viffiiffffi.apply(null, arguments)
    }
    , dynCall_viffiii = Module.dynCall_viffiii = function() {
        return Module.asm.dynCall_viffiii.apply(null, arguments)
    }
    , dynCall_viffiiiif = Module.dynCall_viffiiiif = function() {
        return Module.asm.dynCall_viffiiiif.apply(null, arguments)
    }
    , dynCall_viffjfi = Module.dynCall_viffjfi = function() {
        return Module.asm.dynCall_viffjfi.apply(null, arguments)
    }
    , dynCall_vifi = Module.dynCall_vifi = function() {
        return Module.asm.dynCall_vifi.apply(null, arguments)
    }
    , dynCall_vififfi = Module.dynCall_vififfi = function() {
        return Module.asm.dynCall_vififfi.apply(null, arguments)
    }
    , dynCall_vififfii = Module.dynCall_vififfii = function() {
        return Module.asm.dynCall_vififfii.apply(null, arguments)
    }
    , dynCall_vififiii = Module.dynCall_vififiii = function() {
    ...
    , dynCall_vifijii = Module.dynCall_vifijii = function() {
        return Module.asm.dynCall_vifijii.apply(null, arguments)
    }
    , dynCall_vifjfi = Module.dynCall_vifjfi = function() {
        return Module.asm.dynCall_vifjfi.apply(null, arguments)
    }
    , dynCall_vifji = Module.dynCall_vifji = function() {
        return Module.asm.dynCall_vifji.apply(null, arguments)
    }
    ...
    , dynCall_viidd = Module.dynCall_viidd = function() {
    ...
    , dynCall_viifffffii = Module.dynCall_viifffffii = function() {
    ...
    , dynCall_viiffffiiiiii = Module.dynCall_viiffffiiiiii = function() {
    ...
    , dynCall_viiffiiii = Module.dynCall_viiffiiii = function() {
    ...
    , dynCall_viififf = Module.dynCall_viififf = function() {
        return Module.asm.dynCall_viififf.apply(null, arguments)
    }
    , dynCall_viififfi = Module.dynCall_viififfi = function() {
        return Module.asm.dynCall_viififfi.apply(null, arguments)
    }
    , dynCall_viififi = Module.dynCall_viififi = function() {
        return Module.asm.dynCall_viififi.apply(null, arguments)
    }
    , dynCall_viififii = Module.dynCall_viififii = function() {
    ...
    , dynCall_viifjfi = Module.dynCall_viifjfi = function() {
        return Module.asm.dynCall_viifjfi.apply(null, arguments)
    }
    ...
    , dynCall_viiiffffffi = Module.dynCall_viiiffffffi = function() {
    ...
    , dynCall_viiifffiiij = Module.dynCall_viiifffiiij = function() {
    ...
    , dynCall_viiiffiiiii = Module.dynCall_viiiffiiiii = function() {
        return Module.asm.dynCall_viiiffiiiii.apply(null, arguments)
    }
    , dynCall_viiiffjfi = Module.dynCall_viiiffjfi = function() {
        return Module.asm.dynCall_viiiffjfi.apply(null, arguments)
    }
    ...
    , dynCall_viiififii = Module.dynCall_viiififii = function() {
        return Module.asm.dynCall_viiififii.apply(null, arguments)
    }
    , dynCall_viiififiii = Module.dynCall_viiififiii = function() {
    ...
    , dynCall_viiiiffffii = Module.dynCall_viiiiffffii = function() {
        return Module.asm.dynCall_viiiiffffii.apply(null, arguments)
    }
    , dynCall_viiiifffi = Module.dynCall_viiiifffi = function() {
    ...
    , dynCall_viiiiffiiii = Module.dynCall_viiiiffiiii = function() {
    ...
    , dynCall_viiiififfi = Module.dynCall_viiiififfi = function() {
        return Module.asm.dynCall_viiiififfi.apply(null, arguments)
    }
    , dynCall_viiiififii = Module.dynCall_viiiififii = function() {
    ...
    , dynCall_viiiifiifi = Module.dynCall_viiiifiifi = function() {
        return Module.asm.dynCall_viiiifiifi.apply(null, arguments)
    }
    , dynCall_viiiifiiifii = Module.dynCall_viiiifiiifii = function() {
        return Module.asm.dynCall_viiiifiiifii.apply(null, arguments)
    }
    , dynCall_viiiifiiii = Module.dynCall_viiiifiiii = function() {
        return Module.asm.dynCall_viiiifiiii.apply(null, arguments)
    }
    , dynCall_viiiifiiiii = Module.dynCall_viiiifiiiii = function() {
    ...
    , dynCall_viiiifiiiiiiii = Module.dynCall_viiiifiiiiiiii = function() {
    ...
    , dynCall_viiiiiiiiiffi = Module.dynCall_viiiiiiiiiffi = function() {
    ...
    , dynCall_viiiiiiiiiiiffi = Module.dynCall_viiiiiiiiiiiffi = function() {
    ...
    , dynCall_viiiiji = Module.dynCall_viiiiji = function() {
    ...
    , dynCall_viiij = Module.dynCall_viiij = function() {
        return Module.asm.dynCall_viiij.apply(null, arguments)
    }
    , dynCall_viiijfi = Module.dynCall_viiijfi = function() {
        return Module.asm.dynCall_viiijfi.apply(null, arguments)
    }
    ...
    , dynCall_viijfi = Module.dynCall_viijfi = function() {
        return Module.asm.dynCall_viijfi.apply(null, arguments)
    }
    ...
    , dynCall_viijijj = Module.dynCall_viijijj = function() {
        return Module.asm.dynCall_viijijj.apply(null, arguments)
    }
    , dynCall_viijj = Module.dynCall_viijj = function() {
    ...
    , dynCall_vijfi = Module.dynCall_vijfi = function() {
        return Module.asm.dynCall_vijfi.apply(null, arguments)
    }
    , dynCall_vijfii = Module.dynCall_vijfii = function() {
        return Module.asm.dynCall_vijfii.apply(null, arguments)
    }
    ...
    , dynCall_vijiiii = Module.dynCall_vijiiii = function() {
    ...
    , dynCall_vjfi = Module.dynCall_vjfi = function() {
    ...
    function exit(e, i) {
        i && Module.noExitRuntime && 0 === e || (Module.noExitRuntime || (ABORT = !0,
        EXITSTATUS = e,
